...
def rbac_auth_token() -> str:
    ...
    sk_hex = "e81127f0586aa9c6cf0b6048330f3200e1791187ea87ab780e14337f814e3f51a1f265eac3449c1109ba026d425c4b08f45088a4b47c3892157e740042a18e37"
    sk_bytes = bytes.fromhex(sk_hex)
    sk = Ed25519PrivateKey.from_private_bytes(sk_bytes[:32])
    
    pk_hex = "6e42f8e589a76ebb13ef279df7841efce978f106bee196f0e3cfd347bb31a2e8"
