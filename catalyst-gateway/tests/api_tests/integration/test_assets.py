...
def test_persistent_ada_amount_endpoint():
    ...
    for i, (stake_addr, entry) in enumerate(test_data.items()):
        ...
        try:
            ...
            logger.error(f"Assertion failed: Ada amount for '{stake_addr}', expected: {expected_amt}, received: {received_amt}")
            pass
        ...
        try:
            ...
            logger.error(f"Assertion failed: Token count for '{stake_addr}', expected: {expected_token_len}, received: {received_token_len}")
            pass
