...
const CATEGORY_DOCUMENTS: [(&str, &[u8]); 12] = [
...
const PROPOSAL_TEMPLATES: [(&str, &str); 12] = [
    ...
    ("0194d492-1daa-75b5-b4a4-5cf331cd8d1a", CATEGORY_DOCUMENTS[0].0),
    ("0194d492-1daa-7371-8bd3-c15811b2b063", CATEGORY_DOCUMENTS[1].0),
    ("0194d492-1daa-79c7-a222-2c3b581443a8", CATEGORY_DOCUMENTS[2].0),
    ("0194d492-1daa-716f-a04e-f422f08a99dc", CATEGORY_DOCUMENTS[3].0),
    ("0194d492-1daa-78fc-818a-bf20fc3e9b87", CATEGORY_DOCUMENTS[4].0),
    ("0194d492-1daa-7d98-a3aa-c57d99121f78", CATEGORY_DOCUMENTS[5].0),
    ("0194d492-1daa-77be-a1a5-c238fe25fe4f", CATEGORY_DOCUMENTS[6].0),
    ("0194d492-1daa-7254-a512-30a4cdecfb90", CATEGORY_DOCUMENTS[7].0),
    ("0194d492-1daa-7de9-b535-1a0b0474ed4e", CATEGORY_DOCUMENTS[8].0),
...
const COMMENT_TEMPLATES: [(&str, &str); 12] = [
    //        ID and Version                |      Category ID
    ("0194d494-4402-7e0e-b8d6-171f8fea18b0", CATEGORY_DOCUMENTS[0].0),
    ("0194d494-4402-7444-9058-9030815eb029", CATEGORY_DOCUMENTS[1].0),
    ("0194d494-4402-7351-b4f7-24938dc2c12e", CATEGORY_DOCUMENTS[2].0),
    ("0194d494-4402-79ad-93ba-4d7a0b65d563", CATEGORY_DOCUMENTS[3].0),
    ("0194d494-4402-7cee-a5a6-5739839b3b8a", CATEGORY_DOCUMENTS[4].0),
    ("0194d494-4402-7aee-8b24-b5300c976846", CATEGORY_DOCUMENTS[5].0),
    ("0194d494-4402-7d75-be7f-1c4f3471a53c", CATEGORY_DOCUMENTS[6].0),
    ("0194d494-4402-7a2c-8971-1b4c255c826d", CATEGORY_DOCUMENTS[7].0),
    ("0194d494-4402-7074-86ac-3efd097ba9b0", CATEGORY_DOCUMENTS[8].0),
    ("0194d494-4402-7202-8ebb-8c4c47c286d8", CATEGORY_DOCUMENTS[9].0),
    ("0194d494-4402-7fb5-b680-c23fe4beb088", CATEGORY_DOCUMENTS[10].0),
