...
// #[error(" Schema in database does not match schema supported by the Crate. The current
// schema version: {was}, the schema version we expected: {expected}")] pub(crate) struct
// MismatchedSchemaError {     /// The current DB schema version.
//     was: i32,
