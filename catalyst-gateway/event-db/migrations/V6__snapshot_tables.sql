...
CREATE UNIQUE INDEX unique_voter_id ON voter (
  voting_key, voting_group, snapshot_id
);
...
CREATE UNIQUE INDEX unique_contribution_id ON contribution (
  stake_public_key, voting_key, voting_group, snapshot_id
);
