...
#### `catalyst_analysis` - `v2.0.0`
 ...
 - **FEAT**: improve fornted app architecure ([#158](https://github.com/input-output-hk/catalyst-voices/issues/158)). ([1a9e7950](https://github.com/input-output-hk/catalyst-voices/commit/1a9e7950346689fd56ebd911b60f3f8eb7671e60))
