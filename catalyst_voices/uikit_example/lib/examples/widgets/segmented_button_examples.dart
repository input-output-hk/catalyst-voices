...
class SegmentedButtonExamples extends StatefulWidget {
  const SegmentedButtonExamples({
    super.key,
  });

  @override
  State<SegmentedButtonExamples> createState() {
    return _SegmentedButtonExamplesState();
  }
}

class _SegmentedButtonExamplesState extends State<SegmentedButtonExamples> {
