...
import 'package:catalyst_voices/pages/proposal_viewer/widget/proposal_collaborator_banner_widgets.dart';
import 'package:catalyst_voices/pages/proposal_viewer/widget/proposal_collaborator_dialog.dart';
...
class ProposalCollaboratorBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocSelector<ProposalViewerCubit, ProposalViewerState, CollaboratorProposalState>(
...
class _AcceptFinalProposalButton extends StatelessWidget {
  ...
  Future<void> _showDialog(BuildContext context) async {
    ...
    if (accepted && context.mounted) {
      unawaited(context.read<ProposalViewerCubit>().acceptFinalProposal());
    }
  }
}
...
class _AcceptInvitationButton extends StatelessWidget {
  ...
  Future<void> _showDialog(BuildContext context) async {
    ...
    if (accepted && context.mounted) {
      unawaited(context.read<ProposalViewerCubit>().acceptCollaboratorInvitation());
    }
  }
}
...
class _ChangeToDenyFinalProposalButton extends StatelessWidget {
  ...
  void _rejectProposal(BuildContext context) {
    unawaited(context.read<ProposalViewerCubit>().rejectFinalProposal());
  }
}
...
class _ChangeToDenyInvitationButton extends StatelessWidget {
  ...
  void _rejectInvitation(BuildContext context) {
    unawaited(context.read<ProposalViewerCubit>().rejectCollaboratorInvitation());
  }
}
