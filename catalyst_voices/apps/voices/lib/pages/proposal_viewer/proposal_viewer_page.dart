...
import 'package:catalyst_voices/pages/proposal_viewer/proposal_viewer_content.dart';
import 'package:catalyst_voices/pages/proposal_viewer/proposal_viewer_error.dart';
import 'package:catalyst_voices/pages/proposal_viewer/proposal_viewer_loading.dart';
...
class _ProposalViewerPageState extends State<ProposalViewerPage>
    with
        ErrorHandlerStateMixin<ProposalViewerCubit, ProposalViewerPage>,
        SignalHandlerStateMixin<ProposalViewerCubit, ProposalSignal, ProposalViewerPage> {
              ...
              children: [
                ProposalHeaderWrapper(
                  child: ProposalSidebars(
                    ...
                    body: ProposalViewerContent(
                      scrollController: _segmentsScrollController,
                    ),
                  ),
                ),
                const ProposalViewerLoading(),
              ],
            ),
          ),
          const ProposalViewerError(),
        ],
      ),
    );
  }
  ...
  @override
  void didUpdateWidget(covariant ProposalViewerPage oldWidget) {
...
class _ScrollToTopButtonState extends State<_ScrollToTopButton> {
  ...
  void _handleScrollNotification(ScrollNotification notification) {
    if (notification is ScrollUpdateNotification) {
      ...
      // Only react to content scroll from ProposalViewerContent, not menu
      if (element?.findAncestorWidgetOfExactType<ProposalViewerContent>() != null) {
