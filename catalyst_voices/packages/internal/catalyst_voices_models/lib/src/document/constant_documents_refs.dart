...
const constantDocumentsRefs = <CategoryTemplatesRefs>[
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-7043-8c5c-f0e09f8a6d8c'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-7e75-95c1-a6cf0e8086d9'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-7703-a1c0-83a916b001e7'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-79d1-9a0f-84943123ef38'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-706d-91c6-0d4707f74cdf'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-759e-b729-304306fbaa5e'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-7e27-b5fd-de3133b54bf6'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-7f9e-8a5d-91fb67c078f2'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-7676-9658-36c0b67e656e'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-7978-b031-7aa2ccc5e3fd'),
  ...
  CategoryTemplatesRefs(
    category: SignedDocumentRef.first('0194d490-30bf-7d34-bba9-8498094bd627'),
