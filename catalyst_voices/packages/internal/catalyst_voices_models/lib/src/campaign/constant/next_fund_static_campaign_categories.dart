...
final nextFundCampaignCategories = [
  ...
  f15StaticCampaignCategories[1].copyWith(
    campaignRef: Campaign.dynamicNextFundRef,
    selfRef: const SignedDocumentRef.first('019b2863-7e39-76c0-ab9d-3d78cac2da5a'),
  ),
  f15StaticCampaignCategories[2].copyWith(
    campaignRef: Campaign.dynamicNextFundRef,
    selfRef: const SignedDocumentRef.first('019b2b86-7507-7b95-929e-74e3bffb030d'),
  ),
];
