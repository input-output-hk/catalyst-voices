...
final class UploaderServiceImpl with FilePathHelperMixin implements UploaderService {
  ...
  @override
  Future<VoicesFile?> uploadFile({List<String>? allowedExtensions}) async {
    ...
    final result = await FilePicker.platform.pickFiles(
      ...
      allowedExtensions: (allowedExtensions != null) ? allowedExtensions : null,
