...
/// [brands] is a Map that stores the ThemeData for all the available brands in
/// the Catalyst Voices app.
/// 
/// This map is used by the BrandBloc to properly switch the active theme based
/// on the BlocState.
