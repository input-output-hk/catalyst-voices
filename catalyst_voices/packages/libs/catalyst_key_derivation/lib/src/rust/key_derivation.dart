...
Future<Bip32Ed25519XPrivateKey> mnemonicToXprv({
  ...
  String? passphrase,
}) => RustLib.instance.api.crateKeyDerivationMnemonicToXprv(
  mnemonic: mnemonic,
...
abstract class Bip32Ed25519Signature implements RustOpaqueInterface {
  ...
  factory Bip32Ed25519Signature({required U8Array64 sigBytes}) =>
      RustLib.instance.api.crateKeyDerivationBip32Ed25519SignatureNew(sigBytes: sigBytes);
...
abstract class Bip32Ed25519XPrivateKey implements RustOpaqueInterface {
  ...
  factory Bip32Ed25519XPrivateKey({required U8Array96 xprvBytes}) =>
      RustLib.instance.api.crateKeyDerivationBip32Ed25519XPrivateKeyNew(xprvBytes: xprvBytes);
...
abstract class Bip32Ed25519XPublicKey implements RustOpaqueInterface {
  ...
  factory Bip32Ed25519XPublicKey({required U8Array64 xpubBytes}) =>
      RustLib.instance.api.crateKeyDerivationBip32Ed25519XPublicKeyNew(xpubBytes: xpubBytes);
...
class U8Array96 extends NonGrowableListView<int> {
  ...
  U8Array96(this._inner) : assert(_inner.length == arraySize), super(_inner);
