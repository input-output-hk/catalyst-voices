...
import 'package:catalyst_cardano_web/src/interop/catalyst_cardano_wallet_decorator.dart';
...
final class CatalystCardanoWeb extends CatalystCardanoPlatform {
  ...
  Future<List<CardanoWallet>> getWallets() async {
    ...
    return wallets.map((e) => CardanoWalletAccountChangeDecorator(e.toDart)).toList();
  }
