import { ew as AccountDB, ex as el, ey as sl, ez as getLegacyNotes, eA as createValueJSON, eB as getAddressCredentials, eC as getOwnedCred, eD as add, eE as addValueToValue, eF as createIUtxo, eG as decodeHex, c5 as getAssetIdBech32, eH as createITxBalance, eI as RefDB, eJ as CertificateTypes, eK as createJsonFromCborJson, a4 as now, bj as getUtxoHash, eL as loadUtxoCborFromTxList, eM as loadUtxoByronList, eN as getCSLTransactionOutput, eO as getTransactionOutputJSONFromCSL, b2 as safeFreeCSLObject, eP as createIUtxoFromIUtxoDetails, cO as ITxBalanceType, eQ as compare, cI as abs, z as ref, f as computed, d as defineComponent, a9 as useQuasar, eR as numTxTotal, eS as numTxLoaded, aI as onUnmounted, o as openBlock, c as createElementBlock, e as createBaseVNode, q as createVNode, u as unref, j as createCommentVNode, a as createBlock, t as toDisplayString, Q as QSpinnerDots_default, H as Fragment, I as renderList, ca as QToggle_default, ag as useSelectedAccount, k as dispatchSignalSync, l as doForceSyncImportantAccounts, eT as HistoryDB, eU as getRewardHistory, D as watch, at as appLanguageTag, h as withCtx, cb as QBtn_default, cc as QPopupProxy_default, cd as QDate_default, F as withDirectives, b as withModifiers, i as createTextVNode, eV as QTime_default, an as appUseUtc, B as useFormatter, eW as getCalculatedSlotFromBlockTime, K as networkId, cY as multiply, eX as createTxSearchConfig, eY as ClosePopup_default, eZ as hasSearchConfig, e_ as txListPage, cs as onErrorCaptured, e$ as getPendingTxList, f0 as numItemsPerPage, C as onMounted, et as Transition, n as normalizeClass, f1 as numMaxSearchResults, f2 as currentPage, T as isRef, f3 as numMaxPages, aJ as QPagination_default, f4 as isUpdating, f5 as searchTxList, c2 as isZero } from "./index.js";
...
import { _ as _sfc_main$6 } from "./GridLoading.vue_vue_type_script_setup_true_lang.js";
...
import { _ as _sfc_main$7 } from "./GridTxListBalance.vue_vue_type_script_setup_true_lang.js";
...
const _hoisted_21 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-1" }, "(", -1);
const _hoisted_22 = { class: "mt-0.5 ml-0.5 cc-addr" };
const _hoisted_23 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-0.5 cc-addr" }, "/", -1);
const _hoisted_24 = { class: "mt-0.5 ml-0.5 cc-addr" };
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-0.5" }, ").", -1);
          ...
          createBaseVNode("div", _hoisted_18, [
            createBaseVNode("div", _hoisted_19, [
              ...
              unref(isHistorySyncEnabled) ? (openBlock(), createElementBlock("div", _hoisted_20, [
                _hoisted_21,
                createBaseVNode("span", _hoisted_22, toDisplayString(unref(loadedTxCnt)), 1),
                _hoisted_23,
                createBaseVNode("span", _hoisted_24, toDisplayString(unref(totalTxCnt)), 1),
                _hoisted_25
              ])) : createCommentVNode("", true)
            ]),
            createBaseVNode("div", null, toDisplayString(unref(t)("wallet.transactions.filter.syncinfo_line2")), 1),
            !unref(isHistorySyncEnabled) ? (openBlock(), createElementBlock("div", _hoisted_26, toDisplayString(unref(t)("wallet.transactions.filter.autosync")), 1)) : createCommentVNode("", true)
          ])
        ])) : createCommentVNode("", true)
      ], 64);
    };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watch(tabId, (value, oldValue) => {
      console.log("FILTER WATCH >>>>>>> ", value, oldValue);
      filterByTabId();
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        unref(isUpdating) && unref(txListPage).length === 0 ? (openBlock(), createBlock(_sfc_main$6, {
          key: 3,
