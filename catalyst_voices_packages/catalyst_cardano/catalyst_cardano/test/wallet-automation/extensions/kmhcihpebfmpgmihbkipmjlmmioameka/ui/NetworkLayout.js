...
import { u as useKeystoneDevice, _ as _sfc_main$U, s as signData, v as verifyData } from "./Keystone.vue_vue_type_script_setup_true_lang.js";
    ...
    const doSignData = async (_payload) => {
      ...
      try {
        ...
        if (isMnemonic.value) {
          ...
          verifyData(signedData.value.signature, payload.value);
