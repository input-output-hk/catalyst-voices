import { d as defineComponent, a9 as useQuasar, a7 as toRefs, bf as useWalletAccount, z as ref, f as computed, eD as add, D as watch, o as openBlock, c as createElementBlock, e as createBaseVNode, t as toDisplayString, u as unref, j as createCommentVNode, F as withDirectives, g8 as vModelText, ad as withKeys, b as withModifiers, q as createVNode, Q as QSpinnerDots_default, a0 as isStagingApp, h as withCtx, i as createTextVNode, a as createBlock, n as normalizeClass } from "./index.js";
...
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-information" }, null, -1);
const _hoisted_11 = { class: "cc-text-xs cc-text-normal" };
const _hoisted_12 = { class: "w-full flex flex-row flex-nowrap justify-between" };
const _hoisted_13 = { class: "flex-1 cc-text-bold" };
const _hoisted_14 = {
  key: 0,
  class: "w-full flex flex-row flex-nowrap justify-between"
};
const _hoisted_15 = { class: "flex-1 cc-text-inactive" };
const _hoisted_16 = {
  key: 1,
  class: "w-full flex flex-row flex-nowrap justify-between"
};
const _hoisted_17 = { class: "flex-1 cc-text-inactive" };
const _hoisted_18 = {
  key: 3,
  class: "w-full flex flex-row flex-nowrap justify-between"
};
const _hoisted_19 = { class: "mdi mdi-information-outline" };
const _hoisted_20 = {
  key: 4,
  class: "w-full flex flex-row flex-nowrap justify-between"
};
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            ...
            unref(isAccountSyncing) ? (openBlock(), createElementBlock("div", _hoisted_8, [
              createVNode(QSpinnerDots_default, {
                color: "gray",
                size: "1rem"
              })
            ])) : createCommentVNode("", true),
            unref(isStagingApp)() ? (openBlock(), createElementBlock("div", _hoisted_9, [
              _hoisted_10,
          ...
          createBaseVNode("span", _hoisted_11, "(" + toDisplayString(unref(accountPath)) + ")", 1)
        ]),
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_12, [
            createBaseVNode("span", _hoisted_13, toDisplayString(unref(it)("common.balance.total")), 1),
          ...
          !__props.showOnlyTotal ? (openBlock(), createElementBlock("div", _hoisted_14, [
            createBaseVNode("span", _hoisted_15, toDisplayString(unref(it)("common.balance.balance")), 1),
            createVNode(_sfc_main$2, {
          ...
          !__props.showOnlyTotal ? (openBlock(), createElementBlock("div", _hoisted_16, [
            createBaseVNode("span", _hoisted_17, toDisplayString(unref(it)("common.balance.rewards")), 1),
            createVNode(_sfc_main$2, {
          ...
          localControlledStake.value && !__props.showOnlyTotal ? (openBlock(), createElementBlock("div", _hoisted_18, [
          ...
          localControlledStake.value && !__props.showOnlyTotal ? (openBlock(), createElementBlock("div", _hoisted_20, [
            createBaseVNode("span", {
