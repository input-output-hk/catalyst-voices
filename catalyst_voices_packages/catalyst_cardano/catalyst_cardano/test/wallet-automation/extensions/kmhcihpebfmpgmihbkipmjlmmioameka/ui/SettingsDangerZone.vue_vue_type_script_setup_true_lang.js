...
import { d as defineComponent, a9 as useQuasar, z as ref, gO as createIUIBackground, f as computed, w as watchEffect, C as onMounted, aI as onUnmounted, o as openBlock, a as createBlock, h as withCtx, e as createBaseVNode, q as createVNode, u as unref, t as toDisplayString, b as withModifiers, j as createCommentVNode, a1 as isBexApp, K as networkId, gP as encodeHex, c as createElementBlock, a4 as now, aG as createWalletDownloadable, ag as useSelectedAccount, H as Fragment, k as dispatchSignalSync, gQ as doFullWalletResync, fG as dispatchSignalSyncTo, gR as doFullAccountResync, aX as useRoute, D as watch, U as reactive, aC as renderSlot, gS as getVkFromXpub, gT as getXvkFromXpub, X as nextTick, F as withDirectives, J as vShow, i as createTextVNode, b0 as decryptText, da as purpose, a2 as isMobileApp, ev as __vitePreload, fl as isValidSendAddress, gU as getAddressType, gV as minCollateral, gW as maxCollateral, I as renderList, n as normalizeClass, B as useFormatter, aY as addSignalListener, aZ as removeSignalListener, fZ as getTxBuiltErrorMsg, fU as ErrorBuildTx, gX as onBuiltTxCollateral, bn as dispatchSignal, gY as doBuildTxCollateral, gZ as getOwnedCredFromAddrBech32, g_ as getDerivationPath, c2 as isZero, eQ as compare, g$ as onBuiltTxDeregistration, h0 as doBuildTxDeregistration, h1 as ReportingAccountType, aS as onNetworkFeaturesUpdated, ce as getRandomId, aQ as deleteWallet, h2 as loadWalletList } from "./index.js";
...
import { u as useKeystoneDevice, _ as _sfc_main$r } from "./Keystone.vue_vue_type_script_setup_true_lang.js";
import { u as useBalanceVisible } from "./useBalanceVisible.js";
import { _ as _sfc_main$u } from "./Tooltip.vue_vue_type_script_setup_true_lang.js";
import { _ as _sfc_main$t } from "./GridTextArea.vue_vue_type_script_setup_true_lang.js";
import { _ as _sfc_main$s } from "./AccessPasswordInputModal.vue_vue_type_script_setup_true_lang.js";
import { G as GridInputAutocomplete } from "./GridInputAutocomplete.js";
import { _ as _sfc_main$v } from "./ScanQrCode.vue_vue_type_script_setup_true_lang.js";
import { p as processFile } from "./scanner.js";
import { u as useAdaSymbol } from "./useAdaSymbol.js";
import { _ as _sfc_main$w } from "./GridAccountUtxoItem.vue_vue_type_script_setup_true_lang.js";
import { _ as _sfc_main$y } from "./GridButtonWarning.vue_vue_type_script_setup_true_lang.js";
import { _ as _sfc_main$x } from "./GridToggle.vue_vue_type_script_setup_true_lang.js";
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a, _b;
      return openBlock(), createElementBlock(Fragment, null, [
        ((_a = unref(appAccount)) == null ? void 0 : _a.isKeystone) ? (openBlock(), createBlock(_sfc_main$r, {
          key: 0,
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        ...
        hasBuildError.value ? (openBlock(), createElementBlock("div", _hoisted_6$1, [
          hasBuildError.value ? (openBlock(), createBlock(_sfc_main$t, {
            key: 0,
