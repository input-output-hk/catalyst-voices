...
import { d as defineComponent, bf as useWalletAccount, U as reactive, w as watchEffect, aI as onUnmounted, o as openBlock, c as createElementBlock, q as createVNode, u as unref, e as createBaseVNode, H as Fragment, I as renderList, j as createCommentVNode, a as createBlock, dd as useUiSelectedAccount, d7 as getWalletNameList, dj as selectedWalletId, t as toDisplayString, z as ref, i as createTextVNode, n as normalizeClass, B as useFormatter, a7 as toRefs, f as computed, K as networkId, h as withCtx, a9 as useQuasar, C as onMounted, D as watch, df as walletsExists, bH as onBeforeMount, b as withModifiers, X as nextTick, dk as getRewardAddressFromCred, aJ as QPagination_default, cs as onErrorCaptured } from "./index.js";
...
const _hoisted_9$3 = { class: "w-full cc-text-bold text-xs justify-start" };
const _hoisted_10$3 = ["href"];
const _hoisted_11$2 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-open-in-new ml-1" }, null, -1);
const _hoisted_12$1 = {
  key: 0,
  class: "grid grid-cols-12 w-full"
};
const _hoisted_13$1 = { class: "col-span-12 cc-area-light-1 p-2 m-1" };
const _hoisted_14$1 = { class: "col-span-4 text-xs pr-2" };
const _hoisted_15$1 = { class: "col-span-8 cc-text-bold justify-start" };
const _hoisted_16$1 = {
  key: 1,
  class: "grid grid-cols-12 w-full"
};
const _hoisted_17$1 = { class: "col-span-6 cc-area-light-1 p-2 m-1 overflow-x-scroll" };
const _hoisted_18$1 = { class: "col-span-12 text-xs" };
const _hoisted_19$1 = { class: "col-span-12 cc-text-bold justify-start" };
const _hoisted_20$1 = { class: "col-span-6 cc-area-light-1 py-2 my-1 pl-2 ml-1" };
const _hoisted_21$1 = { class: "col-span-12 text-xs" };
const _hoisted_22$1 = { class: "col-span-12 cc-text-bold justify-start overflow-x-scroll" };
const _hoisted_23$1 = { class: "grid grid-cols-12 w-full" };
const _hoisted_24$1 = { class: "col-span-6 cc-area-light-1 p-2 m-1" };
const _hoisted_25$1 = { class: "w-full grid grid-cols-12" };
const _hoisted_26$1 = { class: "col-span-6" };
const _hoisted_27$1 = { class: "w-full" };
const _hoisted_28$1 = { class: "w-full text-xs pr-2" };
const _hoisted_29$1 = { class: "w-full text-bold" };
const _hoisted_30$1 = { class: "w-full mt-2 text-xs" };
const _hoisted_31$1 = { class: "w-full text-xs pr-2" };
const _hoisted_32$1 = { class: "w-full text-bold" };
const _hoisted_33$1 = {
  key: 0,
  class: "col-span-6 flex justify-center items-center"
};
const _hoisted_34$1 = { class: "flex flex-col items-center" };
const _hoisted_35$1 = {
  class: "cc-text-bold flex-grow",
  id: "A2"
};
const _hoisted_36$1 = ["src"];
const _hoisted_37$1 = { class: "col-span-6 cc-area-light-1 py-2 my-1 pl-2 ml-1" };
const _hoisted_38$1 = { class: "w-full" };
const _hoisted_39 = { class: "w-full text-xs pr-2" };
const _hoisted_40 = { class: "w-full py-2 my-1" };
const _hoisted_41 = { class: "w-full col-span-12 grid grid-cols-12" };
const _hoisted_42 = { class: "col-span-4 cc-text-bold pr-2" };
const _hoisted_43 = { class: "col-span-8 justify-start" };
const _hoisted_44 = { class: "w-full col-span-12 grid grid-cols-12" };
const _hoisted_45 = { class: "col-span-4 cc-text-bold pr-2" };
const _hoisted_46 = { class: "col-span-8 justify-start" };
const _hoisted_47 = {
  key: 0,
  class: "w-full col-span-12 grid grid-cols-12"
};
const _hoisted_48 = { class: "col-span-4 cc-text-bold pr-2" };
const _hoisted_49 = { class: "col-span-8 justify-start" };
const _hoisted_50 = { class: "w-full col-span-12 grid grid-cols-12 justify-end" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        ...
        __props.wcInfo.connectError ? (openBlock(), createElementBlock("div", _hoisted_12$1, [
          createBaseVNode("div", _hoisted_13$1, [
            createBaseVNode("div", _hoisted_14$1, toDisplayString(unref(it)("walletconnect.connect.label.error")), 1),
            createBaseVNode("div", _hoisted_15$1, toDisplayString(__props.wcInfo.connectError), 1)
          ])
        ])) : createCommentVNode("", true),
        __props.wcInfo.session ? (openBlock(), createElementBlock("div", _hoisted_16$1, [
          createBaseVNode("div", _hoisted_17$1, [
            createBaseVNode("div", _hoisted_18$1, toDisplayString(unref(it)("directconnect.connect.labels.walletConnectionId")), 1),
            createBaseVNode("div", _hoisted_19$1, toDisplayString(__props.wcInfo.wcId), 1)
          ]),
          createBaseVNode("div", _hoisted_20$1, [
            createBaseVNode("div", _hoisted_21$1, toDisplayString(unref(it)("directconnect.connect.labels.address")), 1),
            createBaseVNode("div", _hoisted_22$1, toDisplayString(__props.wcInfo.session.topic), 1)
          ])
        ])) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_23$1, [
            ...
            createBaseVNode("div", _hoisted_25$1, [
              createBaseVNode("div", _hoisted_26$1, [
                createBaseVNode("div", _hoisted_27$1, [
                  createBaseVNode("div", _hoisted_28$1, toDisplayString(unref(it)("directconnect.connect.labels.walletId")), 1)
                ]),
                createBaseVNode("div", _hoisted_29$1, toDisplayString(unref(walletName)), 1),
                createBaseVNode("div", _hoisted_30$1, [
                  createBaseVNode("div", _hoisted_31$1, toDisplayString(unref(it)("directconnect.connect.labels.accountPubKey")), 1)
                ]),
                createBaseVNode("div", _hoisted_32$1, toDisplayString(unref(accountName)), 1)
              ]),
              __props.wcInfo.dAppInfo ? (openBlock(), createElementBlock("div", _hoisted_33$1, [
                createBaseVNode("div", _hoisted_34$1, [
                  createBaseVNode("div", _hoisted_35$1, [
                    ...
                    }, null, 10, _hoisted_36$1)) : createCommentVNode("", true)
                  ])
                ])
              ])) : createCommentVNode("", true)
            ])
          ...
          createBaseVNode("div", _hoisted_37$1, [
            createBaseVNode("div", _hoisted_38$1, [
              createBaseVNode("div", _hoisted_39, toDisplayString(unref(it)("directconnect.connect.labels.info")), 1)
            ]),
            createBaseVNode("div", _hoisted_40, [
              createBaseVNode("div", _hoisted_41, [
                createBaseVNode("div", _hoisted_42, toDisplayString(unref(it)("directconnect.connect.labels.lastActive")), 1),
                createBaseVNode("div", _hoisted_43, toDisplayString(unref(formatDatetime)(__props.wcInfo.lastActive ?? 0)), 1)
              ]),
              createBaseVNode("div", _hoisted_44, [
                createBaseVNode("div", _hoisted_45, toDisplayString(unref(it)("directconnect.connect.labels.created")), 1),
                createBaseVNode("div", _hoisted_46, toDisplayString(unref(formatDatetime)(__props.wcInfo.created)), 1)
              ]),
              ((_d2 = __props.wcInfo.session) == null ? void 0 : _d2.expiry) ? (openBlock(), createElementBlock("div", _hoisted_47, [
                createBaseVNode("div", _hoisted_48, toDisplayString(unref(it)("walletconnect.connect.labels.expire")), 1),
                createBaseVNode("div", _hoisted_49, toDisplayString(unref(formatDatetime)(__props.wcInfo.session.expiry * 1e3)), 1)
              ])) : createCommentVNode("", true)
            ])
          ])
        ]),
...
const _hoisted_9$2 = { class: "grid grid-cols-12 w-full" };
const _hoisted_10$2 = { class: "col-span-12 cc-area-light-1 p-2 m-1" };
const _hoisted_11$1 = { class: "col-span-4 text-xs pr-2" };
          ...
          return [
            ...
            createBaseVNode("div", _hoisted_9$2, [
              createBaseVNode("div", _hoisted_10$2, [
                createBaseVNode("div", _hoisted_11$1, toDisplayString(unref(it)("walletconnect.connect.modal.url")), 1),
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        ...
        createBaseVNode("div", _hoisted_3$3, [
          ...
          walletConnectionId.value && wcInfo.value ? (openBlock(), createElementBlock("div", _hoisted_9$1, [
          ...
          unref(walletsExists) ? (openBlock(), createElementBlock("div", _hoisted_10$1, [
...
const _hoisted_4$1 = /* @__PURE__ */ createBaseVNode("i", { class: "relative text-xl mt-0 mdi mdi-application" }, null, -1);
const _hoisted_5 = { class: "relative cc-text-bold mr-0.5" };
const _hoisted_6 = { class: "ml-6 mt-1 cc-addr break-normal" };
const _hoisted_7 = { class: "relative col items-center w-full max-w-full" };
const _hoisted_8 = {
  key: 0,
  class: "w-10 h-10 flex flex-row flex-nowrap justify-end items-center"
};
const _hoisted_9 = /* @__PURE__ */ createBaseVNode("button", {
  type: "button",
  ...
  /* @__PURE__ */ createBaseVNode("i", { class: "cc-text-green text-xs relative top-3 -left-2" }, "P2P")
], -1);
const _hoisted_10 = {
  key: 1,
  class: "w-10 h-10 flex flex-row flex-nowrap justify-end items-center"
};
const _hoisted_11 = /* @__PURE__ */ createBaseVNode("button", {
  type: "button",
  "aria-label": "sync wallet",
  class: "relative h-full text-md sm:text-xl px-2.5 flex flex-col justify-center items-center cursor-pointer cc-text-highlight-hover"
}, [
  ...
  /* @__PURE__ */ createBaseVNode("i", { class: "text-xs relative top-3 -left-2" }, "P2P")
], -1);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const toggleConnection = (event) => {
      var _a2;
      log$1("toggle connection coming from detail in list view", walletConnectInfo == null ? void 0 : walletConnectInfo.value);
            ...
            createBaseVNode("div", _hoisted_1$2, [
              createBaseVNode("div", _hoisted_2$2, [
                ...
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_5, toDisplayString((_b2 = (_a2 = unref(walletConnectInfo)) == null ? void 0 : _a2.dAppInfo) == null ? void 0 : _b2.name), 1),
              ...
              createBaseVNode("div", _hoisted_6, toDisplayString((_f2 = (_e2 = unref(walletConnectInfo)) == null ? void 0 : _e2.dAppInfo) == null ? void 0 : _f2.url), 1)
            ]),
            createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_7, [
                ((_g2 = unref(walletConnectInfo)) == null ? void 0 : _g2.active) ? (openBlock(), createElementBlock("div", _hoisted_8, [
                  _hoisted_9,
                  createVNode(_sfc_main$d, {
                    anchor: "center right",
                    self: "center left",
                ...
                !((_h = unref(walletConnectInfo)) == null ? void 0 : _h.active) ? (openBlock(), createElementBlock("div", _hoisted_10, [
                  _hoisted_11,
                  createVNode(_sfc_main$d, {
                    anchor: "center right",
                    self: "center left",
