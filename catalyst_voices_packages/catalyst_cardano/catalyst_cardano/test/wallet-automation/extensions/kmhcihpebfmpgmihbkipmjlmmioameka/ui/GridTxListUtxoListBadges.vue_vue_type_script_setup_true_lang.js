import { z as ref, d as defineComponent, a7 as toRefs, f as computed, fz as addressBook, bZ as reportLabelList, gK as getIAppAccountById, fs as getIAppAccountByCred, d9 as getIAppWallet, ft as getAccountName, it as getContractProperty, fb as getDonationAddress, K as networkId, iu as getBurnAddress, iv as getFeeAddress, iw as getSwapFeeAddressMS, ix as getSwapFeeAddressDH, o as openBlock, c as createElementBlock, e as createBaseVNode, i as createTextVNode, t as toDisplayString, q as createVNode, h as withCtx, u as unref, b as withModifiers, S as normalizeStyle, fx as isScriptAddress, j as createCommentVNode, a as createBlock, b_ as addReportLabel, iy as useSelectedAccount } from "./index.js";
...
const _hoisted_7 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-heart text-[0.60rem] text-red-500 -mx-0.5" }, null, -1);
const _hoisted_8 = { key: 3 };
const _hoisted_9 = { class: "cc-badge-green whitespace-nowrap inline-block" };
const _hoisted_10 = {
  key: 4,
  class: "flex flex-row flex-nowrap space-x-1 h-5"
};
const _hoisted_11 = { class: "cc-badge-gray whitespace-nowrap inline-block" };
const _hoisted_12 = {
  key: 5,
  class: "flex flex-row flex-nowrap space-x-1 h-5"
};
const _hoisted_13 = { class: "cc-badge-gray whitespace-nowrap inline-block" };
const _hoisted_14 = { key: 6 };
const _hoisted_15 = { key: 7 };
const _hoisted_16 = { class: "cc-badge-yellow whitespace-nowrap inline-block" };
...
const _hoisted_20 = { class: "cc-badge-gray inline-block" };
const _hoisted_21 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-book-outline mr-1" }, null, -1);
const _hoisted_22 = { key: 10 };
const _hoisted_23 = { class: "cc-badge-dark inline-block" };
const _hoisted_24 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-list-box-outline mr-1" }, null, -1);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return address.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        ])) : address.value === unref(burnAddr) ? (openBlock(), createElementBlock("div", _hoisted_8, [
        ...
        ])) : address.value === unref(swapFeeAddrMS) || unref(swapFeeAddrDH).includes(address.value) ? (openBlock(), createElementBlock("div", _hoisted_10, [
        ...
        ])) : address.value === unref(feeAddr) ? (openBlock(), createElementBlock("div", _hoisted_12, [
        ...
        ])) : property.value ? (openBlock(), createElementBlock("div", _hoisted_14, [
          createBaseVNode("div", {
        ...
        ])) : unref(isScriptAddress)(address.value) ? (openBlock(), createElementBlock("div", _hoisted_15, [
        ...
        ])) : !__props.txViewer ? (openBlock(), createElementBlock("div", _hoisted_17, [
          !reportLabelEntry.value ? (openBlock(), createElementBlock("div", _hoisted_18, [
        ...
        addressBookEntry.value ? (openBlock(), createElementBlock("div", _hoisted_19, [
          createBaseVNode("span", _hoisted_20, [
            _hoisted_21,
            createTextVNode(toDisplayString(addressBookEntry.value.name), 1)
          ])
        ])) : createCommentVNode("", true),
        reportLabelEntry.value ? (openBlock(), createElementBlock("div", _hoisted_22, [
