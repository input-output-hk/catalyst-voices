import { o as openBlock, c as createElementBlock, e as createBaseVNode, d as defineComponent, f as computed, kc as getSortedAssetList, D as watch, z as ref, b as withModifiers, H as Fragment, I as renderList, t as toDisplayString, j as createCommentVNode, q as createVNode, u as unref, a as createBlock, a0 as isStagingApp, ag as useSelectedAccount, X as nextTick, K as networkId } from "./index.js";
import { u as useTranslation } from "./useTranslation.js";
import { u as useDAppBrowserEvents, _ as _sfc_main$6, D as DAppEntryEvent, e as entryList } from "./DAppIframe.vue_vue_type_script_setup_true_lang.js";
...
const _hoisted_3$5 = /* @__PURE__ */ createBaseVNode("g", null, [
...
const _hoisted_2$4 = { class: "flex flex-col flex-nowrap" };
const _hoisted_3$4 = /* @__PURE__ */ createBaseVNode("div", { class: "font-bold text-sm" }, "Open ADAmail", -1);
const _hoisted_4$3 = { key: 0 };
const _hoisted_5$1 = { class: "grow flex flex-col flex-nowrap justify-center items-end" };
const _hoisted_6$1 = {
  key: 1,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        adaMailPassList.value.length > 0 ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_1$4, [
            createBaseVNode("div", _hoisted_2$4, [
              ...
              adaMailPassShortList.value.length < adaMailPassList.value.length ? (openBlock(), createElementBlock("div", _hoisted_4$3, "...")) : createCommentVNode("", true)
            ]),
        ...
        showDappBrowserEntry.value && dappBrowserEntry && unref(walletData) && unref(accountData) ? (openBlock(), createElementBlock("div", _hoisted_6$1, [
...
const _hoisted_2$3 = /* @__PURE__ */ createBaseVNode("div", { class: "flex flex-col flex-nowrap" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "font-bold text-sm" }, "Register your ADAmail"),
  /* @__PURE__ */ createBaseVNode("div", null, "yournamehere@adamail.me")
], -1);
const _hoisted_3$3 = { class: "grow flex flex-col flex-nowrap justify-center items-end" };
...
const _hoisted_2$1 = /* @__PURE__ */ createBaseVNode("div", { class: "flex flex-col flex-nowrap" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "font-bold text-sm" }, "Mint your ADA Handle"),
  /* @__PURE__ */ createBaseVNode("div", null, "$youradahandle")
], -1);
const _hoisted_3$1 = { class: "grow flex flex-col flex-nowrap justify-center items-end" };
const _hoisted_4$1 = {
  key: 0,
  class: "absolute top-0 left-0 w-0 h-0 overflow-hidden"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        showDappBrowserEntry.value && dappBrowserEntry.value && unref(walletData) && unref(accountData) ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
          (openBlock(), createBlock(_sfc_main$6, {
...
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("span", { class: "col-span-12" }, "No entries", -1);
const _hoisted_6 = [
  _hoisted_5
];
