...
const _hoisted_6 = /* @__PURE__ */ createBaseVNode("div", { class: "shrink-0 cc-icon-round-xxxs shadow-0 cc-bg-highlight" }, null, -1);
const _hoisted_7 = [
  _hoisted_6
];
const _hoisted_8 = { class: "ml-3 flex flex-col justify-start items-start text-left" };
const _hoisted_9 = ["id"];
const _hoisted_10 = {
  key: 0,
  class: "float ml-1.5"
};
const _hoisted_11 = /* @__PURE__ */ createBaseVNode("div", { class: "cc-badge-yellow" }, [
  /* @__PURE__ */ createBaseVNode("span", null, "Shamir not supported")
], -1);
const _hoisted_12 = [
  _hoisted_11
];
const _hoisted_13 = ["id"];
const _hoisted_14 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-cart text-2xl" }, null, -1);
          ...
          return openBlock(), createElementBlock("button", {
            ...
            createBaseVNode("div", {
              ...
              option.icon ? (openBlock(), createElementBlock("img", {
                ...
                src: option.icon,
                alt: "device logo"
              }, null, 8, _hoisted_4)) : option.id === __props.defaultId ? (openBlock(), createElementBlock("div", _hoisted_5, _hoisted_7)) : createCommentVNode("", true)
            ], 10, _hoisted_3),
            createBaseVNode("div", _hoisted_8, [
              createBaseVNode("div", {
                ...
                option.id === "keystone" ? (openBlock(), createElementBlock("div", _hoisted_10, _hoisted_12)) : createCommentVNode("", true)
              ], 8, _hoisted_9),
              createBaseVNode("div", {
                id: "privacy-setting-" + index + "-description",
                class: "block"
              }, toDisplayString(option.caption), 9, _hoisted_13),
