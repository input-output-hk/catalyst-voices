import { d as defineComponent, z as ref, o as openBlock, c as createElementBlock, n as normalizeClass, e as createBaseVNode, t as toDisplayString, u as unref, a as createBlock, c5 as getAssetIdBech32, j as createCommentVNode, h as withCtx, q as createVNode, hc as swapAssetInfoCnt, K as networkId, H as Fragment, D as watch, i as createTextVNode, ca as QToggle_default, at as appLanguageTag, f as computed, c2 as isZero, eQ as compare, b as withModifiers, B as useFormatter, cY as multiply, Q as QSpinnerDots_default, hd as defaultSlippage, cH as divide, he as getProvider, I as renderList, hf as round, S as normalizeStyle, a9 as useQuasar, C as onMounted, F as withDirectives, J as vShow, X as nextTick, cs as onErrorCaptured, hg as syncStartAI, hh as syncStartAI$1, hi as getSwapSettings, hj as formatAssetName, hk as getEternlFee, bn as dispatchSignal, hl as doInitSwap, aI as onUnmounted, aZ as removeSignalListener, ag as useSelectedAccount, hm as isEqualAssetList, hn as getAssetInfo, ho as getSwapAssetInfo, hp as getSwapAssetInfo$1, hq as selectBestPool, cF as subtract, hr as fetchSwapPools, hs as swapProviderList, eD as add, bS as json, aY as addSignalListener, fZ as getTxBuiltErrorMsg, fU as ErrorBuildTx, ht as onBuiltTxSwap, hu as doBuildTxSwap, hv as fetchSwapEstimate, hw as getRootAddress, hx as createSwapOrder, gl as parseTxSignRequest, hy as getErrorMsg, hz as fetchSwapDatum, hA as setSwapSettings, hB as swapRouteList, hC as verifiedAssetMap, hD as onAccountDataUpdated, ce as getRandomId, hE as createISwapSettings, aR as sleep, hF as fetchAvgPrice, c4 as getAssetName, hG as onBuiltTxSwapCancel, hH as doBuildTxSwapCancel, hI as fetchLpInfo, hJ as updateForBestPool, aJ as QPagination_default, hK as onAccountListUpdated, hL as lastOrderUpdate, hM as openOrderList, hN as isFetchingOrders, hO as orderUpdateDelay, a4 as now, hP as fetchOpenOrders, hQ as fetchOpenOrders$1, hR as fetchEnabledAggList, hS as fetchProviderList } from "./index.js";
    ...
    return (_ctx, _cache) => {
      ...
      return __props.swapInfo ? (openBlock(), createElementBlock("div", {
        ...
        !swapInfoDetails.value ? (openBlock(), createElementBlock("div", {
          ...
          swapSplits.value.length === 1 ? (openBlock(), createElementBlock("span", _hoisted_12$3, toDisplayString(providerList.value[0].name), 1)) : createCommentVNode("", true),
                ...
                createBaseVNode("div", _hoisted_16$2, [
                  createBaseVNode("div", _hoisted_17$2, [
                    ...
                    createBaseVNode("div", _hoisted_18$2, [
                      ...
                      createBaseVNode("span", _hoisted_25$1, toDisplayString(providerList.value[index].name), 1)
                    ])
                  ])
                ]),
...
const CreateSwap = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-c92ceae3"]]);
const _hoisted_1$3 = {
  key: 0,
