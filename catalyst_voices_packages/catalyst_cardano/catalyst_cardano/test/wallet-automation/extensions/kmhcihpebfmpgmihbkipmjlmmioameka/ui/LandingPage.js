import { d as defineComponent, o as openBlock, c as createElementBlock, e as createBaseVNode, t as toDisplayString, u as unref, b as withModifiers, bM as isIosApp, i as createTextVNode, j as createCommentVNode, n as normalizeClass } from "./index.js";
...
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("a", {
  ...
  /* @__PURE__ */ createBaseVNode("strong", null, "Chrome Web Store")
], -1);
const _hoisted_16 = {
  key: 1,
  class: "mx-auto flex flex-col flex-nowrap sm:justify-center md:mt-8"
};
const _hoisted_17 = { class: "cc-text-extra-bold cc-text-green" };
const _hoisted_18 = { class: "block xl:inline leading-7 mt-1 sm:mt-2 text-md sm:text-xl md:text-2xl px-4" };
const _hoisted_19 = { class: "cc-text-sz md:text-xl" };
...
const _hoisted_21 = /* @__PURE__ */ createBaseVNode("a", {
  ...
  /* @__PURE__ */ createBaseVNode("strong", null, "eternl.io")
], -1);
const _hoisted_22 = {
  key: 2,
  class: "mx-auto flex flex-col flex-nowrap sm:justify-center md:mt-8"
};
const _hoisted_23 = { class: "cc-text-extra-bold cc-text-green" };
const _hoisted_24 = { class: "block xl:inline leading-7 mt-1 sm:mt-2 text-md sm:text-xl md:text-2xl px-4" };
const _hoisted_25 = { class: "cc-text-sz md:text-xl" };
...
const _hoisted_27 = /* @__PURE__ */ createBaseVNode("a", {
  ...
  /* @__PURE__ */ createBaseVNode("strong", null, "App Store (iOS)")
], -1);
const _hoisted_28 = /* @__PURE__ */ createBaseVNode("a", {
  ...
  /* @__PURE__ */ createBaseVNode("strong", null, "Play Store (Android)")
], -1);
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            ...
            unref(isIosApp)() ? (openBlock(), createElementBlock("div", _hoisted_16, [
              createBaseVNode("h1", _hoisted_17, [
                createBaseVNode("span", _hoisted_18, toDisplayString(unref(it)("landingpage.ios.headline")), 1)
              ]),
            ...
            !unref(isIosApp)() ? (openBlock(), createElementBlock("div", _hoisted_22, [
              createBaseVNode("h1", _hoisted_23, [
                createBaseVNode("span", _hoisted_24, toDisplayString(unref(it)("landingpage.mobile.headline")), 1)
              ]),
