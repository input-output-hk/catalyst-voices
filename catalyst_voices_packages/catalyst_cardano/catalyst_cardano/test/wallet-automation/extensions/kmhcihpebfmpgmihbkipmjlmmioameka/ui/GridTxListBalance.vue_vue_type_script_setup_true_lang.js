import { hX as toB64Buffer, ep as cryptoBrowserifyExports, dl as Buffer$1, hY as toB64String, el as getRequestData, em as ApiRequestType, en as ErrorSync, eo as DEFAULT_ACCOUNT_ID, d as defineComponent, z as ref, D as watch, bS as json, hZ as getPlutusHVB, cs as onErrorCaptured, o as openBlock, c as createElementBlock, q as createVNode, u as unref, e as createBaseVNode, t as toDisplayString, j as createCommentVNode, f as computed, h_ as useWindowSize, C as onMounted, H as Fragment, I as renderList, a as createBlock, aJ as QPagination_default, h$ as useDetailedTxInfo, aK as useGuard, h as withCtx, i as createTextVNode, bj as getUtxoHash, B as useFormatter, bt as useWitnesses, b4 as toHexString, eB as getAddressCredentials, i0 as getDeposit, b as withModifiers, n as normalizeClass, eQ as compare, hj as formatAssetName, c5 as getAssetIdBech32, eJ as CertificateTypes, i1 as CertificateKind, i2 as getPoolAddressFromKeyHash, dk as getRewardAddressFromCred, K as networkId, gG as getDRepAddressFromKeyHash, gb as getMetadataType, eK as createJsonFromCborJson, Q as QSpinnerDots_default, F as withDirectives, g8 as vModelText, a7 as toRefs, i3 as getTxBalance, ag as useSelectedAccount, a4 as now, i4 as saveTxNote, a9 as useQuasar, aI as onUnmounted, eF as createIUtxo, eP as createIUtxoFromIUtxoDetails, g4 as getTransactionFromCbor, ge as cslToJson, hU as freeCSLObjects, i5 as loadUnknownUtxos, i6 as getAllInputUtxoHashList, i7 as getEpochFromSlot, R as chainTip, a_ as checkEpochParams, i8 as syncEpochParams, i9 as PlutusScripts, ia as jsonToCsl, b2 as safeFreeCSLObject, ib as PlutusScript, ic as toHexBuffer, hf as round, eD as add, cY as multiply, id as isOnChainState, ie as isInvalidState, ig as isSubmittedState, ih as isSignedState, ii as timestamp, ij as getCalculatedChainTip, bn as dispatchSignal, ik as doUpdatePendingTxStatus, bi as getTimestampFromSlot, il as getAddressesByRefId, im as getContractMappingByAddresses, aY as addSignalListener, io as onInterval60s, aZ as removeSignalListener, bl as QSpinner_default, J as vShow, ce as getRandomId, ip as decryptedMsgMap, iq as saveDecryptedMsg, S as normalizeStyle, ir as delDecryptedMsg, is as doRemovePendingTx, hW as submitTx } from "./index.js";
...
import { u as useReportDetails, _ as _sfc_main$j } from "./GridTxListUtxoListBadges.vue_vue_type_script_setup_true_lang.js";
import "./NetworkId.js";
...
const _hoisted_3$f = { class: "relative w-full max-w-full flex flex-row flex-nowrap cc-text-xs" };
const _hoisted_4$e = { class: "pr-1 cc-text-semi-bold whitespace-nowrap min-w-9" };
const _hoisted_5$c = { class: "w-5 align-text-top" };
const _hoisted_6$c = { class: "w-full max-w-full cc-addr truncate overflow-hidden" };
const _hoisted_7$a = {
  key: 0,
  class: "relative w-full max-w-full flex flex-row flex-nowrap cc-text-xs"
};
const _hoisted_8$a = { class: "pr-1 cc-text-semi-bold whitespace-nowrap min-w-9" };
const _hoisted_9$a = { class: "w-5 align-text-top" };
const _hoisted_10$9 = { class: "w-full max-w-full cc-addr truncate overflow-hidden" };
const _hoisted_11$8 = {
  key: 1,
  class: "relative w-full max-w-full flex flex-row flex-nowrap cc-text-xs"
};
const _hoisted_12$8 = { class: "pr-1 cc-text-semi-bold whitespace-nowrap min-w-9" };
      ...
      return datum.value ? (openBlock(), createElementBlock("div", _hoisted_1$f, [
        ...
        createBaseVNode("div", _hoisted_2$f, [
          createBaseVNode("div", _hoisted_3$f, [
            ...
            createBaseVNode("div", _hoisted_6$c, toDisplayString(datum.value.hash), 1)
          ]),
          datum.value.bytes ? (openBlock(), createElementBlock("div", _hoisted_7$a, [
            createBaseVNode("div", _hoisted_8$a, toDisplayString(unref(t)("wallet.transactions.header.datum.bytes")), 1),
            ...
            createBaseVNode("div", _hoisted_10$9, toDisplayString(JSON.stringify(datum.value.bytes)), 1)
          ])) : createCommentVNode("", true),
          datum.value.value ? (openBlock(), createElementBlock("div", _hoisted_11$8, [
            createBaseVNode("div", _hoisted_12$8, toDisplayString(unref(t)("wallet.transactions.header.datum.json")), 1),
...
const _hoisted_3$e = { class: "w-5 align-text-top" };
...
const _hoisted_4$c = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-lock-open-check mr-1 cc-text-green" }, null, -1);
const _hoisted_5$b = {
  key: 1,
  class: "relative"
};
const _hoisted_6$b = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-lock-open-check mr-1 cc-text-green" }, null, -1);
const _hoisted_7$9 = { class: "w-full flex flex-row flex-nowrap justify-between items-start gap-1" };
const _hoisted_8$9 = { key: 0 };
const _hoisted_9$9 = { class: "cc-badge-red cc-none inline-flex" };
const _hoisted_10$8 = {
  key: 0,
  class: "w-full flex flex-row flex-nowrap items-start opacity-50 -mt-1"
};
const _hoisted_11$7 = { class: "w-full flex flex-col" };
const _hoisted_12$7 = /* @__PURE__ */ createBaseVNode("div", { class: "cc-addr text-bold" }, "Payment Cred:", -1);
const _hoisted_13$5 = { class: "w-full flex flex-row flex-nowrap items-start justify-between gap-1" };
const _hoisted_14$4 = { class: "cc-addr" };
const _hoisted_15$4 = {
  key: 1,
  class: "w-full flex flex-row flex-nowrap items-start opacity-50 -mt-1"
};
const _hoisted_16$4 = { class: "w-full flex flex-col" };
const _hoisted_17$4 = /* @__PURE__ */ createBaseVNode("div", { class: "cc-addr text-bold" }, "Stake Cred:", -1);
const _hoisted_18$4 = { class: "w-full flex flex-row flex-nowrap items-start justify-between gap-1" };
const _hoisted_19$3 = { class: "cc-addr" };
const _hoisted_20$3 = { class: "grow-1 w-full flex" };
const _hoisted_21$3 = { class: "relative max-w-full align-text-top justify-end flex-grow-1 flex-auto flex-grow-1" };
const _hoisted_22$3 = {
  key: 2,
  class: "grow-1 w-full flex flex-col flex-nowrap items-start"
};
const _hoisted_23$3 = { class: "flex flex-row flex-nowrap items-start gap-0.5" };
const _hoisted_24$3 = {
  key: 3,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
          ...
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_2$d, [
              createBaseVNode("div", null, [
                __props.witnessCheck && __props.isInput && unref(isSignedUtxo)(utxo) ? (openBlock(), createElementBlock("div", _hoisted_3$d, [
                  _hoisted_4$c,
                ...
                ])) : __props.witnessCheck && __props.isInput && unref(hasSpendRedeemer)(utxo.input) ? (openBlock(), createElementBlock("div", _hoisted_5$b, [
                  _hoisted_6$b,
                  createVNode(_sfc_main$h, {
                    anchor: "bottom middle",
                    "transition-show": "scale",
              ...
              createBaseVNode("div", _hoisted_7$9, [
                ...
                scamAddresses.value.includes(utxo.output.address) ? (openBlock(), createElementBlock("div", _hoisted_8$9, [
            ...
            (__props.txViewer || unref(showTxDetails)) && utxo.pc ? (openBlock(), createElementBlock("div", _hoisted_10$8, [
              createBaseVNode("div", _hoisted_11$7, [
                _hoisted_12$7,
                createBaseVNode("div", _hoisted_13$5, [
                  createBaseVNode("div", _hoisted_14$4, toDisplayString(utxo.pc), 1),
                  createVNode(_sfc_main$g, {
            ...
            (__props.txViewer || unref(showTxDetails)) && utxo.sc ? (openBlock(), createElementBlock("div", _hoisted_15$4, [
              createBaseVNode("div", _hoisted_16$4, [
                _hoisted_17$4,
                createBaseVNode("div", _hoisted_18$4, [
                  createBaseVNode("div", _hoisted_19$3, toDisplayString(utxo.sc), 1),
                  createVNode(_sfc_main$g, {
                    "label-hover": unref(t)("wallet.transactions.button.copy.cred.hover"),
                    "notification-text": unref(t)("wallet.transactions.button.copy.cred.notify"),
            ...
            __props.isInput && unref(showTxDetails) ? (openBlock(), createElementBlock("div", _hoisted_22$3, [
              createVNode(GridSpace, {
                hr: "",
                class: "w-full opacity-50",
                label: "txhash # index",
            ...
            unref(showTxDetails) && (utxo.output.plutus_data || utxo.output.script_ref) ? (openBlock(), createElementBlock("div", _hoisted_24$3, [
        ...
        showPagination.value ? (openBlock(), createElementBlock("div", _hoisted_25$3, [
...
const _hoisted_7$8 = { class: "whitespace-nowrap" };
const _hoisted_8$8 = { class: "cc-text-semi-bold" };
const _hoisted_9$8 = {
  key: 2,
  class: "flex flex-row xs:flex-col justify-between xs:justify-start w-full xs:w-auto"
};
const _hoisted_10$7 = { class: "whitespace-nowrap" };
const _hoisted_11$6 = { class: "cc-text-semi-bold" };
const _hoisted_12$6 = { class: "justify-end flex-nowrap" };
const _hoisted_13$4 = {
  key: 3,
  class: "flex flex-row xs:flex-col justify-between xs:justify-start w-full xs:w-auto"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$c, [
        __props.hash ? (openBlock(), createElementBlock("div", _hoisted_2$c, [
          __props.hash ? (openBlock(), createElementBlock("div", _hoisted_3$c, [
        ...
        !__props.stagingTx && __props.blockNo > 0 ? (openBlock(), createElementBlock("div", _hoisted_6$a, [
          createBaseVNode("div", _hoisted_7$8, [
            createBaseVNode("span", _hoisted_8$8, toDisplayString(unref(t)("wallet.transactions.header.block")), 1),
            createVNode(_sfc_main$g, {
          ...
          createBaseVNode("span", _hoisted_12$6, toDisplayString(__props.tx.size ?? 0), 1)
        ])),
...
const _hoisted_3$b = { class: "whitespace-nowrap cc-text-semi-bold" };
const _hoisted_4$a = { class: "flex flex-row flex-nowrap pt-0 space-x-1" };
const _hoisted_5$9 = { key: 0 };
const _hoisted_6$9 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-lock-open-check mr-1 cc-text-green" }, null, -1);
    ...
    return (_ctx, _cache) => {
      return withdrawals.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$b, [
        ...
        createBaseVNode("div", _hoisted_2$b, [
          createBaseVNode("div", _hoisted_3$b, toDisplayString(withdrawals.value.length + " " + unref(t)("wallet.transactions.header.withdrawal.label")), 1),
...
const _hoisted_6$8 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-lock-open-check mr-1 cc-text-green" }, null, -1);
const _hoisted_7$7 = {
  key: 1,
  class: "h-min"
};
const _hoisted_8$7 = { class: "cc-badge-green cc-none inline-flex my-1" };
const _hoisted_9$7 = {
  key: 2,
      ...
      return __props.tx.body.mint ? (openBlock(), createElementBlock("div", _hoisted_1$a, [
        ...
        createBaseVNode("div", _hoisted_2$a, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_3$a, toDisplayString(mintCount.value + " " + unref(t)("wallet.transactions.header.mint.label")), 1),
            createBaseVNode("i", {
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(Object.entries(policy[1]), (asset, a_index) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("div", _hoisted_4$9, [
                    ...
                    compare(asset[1], ">", 0) ? (openBlock(), createElementBlock("div", _hoisted_7$7, [
                      createBaseVNode("div", _hoisted_8$7, toDisplayString(unref(t)("common.label.mint")), 1)
                    ])) : (openBlock(), createElementBlock("div", _hoisted_9$7, toDisplayString(unref(t)("common.label.burn")), 1)),
...
const _hoisted_6$7 = { class: "pr-1 cc-text-semi-bold whitespace-nowrap" };
const _hoisted_7$6 = { class: "w-5 align-text-top" };
const _hoisted_8$6 = { class: "flex flex-row flex-nowrap" };
const _hoisted_9$6 = {
  key: 1,
  class: "align-middle cc-text-xs"
};
const _hoisted_10$6 = { class: "pr-1 cc-text-semi-bold whitespace-nowrap capitalize" };
const _hoisted_11$5 = { class: "w-5 align-text-top" };
const _hoisted_12$5 = { class: "flex flex-row flex-nowrap" };
const _hoisted_13$3 = {
  key: 2,
  class: "align-middle cc-text-xs"
};
...
const _hoisted_20$2 = { class: "pr-1 cc-text-semi-bold align-text-top whitespace-nowrap capitalize" };
const _hoisted_21$2 = { class: "w-5 align-text-top" };
const _hoisted_22$2 = { class: "w-full font-mono overflow-auto" };
const _hoisted_23$2 = {
  key: 5,
  class: "align-middle cc-text-xs"
};
...
const _hoisted_29$2 = { class: "cc-text-xs" };
const _hoisted_30$2 = {
  key: 8,
  class: "align-middle cc-text-xs"
};
...
const _hoisted_33$2 = { class: "pr-1 cc-text-semi-bold whitespace-nowrap" };
const _hoisted_34$2 = { class: "w-5 align-text-top" };
const _hoisted_35$2 = { class: "flex flex-row flex-nowrap" };
const _hoisted_36$2 = { class: "pr-1 cc-text-semi-bold align-text-top whitespace-nowrap" };
const _hoisted_37$2 = { key: 0 };
const _hoisted_38$2 = { class: "w-5 align-text-top" };
const _hoisted_39$2 = { class: "flex flex-col flex-nowrap" };
const _hoisted_40$2 = {
  colspan: "2",
  class: "pr-1 cc-text-semi-bold align-text-top whitespace-nowrap"
};
const _hoisted_41$2 = { key: 0 };
const _hoisted_42$2 = { class: "flex flex-col flex-nowrap space-y-1" };
const _hoisted_43$2 = { class: "flex flex-row flex-nowrap cc-addr" };
...
const _hoisted_48$2 = { class: "cc-addr hover:text-gray-500 self-center" };
const _hoisted_49$2 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-open-in-new mx-1" }, null, -1);
const _hoisted_50$2 = {
  key: 13,
  class: "align-middle cc-text-xs"
};
...
const _hoisted_52$2 = { class: "cc-addr" };
const _hoisted_53$2 = {
  key: 14,
  class: "align-middle cc-text-xs"
};
const _hoisted_54$2 = { class: "pr-1 cc-text-semi-bold align-text-top whitespace-nowrap" };
const _hoisted_55$2 = { class: "w-5 align-text-top" };
const _hoisted_56$2 = { class: "w-full font-mono overflow-auto" };
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
        ...
        switch (id) {
          ...
          case CertificateKind.DrepDeregistration:
            try {
              ...
              const drepBech32 = getDRepAddressFromKeyHash(cred);
    ...
    const getDRep = (drep) => {
      ...
      try {
        drepStr = getDRepAddressFromKeyHash(drepStr);
      } catch (e) {
      }
      return drepStr;
    };
      ...
      return certList.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$9, [
        ...
        createBaseVNode("div", _hoisted_2$9, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_3$9, toDisplayString(certList.value.length + " " + unref(t)("wallet.transactions.header.certificate.label")), 1),
            createBaseVNode("i", {
              class: normalizeClass(["text-xl", open.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
            }, null, 2)
          ]),
              ...
              createBaseVNode("table", _hoisted_4$8, [
                createBaseVNode("tbody", null, [
                  cert.stakeAddr ? (openBlock(), createElementBlock("tr", _hoisted_5$7, [
                    createBaseVNode("td", _hoisted_6$7, toDisplayString(unref(t)("common.address.label")), 1),
                  ...
                  cert.poolAddr ? (openBlock(), createElementBlock("tr", _hoisted_9$6, [
                    createBaseVNode("td", _hoisted_10$6, toDisplayString(unref(t)("common.label.pool")), 1),
                  ...
                  cert.drep ? (openBlock(), createElementBlock("tr", _hoisted_13$3, [
                    createBaseVNode("td", _hoisted_14$2, toDisplayString(unref(t)(`wallet.transactions.header.certificate.gov.${typeof cert.drep === "string" && cert.drep.length < 56 ? "vote" : "drep"}`)), 1),
                    ...
                    createBaseVNode("td", _hoisted_16$2, [
                      createVNode(_sfc_main$i, {
                        subject: cert.stakeAddr,
                        type: "stake",
                        label: getDRep(cert.drep),
                        "label-c-s-s": "cc-addr hover:text-gray-500"
                      }, null, 8, ["subject", "label"])
                    ])
                  ])) : createCommentVNode("", true),
                  cert.coin ? (openBlock(), createElementBlock("tr", _hoisted_17$2, [
                    createBaseVNode("td", _hoisted_18$2, toDisplayString(unref(t)("common.label.deposit")), 1),
                  ...
                  cert.anchor ? (openBlock(), createElementBlock("tr", _hoisted_19$2, [
                    ...
                    createBaseVNode("td", _hoisted_22$2, [
                      createVNode(unref(S), {
                        showLength: "",
                        showDoubleQuotes: false,
                        deep: 5,
                  ...
                  cert.kind === unref(CertificateKind).PoolRetirement ? (openBlock(), createElementBlock("tr", _hoisted_23$2, [
                    createBaseVNode("td", _hoisted_24$2, toDisplayString(unref(t)("wallet.transactions.header.certificate.poolret.retepno")), 1),
                    createBaseVNode("td", null, toDisplayString(cert.cert.PoolRetirement.epoch), 1)
                  ])) : createCommentVNode("", true),
                  cert.poolParams ? (openBlock(), createElementBlock("tr", _hoisted_25$2, [
                    createBaseVNode("td", _hoisted_26$2, toDisplayString(unref(t)("wallet.transactions.header.certificate.poolreg.fixedcost")), 1),
                    createBaseVNode("td", null, [
                      createVNode(_sfc_main$k, {
                  ...
                  cert.poolParams ? (openBlock(), createElementBlock("tr", _hoisted_27$2, [
                    createBaseVNode("td", _hoisted_28$2, toDisplayString(unref(t)("wallet.transactions.header.certificate.poolreg.margin")), 1),
                    createBaseVNode("td", _hoisted_29$2, toDisplayString(parseFloat((parseInt(cert.poolParams.margin.numerator) / parseInt(cert.poolParams.margin.denominator) * 100).toFixed(4))) + " %", 1)
                  ])) : createCommentVNode("", true),
                  cert.poolParams ? (openBlock(), createElementBlock("tr", _hoisted_30$2, [
                    createBaseVNode("td", _hoisted_31$2, toDisplayString(unref(t)("wallet.transactions.header.certificate.poolreg.pledge")), 1),
                    createBaseVNode("td", null, [
                      createVNode(_sfc_main$k, {
                  ...
                  cert.poolParams && cert.stakeAddr ? (openBlock(), createElementBlock("tr", _hoisted_32$2, [
                    createBaseVNode("td", _hoisted_33$2, toDisplayString(unref(t)("wallet.transactions.header.certificate.poolreg.rewardaddr")), 1),
                    createBaseVNode("td", _hoisted_34$2, [
                      createVNode(_sfc_main$g, {
                        "label-hover": unref(t)("wallet.transactions.button.copy.address.hover"),
                        "notification-text": unref(t)("wallet.transactions.button.copy.address.notify"),
                        "copy-text": cert.stakeAddr.bech32,
                  ...
                  cert.poolParams && cert.poolOwners ? (openBlock(true), createElementBlock(Fragment, { key: 10 }, renderList(cert.poolOwners, (owner, index2) => {
                    return openBlock(), createElementBlock("tr", {
                      class: "align-middle cc-text-xs",
                      key: index2
                    }, [
                      createBaseVNode("td", _hoisted_36$2, [
                        index2 === 0 ? (openBlock(), createElementBlock("span", _hoisted_37$2, toDisplayString(unref(t)("wallet.transactions.header.certificate.poolreg.owners")), 1)) : createCommentVNode("", true)
                      ]),
                  ...
                  cert.poolParams ? (openBlock(true), createElementBlock(Fragment, { key: 11 }, renderList(cert.poolRelays, (relay, index2) => {
                    return openBlock(), createElementBlock("tr", {
                      class: "align-middle cc-text-xs",
                      key: index2
                    }, [
                      createBaseVNode("td", _hoisted_40$2, [
                        index2 === 0 ? (openBlock(), createElementBlock("span", _hoisted_41$2, toDisplayString(unref(t)("wallet.transactions.header.certificate.poolreg.relays")), 1)) : createCommentVNode("", true)
                      ]),
                      createBaseVNode("td", _hoisted_42$2, [
                        createBaseVNode("div", _hoisted_43$2, [
                          ...
                          relay.port ? (openBlock(), createElementBlock("span", _hoisted_44$2, " : " + toDisplayString(relay.port), 1)) : createCommentVNode("", true)
                        ])
                      ])
                    ]);
                  }), 128)) : createCommentVNode("", true),
                  ((_a = cert.poolParams) == null ? void 0 : _a.pool_metadata) ? (openBlock(), createElementBlock("tr", _hoisted_45$2, [
                    createBaseVNode("td", _hoisted_46$2, toDisplayString(unref(t)("wallet.transactions.header.certificate.poolreg.metaurl")), 1),
                    createBaseVNode("td", null, [
                      createBaseVNode("a", {
                        ...
                        createBaseVNode("div", _hoisted_48$2, toDisplayString(cert.poolParams.pool_metadata.url), 1),
                        _hoisted_49$2
                      ], 8, _hoisted_47$2)
                    ])
                  ])) : createCommentVNode("", true),
                  ((_b = cert.poolParams) == null ? void 0 : _b.pool_metadata) ? (openBlock(), createElementBlock("tr", _hoisted_50$2, [
                    createBaseVNode("td", _hoisted_51$2, toDisplayString(unref(t)("wallet.transactions.header.certificate.poolreg.metahash")), 1),
                    createBaseVNode("td", _hoisted_52$2, toDisplayString(cert.poolParams.pool_metadata.pool_metadata_hash), 1)
                  ])) : createCommentVNode("", true),
                  cert.unknown ? (openBlock(), createElementBlock("tr", _hoisted_53$2, [
                    createBaseVNode("td", _hoisted_54$2, [
                    ...
                    createBaseVNode("td", _hoisted_56$2, [
                      createVNode(unref(S), {
                        showLength: "",
                        showDoubleQuotes: false,
                        deep: 5,
...
const _hoisted_6$6 = { class: "w-full pb-1 pr-1 whitespace-pre-wrap overflow-auto" };
const _hoisted_7$5 = {
  key: 0,
...
const _hoisted_10$5 = { class: "self-center" };
const _hoisted_11$4 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-open-in-new mx-1" }, null, -1);
      ...
      return ((_a2 = __props.tx.auxiliary_data) == null ? void 0 : _a2.metadata) && metaCount.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$8, [
        ...
        createBaseVNode("div", _hoisted_2$8, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_3$8, toDisplayString(metaCount.value + " " + unref(t)("wallet.transactions.header.metadata.label")), 1),
            createBaseVNode("i", {
              class: normalizeClass(["text-xl", open.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
            }, null, 2)
          ]),
          open.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(Object.entries(__props.tx.auxiliary_data.metadata), (metadata, index) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_6$6, [
                unref(getMetadataType)(metadata[1]) === "string" || unref(getMetadataType)(metadata[1]) === "number" ? (openBlock(), createElementBlock("span", _hoisted_7$5, [
                  unref(isMilkomeda) && metadata[0] === String(unref(networkMetadataAddressKey)) ? (openBlock(), createElementBlock("div", _hoisted_8$5, [
                    createBaseVNode("a", {
                      ...
                      createBaseVNode("div", _hoisted_10$5, toDisplayString(unref(getJsonValue)(metadata[1])), 1),
                      _hoisted_11$4,
                      createVNode(_sfc_main$h, {
                  ...
                  ])) : (openBlock(), createElementBlock("span", _hoisted_12$4, toDisplayString(unref(getJsonValue)(metadata[1])), 1))
...
const _hoisted_5$5 = /* @__PURE__ */ createBaseVNode("div", { class: "flex flex-row flex-nowrap cc-text-xs" }, null, -1);
const _hoisted_6$5 = { class: "w-full pb-1 pr-1 whitespace-pre-wrap overflow-auto" };
      ...
      return hasWitness.value ? (openBlock(), createElementBlock("div", _hoisted_1$7, [
        ...
        createBaseVNode("div", _hoisted_2$7, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_3$7, toDisplayString(unref(t)("wallet.transactions.header.witnessset.label")), 1),
            createBaseVNode("i", {
              class: normalizeClass(["text-xl", open.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
            }, null, 2)
          ]),
...
const _hoisted_6$4 = { class: "align-middle cc-text-xs" };
const _hoisted_7$4 = { class: "pr-1 cc-text-semi-bold whitespace-nowrap" };
const _hoisted_8$4 = { class: "w-5 align-text-top" };
const _hoisted_9$4 = { class: "cc-addr" };
const _hoisted_10$4 = { class: "align-middle cc-text-xs" };
      ...
      return __props.scriptList.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$6, [
        ...
        createBaseVNode("div", _hoisted_2$6, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_3$6, toDisplayString(__props.scriptList.length + " " + unref(t)("wallet.transactions.header.nativescript.label")), 1),
            createBaseVNode("i", {
              class: normalizeClass(["text-xl", open.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
            }, null, 2)
          ]),
            ...
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("table", _hoisted_4$5, [
                createBaseVNode("tbody", _hoisted_5$4, [
                  createBaseVNode("tr", _hoisted_6$4, [
                    createBaseVNode("td", _hoisted_7$4, toDisplayString(unref(t)("wallet.transactions.header.nativescript.hash")), 1),
                    ...
                    createBaseVNode("td", _hoisted_9$4, toDisplayString(script.scriptHash), 1)
                  ]),
...
const _hoisted_6$3 = { class: "w-24 pr-1 cc-text-semi-bold text-left whitespace-nowrap capitalize" };
const _hoisted_7$3 = { class: "w-5 align-text-top" };
const _hoisted_8$3 = { class: "flex flex-row flex-nowrap mt-1" };
const _hoisted_9$3 = {
  key: 1,
  class: "h-0"
};
const _hoisted_10$3 = /* @__PURE__ */ createBaseVNode("td", { class: "w-24" }, null, -1);
const _hoisted_11$2 = /* @__PURE__ */ createBaseVNode("td", { class: "w-5" }, null, -1);
...
const _hoisted_22$1 = { class: "align-middle cc-text-xs" };
const _hoisted_23$1 = {
  colspan: "2",
  class: "pr-1 cc-text-semi-bold whitespace-nowrap"
};
const _hoisted_24$1 = { class: "align-middle cc-text-xs" };
...
const _hoisted_29$1 = { class: "pr-1 cc-text-semi-bold whitespace-nowrap" };
const _hoisted_30$1 = { class: "w-5 align-text-top" };
const _hoisted_31$1 = { class: "cc-addr truncate" };
const _hoisted_32$1 = {
  key: 3,
  class: "align-middle cc-text-xs"
};
const _hoisted_33$1 = { class: "pr-1 cc-text-semi-bold align-text-top whitespace-nowrap" };
const _hoisted_34$1 = { class: "w-5 align-text-top" };
const _hoisted_35$1 = { class: "w-full font-mono" };
const _hoisted_36$1 = {
  key: 4,
  class: "align-middle cc-text-xs"
};
const _hoisted_37$1 = { colspan: "3" };
const _hoisted_38$1 = { class: "w-full flex flex-row flex-nowrap mt-1" };
const _hoisted_39$1 = /* @__PURE__ */ createBaseVNode("i", { class: "mr-1 mdi mdi-plus" }, null, -1);
const _hoisted_40$1 = {
  key: 5,
  class: "align-middle cc-text-xs"
};
const _hoisted_41$1 = { class: "pr-1 cc-text-semi-bold whitespace-nowrap" };
const _hoisted_42$1 = { class: "w-5 align-text-top" };
const _hoisted_43$1 = { class: "cc-addr truncate" };
const _hoisted_44$1 = {
  key: 6,
  class: "align-middle cc-text-xs"
};
const _hoisted_45$1 = { class: "pr-1 cc-text-semi-bold whitespace-nowrap" };
const _hoisted_46$1 = { class: "w-5 align-text-top" };
const _hoisted_47$1 = { class: "cc-addr truncate" };
const _hoisted_48$1 = {
  key: 7,
  class: "align-middle cc-text-xs"
};
const _hoisted_49$1 = { class: "pr-1 cc-text-semi-bold align-text-top whitespace-nowrap" };
const _hoisted_50$1 = { class: "w-5 align-text-top" };
const _hoisted_51$1 = { class: "w-full font-mono" };
const _hoisted_52$1 = {
  key: 8,
  class: "align-middle cc-text-xs"
};
const _hoisted_53$1 = { colspan: "3" };
const _hoisted_54$1 = { class: "w-full flex flex-row flex-nowrap mt-1" };
const _hoisted_55$1 = /* @__PURE__ */ createBaseVNode("i", { class: "mr-1 mdi mdi-arrow-down" }, null, -1);
const _hoisted_56$1 = {
  key: 9,
  class: "align-middle cc-text-xs"
};
...
const _hoisted_59$1 = { class: "pr-1 cc-text-semi-bold whitespace-nowrap" };
const _hoisted_60$1 = { class: "w-5 align-text-top" };
const _hoisted_61$1 = { class: "cc-addr truncate" };
const _hoisted_62$1 = {
  key: 11,
  class: "align-middle cc-text-xs"
};
const _hoisted_63$1 = { class: "pr-1 cc-text-semi-bold" };
const _hoisted_64$1 = { class: "w-5 align-text-top" };
const _hoisted_65$1 = { class: "truncate max-w-0" };
      ...
      return __props.tx.witness_set.redeemers && __props.tx.witness_set.redeemers.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$5, [
        ...
        createBaseVNode("div", _hoisted_2$5, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_3$5, toDisplayString(__props.tx.witness_set.redeemers.length + " " + unref(t)("wallet.transactions.header.plutuscontract.label")), 1),
            createBaseVNode("i", {
              class: normalizeClass(["text-xl", open.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
            }, null, 2),
              ...
              createBaseVNode("table", _hoisted_4$4, [
                createBaseVNode("tbody", null, [
                  sc.address || sc.scriptHash ? (openBlock(), createElementBlock("tr", _hoisted_5$3, [
                    createBaseVNode("td", _hoisted_6$3, toDisplayString(unref(t)("common.label.contract")), 1),
                  ...
                  ])) : (openBlock(), createElementBlock("tr", _hoisted_9$3, _hoisted_13$1)),
                  ...
                  createBaseVNode("tr", _hoisted_16$1, [
                    createBaseVNode("td", _hoisted_17$1, toDisplayString(unref(t)("wallet.transactions.header.plutus.redeemer.purpose")), 1),
                    createBaseVNode("td", null, toDisplayString(sc.input.redeemer.purpose), 1)
                  ]),
                  createBaseVNode("tr", _hoisted_18$1, [
                    createBaseVNode("td", _hoisted_19$1, toDisplayString(unref(t)("wallet.transactions.header.plutus.redeemer.fee")), 1),
                    createBaseVNode("td", null, toDisplayString(sc.input.redeemer.fee), 1)
                  ]),
                  createBaseVNode("tr", _hoisted_20$1, [
                    createBaseVNode("td", _hoisted_21$1, toDisplayString(unref(t)("wallet.transactions.header.plutus.redeemer.usteps")), 1),
                    createBaseVNode("td", null, toDisplayString(sc.input.redeemer.unit.steps), 1)
                  ]),
                  createBaseVNode("tr", _hoisted_22$1, [
                    createBaseVNode("td", _hoisted_23$1, toDisplayString(unref(t)("wallet.transactions.header.plutus.redeemer.umem")), 1),
                    createBaseVNode("td", null, toDisplayString(sc.input.redeemer.unit.mem), 1)
                  ]),
                  createBaseVNode("tr", _hoisted_24$1, [
                    createBaseVNode("td", _hoisted_25$1, toDisplayString(unref(t)("wallet.transactions.header.plutus.redeemer.dhash")), 1),
                    ...
                    createBaseVNode("td", _hoisted_27$1, toDisplayString(sc.input.redeemer.datum.hash), 1)
                  ]),
                  sc.input.redeemer.datum.bytes ? (openBlock(), createElementBlock("tr", _hoisted_28$1, [
                    createBaseVNode("td", _hoisted_29$1, toDisplayString(unref(t)("wallet.transactions.header.plutus.redeemer.dvalue")), 1),
                    ...
                    createBaseVNode("td", _hoisted_31$1, toDisplayString(sc.input.redeemer.datum.bytes), 1)
                  ])) : createCommentVNode("", true),
                  sc.input.redeemer.datum.value.length > 0 ? (openBlock(), createElementBlock("tr", _hoisted_32$1, [
                    ...
                    createBaseVNode("td", _hoisted_35$1, [
                      createVNode(unref(S), {
                        showLength: "",
                        showDoubleQuotes: false,
                        deep: 5,
                  ...
                  sc.input.datum ? (openBlock(), createElementBlock("tr", _hoisted_36$1, [
                  ...
                  sc.input.datum ? (openBlock(), createElementBlock("tr", _hoisted_40$1, [
                    createBaseVNode("td", _hoisted_41$1, toDisplayString(unref(t)("wallet.transactions.header.plutus.datum.hash")), 1),
                    ...
                    createBaseVNode("td", _hoisted_43$1, toDisplayString(sc.input.datum.hash), 1)
                  ])) : createCommentVNode("", true),
                  sc.input.datum && sc.input.datum.bytes ? (openBlock(), createElementBlock("tr", _hoisted_44$1, [
                    createBaseVNode("td", _hoisted_45$1, toDisplayString(unref(t)("wallet.transactions.header.plutus.datum.bytecode")), 1),
                    ...
                    createBaseVNode("td", _hoisted_47$1, toDisplayString(sc.input.datum.bytes), 1)
                  ])) : createCommentVNode("", true),
                  sc.input.datum && sc.input.datum.value.length > 0 ? (openBlock(), createElementBlock("tr", _hoisted_48$1, [
                  ...
                  sc.size || sc.scriptHash || sc.bytecode ? (openBlock(), createElementBlock("tr", _hoisted_56$1, [
                    createBaseVNode("td", _hoisted_57$1, toDisplayString(unref(t)("wallet.transactions.header.plutuscontract.script.size")), 1),
                    createBaseVNode("td", null, toDisplayString(sc.size), 1)
                  ])) : createCommentVNode("", true),
                  sc.size || sc.scriptHash || sc.bytecode ? (openBlock(), createElementBlock("tr", _hoisted_58$1, [
                    createBaseVNode("td", _hoisted_59$1, toDisplayString(unref(t)("wallet.transactions.header.plutuscontract.script.hash")), 1),
                    ...
                    createBaseVNode("td", _hoisted_61$1, toDisplayString(sc.scriptHash), 1)
                  ])) : createCommentVNode("", true),
                  sc.size || sc.scriptHash || sc.bytecode ? (openBlock(), createElementBlock("tr", _hoisted_62$1, [
                    createBaseVNode("td", _hoisted_63$1, toDisplayString(unref(t)("wallet.transactions.header.plutuscontract.script.bytecode")), 1),
                    createBaseVNode("td", _hoisted_64$1, [
                      createVNode(_sfc_main$g, {
                        "label-hover": unref(t)("wallet.transactions.button.copy.script.hover"),
                        "notification-text": unref(t)("wallet.transactions.button.copy.script.notify"),
                    ...
                    createBaseVNode("td", _hoisted_65$1, toDisplayString(sc.bytecode), 1)
                  ])) : createCommentVNode("", true)
                ])
              ])
            ]);
...
const _hoisted_3$4 = { class: "grid grid-cols-12 cc-gap p-4 w-full" };
...
const _hoisted_3$3 = /* @__PURE__ */ createBaseVNode("i", { class: "text-sm mr-2 mdi mdi-note" }, null, -1);
...
const _hoisted_6$2 = { class: "w-full pb-1 pr-1 whitespace-pre-wrap overflow-auto" };
const _hoisted_7$2 = {
  key: 1,
  class: "relative w-full"
};
const _hoisted_8$2 = { class: "cc-text-sm" };
const _hoisted_9$2 = { class: "whitespace-nowrap cc-text-semi-bold" };
const _hoisted_10$2 = { class: "flex flex-row flex-nowrap cc-text-xs" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        procedureCount.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_7$2, [
          createVNode(GridSpace, {
            hr: "",
            class: "w-full my-2"
          }),
          createBaseVNode("div", _hoisted_8$2, [
            createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_9$2, toDisplayString(procedureCount.value + " " + unref(t)("wallet.transactions.header.governance.procedure.label")), 1),
              createBaseVNode("i", {
                class: normalizeClass(["text-xl", open.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
              }, null, 2)
            ]),
...
const _hoisted_6$1 = /* @__PURE__ */ createBaseVNode("div", { class: "grow" }, " ", -1);
const _hoisted_7$1 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-list-box-outline text-lg" }, null, -1);
const _hoisted_8$1 = [
  _hoisted_7$1
];
const _hoisted_9$1 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-information-outline text-lg" }, null, -1);
const _hoisted_10$1 = [
  _hoisted_9$1
];
...
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("div", { class: "mt-1 rounded-full bg-yellow-500 dark:bg-yellow-600 w-4 h-4 flex justify-center items-center" }, [
  /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-alert-octagon-outline text-xs" })
], -1);
const _hoisted_6 = [
  _hoisted_5
];
...
const _hoisted_8 = { class: "relative flex flex-row items-center mt-1 sm:mt-0.5 gap-1" };
const _hoisted_9 = {
  key: 0,
  class: "mdi mdi-note mr-1"
};
const _hoisted_10 = { key: 1 };
const _hoisted_11 = { class: "cc-none inline-flex justify-center" };
const _hoisted_12 = {
  key: 0,
...
const _hoisted_16 = /* @__PURE__ */ createBaseVNode("span", { class: "text-italic" }, /* @__PURE__ */ toDisplayString("Preview: Waiting for user inputs"), -1);
const _hoisted_17 = [
  _hoisted_16
];
const _hoisted_18 = {
...
const _hoisted_34 = { key: 11 };
const _hoisted_35 = { class: "cc-badge-blue cc-none inline-flex" };
const _hoisted_36 = { key: 12 };
const _hoisted_37 = { class: "cc-badge-blue cc-none inline-flex" };
const _hoisted_38 = { key: 13 };
const _hoisted_39 = { class: "cc-badge-blue cc-none inline-flex" };
const _hoisted_40 = { key: 14 };
const _hoisted_41 = { class: "cc-badge-blue cc-none inline-flex" };
const _hoisted_42 = { key: 16 };
const _hoisted_43 = { class: "cc-badge-blue cc-none inline-flex" };
const _hoisted_44 = { key: 17 };
const _hoisted_45 = { class: "cc-badge-gray cc-none inline-flex" };
const _hoisted_46 = { class: "cc-badge-yellow cc-none inline-flex" };
const _hoisted_47 = { key: 19 };
const _hoisted_48 = { class: "cc-badge-red cc-none inline-flex" };
const _hoisted_49 = { key: 20 };
const _hoisted_50 = { class: "cc-badge-green cc-none inline-flex" };
const _hoisted_51 = { key: 21 };
const _hoisted_52 = { class: "cc-badge-red cc-none inline-flex" };
const _hoisted_53 = { key: 22 };
const _hoisted_54 = { class: "cc-badge-red cc-none inline-flex" };
const _hoisted_55 = { key: 23 };
const _hoisted_56 = { class: "cc-badge-purple cc-none inline-flex" };
const _hoisted_57 = { key: 24 };
const _hoisted_58 = { class: "cc-badge-yellow cc-none inline-flex" };
const _hoisted_59 = { key: 25 };
const _hoisted_60 = { class: "cc-badge-yellow cc-none inline-flex" };
const _hoisted_61 = { key: 26 };
const _hoisted_62 = { class: "cc-badge-yellow cc-none inline-flex" };
const _hoisted_63 = { key: 27 };
const _hoisted_64 = { class: "cc-badge-gray cc-none inline-flex" };
const _hoisted_65 = { key: 28 };
const _hoisted_66 = { class: "cc-badge-gray cc-none inline-flex" };
const _hoisted_67 = { key: 29 };
const _hoisted_68 = { class: "cc-badge-red cc-none inline-flex" };
const _hoisted_69 = { key: 30 };
const _hoisted_70 = {
  key: 0,
...
const _hoisted_73 = { class: "ml-6 mt-1 cc-addr flex flex-col flex-nowrap break-all" };
const _hoisted_74 = {
  key: 0,
  class: "inline italic"
};
          ...
          !__props.txViewer ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_2, [
              createBaseVNode("div", _hoisted_3, [
                (__props.stagingTx || __props.sendTx) && ((_a = unref(txBalance)) == null ? void 0 : _a.coin) === "0" ? (openBlock(), createElementBlock("div", _hoisted_4, _hoisted_6)) : (openBlock(), createElementBlock("div", _hoisted_7, [
                  createBaseVNode("i", {
                ...
                createBaseVNode("div", _hoisted_8, [
                  hasNote.value ? (openBlock(), createElementBlock("i", _hoisted_9)) : createCommentVNode("", true),
                  !__props.stagingTx && ((_b = unref(txBalance)) == null ? void 0 : _b.block) ? (openBlock(), createElementBlock("div", _hoisted_10, [
                    createBaseVNode("div", _hoisted_11, [
                      confirmations.value < 10 ? (openBlock(), createElementBlock("i", _hoisted_12)) : confirmations.value < 20 ? (openBlock(), createElementBlock("i", _hoisted_13)) : (openBlock(), createElementBlock("i", _hoisted_14)),
                      createVNode(_sfc_main$h, {
                        anchor: "bottom middle",
                        "transition-show": "scale",
                        "transition-hide": "scale"
                  ...
                  (__props.stagingTx || __props.sendTx) && ((_c = unref(txBalance)) == null ? void 0 : _c.coin) === "0" ? (openBlock(), createElementBlock("div", _hoisted_15, _hoisted_17)) : (openBlock(), createElementBlock("div", _hoisted_18, [
                    __props.stagingTx || __props.sendTx ? (openBlock(), createElementBlock("span", _hoisted_19, toDisplayString("Preview: "))) : createCommentVNode("", true),
                    createTextVNode(toDisplayString(txType.value.name), 1)
                  ])),
                  hasCatalystReg.value ? (openBlock(), createElementBlock("div", _hoisted_20, [
                  ...
                  hasMeta.value ? (openBlock(), createElementBlock("div", _hoisted_22, [
                  ...
                  hasMint.value ? (openBlock(), createElementBlock("div", _hoisted_24, [
                  ...
                  hasGovCert.value || hasGovVote.value ? (openBlock(), createElementBlock("div", _hoisted_26, [
                  ...
                  hasGovVote.value ? (openBlock(), createElementBlock("div", _hoisted_28, [
                  ...
                  hasRegCert.value ? (openBlock(), createElementBlock("div", _hoisted_30, [
                  ...
                  hasDeregCert.value ? (openBlock(), createElementBlock("div", _hoisted_32, [
                  ...
                  hasDelegCert.value ? (openBlock(), createElementBlock("div", _hoisted_34, [
                  ...
                  hasPoolRegCert.value ? (openBlock(), createElementBlock("div", _hoisted_36, [
                  ...
                  hasPoolRetCert.value ? (openBlock(), createElementBlock("div", _hoisted_38, [
                  ...
                  hasNativeScript.value ? (openBlock(), createElementBlock("div", _hoisted_40, [
                  ...
                  }), 128)) : hasPlutusContract.value ? (openBlock(), createElementBlock("div", _hoisted_42, [
                  ...
                  (__props.pendingTx || __props.stagingTx) && isSigned.value && !isSubmitted.value && !isOnChain.value ? (openBlock(), createElementBlock("div", _hoisted_44, [
                  ...
                  (__props.pendingTx || __props.stagingTx) && isSigned.value && !isSubmitted.value && !isOnChain.value && hasCbor.value && !isInvalid.value ? (openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_46, [
                      createTextVNode(" submit transaction "),
                      createVNode(_sfc_main$h, {
                        anchor: "bottom middle",
                        "transition-show": "scale",
                        "transition-hide": "scale"
                  ...
                  (__props.pendingTx || __props.stagingTx) && isSigned.value && !isSubmitted.value && !hasCbor.value ? (openBlock(), createElementBlock("div", _hoisted_47, [
                  ...
                  (__props.pendingTx || __props.stagingTx) && isOnChain.value ? (openBlock(), createElementBlock("div", _hoisted_49, [
                  ...
                  (__props.pendingTx || __props.stagingTx) && isInvalid.value ? (openBlock(), createElementBlock("div", _hoisted_51, [
                  ...
                  !(__props.pendingTx || __props.stagingTx) && isFailed.value ? (openBlock(), createElementBlock("div", _hoisted_53, [
                  ...
                  hasMilkomedaMeta.value ? (openBlock(), createElementBlock("div", _hoisted_55, [
                  ...
                  (__props.pendingTx || __props.stagingTx) && !isExpired.value && !isInvalid.value && !isOnChain.value && __props.pendingTx && isSubmitted.value ? (openBlock(), createElementBlock("div", _hoisted_57, [
                  ...
                  ])) : __props.signed && !__props.pendingTx && !isExpired.value && !isInvalid.value && !isOnChain.value ? (openBlock(), createElementBlock("div", _hoisted_59, [
                  ...
                  ])) : (__props.pendingTx || __props.stagingTx) && !isExpired.value && !isInvalid.value && !isOnChain.value && __props.stagingTx && !__props.sendTx ? (openBlock(), createElementBlock("div", _hoisted_61, [
                  ...
                  (__props.pendingTx || __props.stagingTx) && !isExpired.value && !isInvalid.value && !isOnChain.value && doesNotExpire.value ? (openBlock(), createElementBlock("div", _hoisted_63, [
                  ...
                  ])) : (__props.pendingTx || __props.stagingTx || __props.signed) && !isExpired.value && !isInvalid.value && !isOnChain.value && validFor.value ? (openBlock(), createElementBlock("div", _hoisted_65, [
                  ...
                  ])) : (__props.pendingTx || __props.stagingTx) && isExpired.value && !isInvalid.value && !isOnChain.value ? (openBlock(), createElementBlock("div", _hoisted_67, [
                  ...
                  (__props.pendingTx || __props.stagingTx) && (isExpired.value || isInvalid.value || isSigned.value && !isSubmitted.value) ? (openBlock(), createElementBlock("div", _hoisted_69, [
                    createBaseVNode("div", {
              ...
              !__props.stagingTx && !__props.pendingTx && !__props.signed ? (openBlock(), createElementBlock("div", _hoisted_70, toDisplayString(unref(formatDatetime)(blockTime.value)), 1)) : __props.pendingTx && __props.tx ? (openBlock(), createElementBlock("div", _hoisted_71, toDisplayString(unref(formatDatetime)(__props.tx.time)), 1)) : (openBlock(), createElementBlock("div", _hoisted_72, "Valid until: " + toDisplayString(unref(formatDatetime)(new Date(unref(now)() + 3600 * 1e3 * 3))), 1)),
              ...
              numComments.value > 0 || isCommentsEnc.value ? (openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_73, [
                  numComments.value === 0 ? (openBlock(), createElementBlock("div", _hoisted_74, toDisplayString(unref(t)("wallet.transactions.message.encrypted")), 1)) : (openBlock(), createElementBlock("div", _hoisted_75, [
                    ...
                    hasMoreComments.value ? (openBlock(), createElementBlock("div", _hoisted_76, "...")) : createCommentVNode("", true)
                  ]))
                ])
              ], 2)) : createCommentVNode("", true)
            ]),
