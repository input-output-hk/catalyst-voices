import { d as defineComponent, a7 as toRefs, f as computed, z as ref, u as unref, o as openBlock, a as createBlock, h as withCtx, e as createBaseVNode, q as createVNode, c as createElementBlock, j as createCommentVNode, a9 as useQuasar, bR as entityGroupList, C as onMounted, n as normalizeClass, b as withModifiers, t as toDisplayString, H as Fragment, I as renderList, aJ as QPagination_default, bS as json, bT as deleteReportEntityGroup, bU as addReportEntityGroup, bV as updateReportEntityGroup, bW as updateAllReportEntityGroups, bX as setSelectedEntityGroup, F as withDirectives, J as vShow, bY as selectedEntityGroup, i as createTextVNode, bZ as reportLabelList, b_ as addReportLabel, b$ as deleteReportLabel, ai as walletGroupNameList, c0 as allEntityGroup, c1 as switchWalletGroupToSelectedEntityGroup, D as watch, c2 as isZero, c3 as isLessThanZero, c4 as getAssetName, B as useFormatter, c5 as getAssetIdBech32, c6 as accAssetInfoMap, c7 as fetchAssetInfo, K as networkId, c8 as updateAccountAssetInfoMap, aK as useGuard, c9 as hasLeftOverValue, bi as getTimestampFromSlot, ca as QToggle_default, cb as QBtn_default, cc as QPopupProxy_default, cd as QDate_default, ce as getRandomId, cf as markBalanceRewards, cg as markBalanceAsTaxRelevant, ch as markBalanceAsC, ci as resetBalance, cj as calcFiatValue, ck as markBalanceAsManual, cl as markBalanceAsN, cm as trimAllStrings, cn as isTxHash, co as getMetaData, cp as markBalanceUsingCostBasis, cq as updateBalanceCB, cr as getSlotFromDateId, au as appTimezone, cs as onErrorCaptured, ct as getAllMetaData, cu as isZeroOrGreater, bf as useWalletAccount, cv as getRawData, aI as onUnmounted, cw as isAccountLoadingRawReportingData, cx as isLoadingRawReportingData, cy as loadRawData, a8 as useAppWallet, aa as SyncState, ad as withKeys, ak as walletGroupMap, cz as getIAppWallet, cA as loadRawDataRewards, cB as saveRawData, cC as clearRawData, cD as addRawData, X as nextTick, cE as sortRawBalanceList, cF as subtract, cG as neg, cH as divide, cI as abs, cJ as isGreaterThanZero, cK as getAssetInfoLight, cL as doLoadMissingAssetInfo, cM as saveMetaData, cN as clearMetaData, cO as ITxBalanceType, cP as getDateIdFromSlot, cQ as addPriceOfDay, cR as combineData, cS as setMetaData, cT as getAllReportData, cU as getCSVADAAmount, cV as getCSVAmount, cW as getCSVAmount2, cX as bigToNum, cY as multiply, cZ as saveReportData, c_ as clearReportData, c$ as createReportData, d0 as getAccountIdListByEntity, d1 as createLedger, d2 as getReports, d3 as doLoadMissingAssetInfoByStringList, d4 as setReportData, x as isSignMode } from "./index.js";
...
const _hoisted_4$f = { class: "px-4 pb-4" };
...
const _hoisted_4$d = { class: "cc-text-bold cc-text-sz capitalize text-middle" };
        ...
        filteredList.value.length > 0 ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_2$f, [
            createBaseVNode("table", _hoisted_3$e, [
              createBaseVNode("thead", null, [
                createBaseVNode("tr", _hoisted_4$d, [
                  createBaseVNode("th", {
                    class: "text-left min-w-24 cursor-pointer pr-1 sm:pr-2",
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$d, [
        createBaseVNode("div", _hoisted_2$d, [
          ...
          __props.costBasis.ts ? (openBlock(), createElementBlock("span", _hoisted_4$b, toDisplayString(unref(formatDatetime2)(new Date(__props.costBasis.ts), true, false)), 1)) : createCommentVNode("", true),
...
const ReportCBListEntryBalance = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-5a903c0f"]]);
...
const _hoisted_4$a = { class: "m-2 sm:m-4 grid grid-cols-12 gap-2" };
          ...
          createBaseVNode("div", _hoisted_15, [
            createBaseVNode("div", _hoisted_16, [
              createBaseVNode("div", _hoisted_17, [
                ...
                createBaseVNode("div", _hoisted_22, toDisplayString(unref(formatDatetime2)(blockTime.value)), 1),
...
const _hoisted_4$9 = { class: "flex flex-row" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        ...
        createBaseVNode("div", _hoisted_4$6, toDisplayString(unref(year2)), 1),
        createBaseVNode("button", {
          class: "p-4 col-span-2 rounded-xl border hover:border-amber-400",
          tabindex: "5",
...
const _hoisted_4$4 = { class: "col-span-12 flex flex-row flex-nowrap gap-2 justify-between" };
...
const _hoisted_4$3 = { class: "m-2 sm:m-4" };
...
const _hoisted_4$2 = { class: "h-full pr-1 flex flex-col self-start" };
...
const _hoisted_4$1 = { class: "col-span-12 grid grid-cols-12 cc-page-gap" };
