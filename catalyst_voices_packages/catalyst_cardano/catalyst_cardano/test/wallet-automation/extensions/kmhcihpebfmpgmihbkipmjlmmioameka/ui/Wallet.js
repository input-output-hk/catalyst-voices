import { el as getRequestData, em as ApiRequestType, en as ErrorSync, eo as DEFAULT_ACCOUNT_ID, d as defineComponent, o as openBlock, c as createElementBlock, e as createBaseVNode, u as unref, q as createVNode, a as createBlock, j as createCommentVNode, b as withModifiers, z as ref, D as watch, h as withCtx, H as Fragment, I as renderList, ag as useSelectedAccount, K as networkId, s as selectedAccountId, b4 as toHexString, X as nextTick, ep as cryptoBrowserifyExports, n as normalizeClass, i as createTextVNode, t as toDisplayString, C as onMounted, aY as addSignalListener, aS as onNetworkFeaturesUpdated, aI as onUnmounted, aZ as removeSignalListener, aX as useRoute, w as watchEffect, ad as withKeys, Q as QSpinnerDots_default, v as isNormalMode, bM as isIosApp, x as isSignMode, ce as getRandomId, L as pushScopeId, M as popScopeId, ab as timestampLocal, k as dispatchSignalSync, d8 as doToggleDappAccountId, r as resolveComponent } from "./index.js";
...
const _withScopeId = (n) => (pushScopeId("data-v-ff119fcb"), n = n(), popScopeId(), n);
...
const _hoisted_9 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-sync" }, null, -1));
...
const _hoisted_23 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "cc-none xxxs:block grow w-px" }, null, -1));
const _hoisted_24 = {
  key: 0,
...
const _hoisted_31 = { class: "mb-0.5 flex flex-row" };
const _hoisted_32 = {
  key: 0,
  class: "h-0 mr-1"
};
...
const _hoisted_34 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "flex flex-col space-y-1 justify-center items-center font-bold" }, [
  /* @__PURE__ */ createBaseVNode("span", null, "Buy"),
  /* @__PURE__ */ createBaseVNode("span", null, "ADA")
], -1));
const _hoisted_35 = {
  key: 0,
...
const _hoisted_37 = { class: "grow-0 shrink-0 w-full flex flex-row flex-nowrap items-start justify-between cc-bg-white-0 border-b cc-p" };
const _hoisted_38 = { class: "flex flex-col cc-text-sz" };
const _hoisted_39 = { class: "p-4" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$1, [
          createBaseVNode("div", _hoisted_2$1, [
            createBaseVNode("div", {
              ...
              unref(appWallet) ? (openBlock(), createElementBlock("div", _hoisted_4, [
                ...
                unref(appAccount) ? (openBlock(), createElementBlock("span", _hoisted_8, [
                  ...
                  unref(isManualSyncEnabled) ? (openBlock(), createElementBlock("span", _hoisted_10, [
                    createTextVNode("Manual, "),
                    unref(appAccount).syncInfo.isInitializing && unref(isAccountSyncing) ? (openBlock(), createElementBlock("span", _hoisted_11, " preparing for")) : unref(isAccountSyncing) ? (openBlock(), createElementBlock("span", _hoisted_12, " syncing for")) : !(lastSync1.value || lastSync2.value) && unref(isManualSyncEnabled) ? (openBlock(), createElementBlock("span", _hoisted_13, " not synced yet")) : (openBlock(), createElementBlock("span", _hoisted_14, " synced"))
                  ])) : unref(appAccount).syncInfo.isInitializing ? (openBlock(), createElementBlock("span", _hoisted_15, "Initializing")) : unref(isAccountSyncing) ? (openBlock(), createElementBlock("span", _hoisted_16, "Syncing for")) : (openBlock(), createElementBlock("span", _hoisted_17, "Synced")),
                  lastSync1.value ? (openBlock(), createElementBlock("span", _hoisted_18, " ")) : createCommentVNode("", true),
                  lastSync1.value ? (openBlock(), createElementBlock("span", _hoisted_19, toDisplayString(lastSync1.value), 1)) : createCommentVNode("", true),
                  lastSync2.value ? (openBlock(), createElementBlock("span", _hoisted_20, " ")) : createCommentVNode("", true),
                  lastSync2.value ? (openBlock(), createElementBlock("span", _hoisted_21, toDisplayString(lastSync2.value), 1)) : createCommentVNode("", true),
                  (lastSync1.value || lastSync2.value) && !unref(isAccountSyncing) ? (openBlock(), createElementBlock("span", _hoisted_22, " ago")) : createCommentVNode("", true)
                ])) : createCommentVNode("", true)
              ])) : createCommentVNode("", true)
            ], 32),
            _hoisted_23,
            unref(appAccount) && unref(isNormalMode)() ? (openBlock(), createElementBlock("div", {
              ...
              unref(appAccount).isDappAccount ? (openBlock(), createElementBlock("svg", _hoisted_24, _hoisted_26)) : (openBlock(), createElementBlock("svg", _hoisted_27, _hoisted_29))
            ])) : createCommentVNode("", true),
            createBaseVNode("div", {
              ...
              unref(appAccount) ? (openBlock(), createElementBlock("div", _hoisted_30, [
                createBaseVNode("div", _hoisted_31, [
                  unref(isAccountSyncing) ? (openBlock(), createElementBlock("div", _hoisted_32, [
                    createVNode(QSpinnerDots_default, {
                      color: "gray",
                      size: "1rem"
                    })
                  ])) : createCommentVNode("", true),
                  unref(appAccount).isDappAccount ? (openBlock(), createElementBlock("i", _hoisted_33)) : createCommentVNode("", true),
        ...
        !unref(isSignMode)() ? (openBlock(), createElementBlock("div", _hoisted_35, [
          createBaseVNode("nav", _hoisted_36, [
