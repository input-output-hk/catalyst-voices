import { d as defineComponent, a7 as toRefs, z as ref, u as unref, o as openBlock, a as createBlock, V as createSlots, h as withCtx, e as createBaseVNode, q as createVNode, j as createCommentVNode, f as computed, cF as subtract, D as watch, jX as setRewardsLocked, fG as dispatchSignalSyncTo, fH as doUpdateAccountBalances, c2 as isZero, c as createElementBlock, Q as QSpinnerDots_default, t as toDisplayString, n as normalizeClass, cJ as isGreaterThanZero, i as createTextVNode, b as withModifiers, cG as neg, ag as useSelectedAccount } from "./index.js";
...
const _hoisted_9 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-arrow-right-circle-outline" }, null, -1);
const _hoisted_10 = {
  key: 2,
  class: "col-span-12 flex flex-row w-full justify-between"
};
const _hoisted_11 = { class: "flex flex-row flex-nowrap" };
const _hoisted_12 = { class: "cc-text-inactive" };
const _hoisted_13 = {
  key: 3,
  class: "col-span-12 flex flex-row w-full justify-between"
};
const _hoisted_14 = { class: "flex flex-row flex-nowrap" };
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-arrow-right-circle-outline" }, null, -1);
const _hoisted_16 = {
  key: 4,
  class: "col-span-12 flex flex-row w-full justify-between"
};
const _hoisted_17 = { class: "flex flex-row flex-nowrap" };
const _hoisted_18 = { class: "cc-text-inactive" };
const _hoisted_19 = {
  key: 5,
  class: "col-span-12 flex flex-row w-full justify-between"
};
const _hoisted_20 = { class: "flex flex-row flex-nowrap" };
const _hoisted_21 = { class: "cc-text-inactive" };
const _hoisted_22 = {
  key: 6,
  class: "col-span-12 flex flex-row w-full justify-between"
};
const _hoisted_23 = { class: "flex flex-row flex-nowrap" };
const _hoisted_24 = { class: "cc-text-inactive" };
const _hoisted_25 = {
  key: 8,
  class: "col-span-12 flex flex-row w-full justify-between"
};
const _hoisted_26 = { class: "flex flex-row flex-nowrap" };
const _hoisted_27 = { class: "cc-text-inactive" };
    ...
    return (_ctx, _cache) => {
      return !(unref(accountBalances) && (__props.alwaysShowHeader || !isZero(unref(accountBalances).lockedTotal.total))) ? (openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        showDetails.value && unref(accountBalances) ? (openBlock(), createElementBlock("div", _hoisted_3, [
          ...
          !isZero(unref(accountBalances).collateral.total) ? (openBlock(), createElementBlock("div", _hoisted_10, [
            createBaseVNode("div", _hoisted_11, [
              ...
              createBaseVNode("div", _hoisted_12, toDisplayString(unref(it)("common.balance.lockedByCollateral")), 1)
            ]),
            createVNode(_sfc_main$6, {
          ...
          !isZero(unref(accountBalances).locked.total) ? (openBlock(), createElementBlock("div", _hoisted_13, [
          ...
          !isZero(unref(accountBalances).lockedByTokens.total) ? (openBlock(), createElementBlock("div", _hoisted_16, [
            createBaseVNode("div", _hoisted_17, [
              ...
              createBaseVNode("div", _hoisted_18, toDisplayString(unref(it)("common.balance.lockedByTokens")), 1)
            ]),
            createVNode(_sfc_main$6, {
          ...
          !isZero(subtract(unref(accountBalances).lockedByTokens.total, unref(accountBalances).lockedByTokensTF.total)) ? (openBlock(), createElementBlock("div", _hoisted_19, [
            createBaseVNode("div", _hoisted_20, [
              ...
              createBaseVNode("div", _hoisted_21, toDisplayString(unref(it)("common.balance.lockedByTokensTF")), 1)
            ]),
            createVNode(_sfc_main$6, {
          ...
          !isZero(unref(accountBalances).lockedByRewards.total) ? (openBlock(), createElementBlock("div", _hoisted_22, [
            createBaseVNode("div", _hoisted_23, [
              ...
              createBaseVNode("div", _hoisted_24, toDisplayString(unref(it)("common.balance.lockedAsRewards")), 1)
            ]),
            createVNode(_sfc_main$6, {
          ...
          __props.showFees ? (openBlock(), createElementBlock("div", _hoisted_25, [
            createBaseVNode("div", _hoisted_26, [
              ...
              createBaseVNode("div", _hoisted_27, toDisplayString(unref(it)("common.balance.lockedFees")), 1)
            ]),
            createVNode(_sfc_main$6, {
