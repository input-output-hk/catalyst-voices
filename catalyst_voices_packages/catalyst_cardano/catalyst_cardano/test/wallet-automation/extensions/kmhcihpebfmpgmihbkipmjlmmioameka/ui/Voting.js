...
import { gy as endPoints, N as api, d as defineComponent, cs as onErrorCaptured, o as openBlock, c as createElementBlock, e as createBaseVNode, t as toDisplayString, j as createCommentVNode, q as createVNode, h as withCtx, i as createTextVNode, u as unref, z as ref, f as computed, H as Fragment, I as renderList, a as createBlock, aJ as QPagination_default, n as normalizeClass, C as onMounted, D as watch, X as nextTick, gz as isSameArray, aC as renderSlot, B as useFormatter, U as reactive, a9 as useQuasar, K as networkId, gA as getResultsDate, gB as isValidDate, a4 as now, aY as addSignalListener, gC as onTxSubmitted, aI as onUnmounted, aZ as removeSignalListener, b as withModifiers, a2 as isMobileApp, bM as isIosApp, bQ as isAndroidApp, ce as getRandomId, ag as useSelectedAccount, gD as generateCatalystKey, bD as getDataSignErrorMsg, bC as ErrorSignData, fZ as getTxBuiltErrorMsg, fU as ErrorBuildTx, gE as onBuiltTxVoteReg, bn as dispatchSignal, gF as doBuildTxVoteReg, el as getRequestData, em as ApiRequestType, en as ErrorSync, eo as DEFAULT_ACCOUNT_ID, gG as getDRepAddressFromKeyHash, c2 as isZero, cY as multiply, cH as divide, gH as getCCColdAddressFromKeyHash, gI as getCCHotAddressFromKeyHash, gJ as epochParams, gK as getIAppAccountById, eB as getAddressCredentials, gL as onBuiltTxVoteDelegation, gM as doBuildTxVoteDelegation, gN as onEpochParamsUpdated, aS as onNetworkFeaturesUpdated } from "./index.js";
import { u as useTranslation } from "./useTranslation.js";
import { u as useAdaSymbol } from "./useAdaSymbol.js";
import { u as useKeystoneDevice, _ as _sfc_main$l } from "./Keystone.vue_vue_type_script_setup_true_lang.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const validateCustomDRepId = (value) => {
      ...
      if (value && (!value.startsWith("drep") || value.length !== 56)) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        }, null, 8, ["text", "icon"])) : unref(epochParams).isAtLeastConwayEra2 && (((_a2 = unref(rewardInfo)) == null ? void 0 : _a2.govDelegationList.length) ?? 0) === 0 ? (openBlock(), createBlock(_sfc_main$g, {
          key: 1,
          html: "",
          class: "col-span-12",
          css: "cc-rounded cc-banner-warning",
        ...
        showDelegation.value && unref(epochParams).isAtLeastConwayEra ? (openBlock(), createElementBlock("div", _hoisted_18, [
