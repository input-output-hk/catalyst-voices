...
(function() {
  ...
  var TxSignErrorCode = /* @__PURE__ */ ((TxSignErrorCode2) => {
    ...
    TxSignErrorCode2[TxSignErrorCode2["DepreciatedCertificate"] = 3] = "DepreciatedCertificate";
  ...
  **/
  ...
  networkFeaturesMap["preprod"] = INetworkFeature.STAKING | INetworkFeature.DAPP_BROWSER | INetworkFeature.SWAP | INetworkFeature.CREATE_SWAP | INetworkFeature.CATALYST;
  networkFeaturesMap["preview"] = INetworkFeature.STAKING | INetworkFeature.DAPP_BROWSER;
  ...
  const isTestnetNetwork = (networkId2) => getNetworkId$2(networkId2) === 0;
