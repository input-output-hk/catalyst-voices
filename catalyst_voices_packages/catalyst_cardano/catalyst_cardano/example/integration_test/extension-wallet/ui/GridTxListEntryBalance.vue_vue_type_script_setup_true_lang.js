import { d as defineComponent, z as ref, D as watch, o as openBlock, c as createElementBlock, e as createBaseVNode, q as createVNode, H as Fragment, I as renderList, t as toDisplayString, u as unref, j as createCommentVNode, cn as getAssetIdBech32, co as accAssetInfoMap, cp as fetchAssetInfo, K as networkId, cq as updateAccountAssetInfoMap, aK as useGuard, cm as getAssetName, i as createTextVNode, h as withCtx } from "./index.js";
        ...
        for (const policy of Object.entries(balance.multiasset)) {
          for (const asset of Object.entries(policy[1])) {
            ...
            if (count <= props.assetLimit) {
              ...
              if ((await isAssetOnBlockList(getAssetIdBech32(policy[0], asset[0]))).length > 0) {
