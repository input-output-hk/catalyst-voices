import { iN as getDappFavorites, z as ref, f as computed, X as nextTick, iO as addDappBrowserFavorite$1, K as networkId, a0 as isStagingApp, N as api, eL as el, iP as delDappBrowserFavorite$1, d as defineComponent, eG as useSlots, o as openBlock, a as createBlock, e as createBaseVNode, n as normalizeClass, b as withModifiers, ad as withKeys, c as createElementBlock, aC as renderSlot, j as createCommentVNode, F as withDirectives, J as vShow, iM as Teleport, a7 as toRefs, bf as useWalletAccount, dj as getIDAppConnectEntry, D as watch, aY as addSignalListener, bx as onTxSignSubmit, by as onTxSignCancel, bX as onDataSignSubmit, bY as onDataSignCancel, aZ as removeSignalListener, aI as onUnmounted, C as onMounted, u as unref, h as withCtx, q as createVNode, t as toDisplayString, i as createTextVNode, cw as getRandomId, iQ as getIDAppConnectProperty, iR as TxSignErrorCode, iS as DataSignErrorCode, iT as useDAppBrowser, aK as useGuard, iU as getTxSignParseError, a$ as ErrorSignTx, iV as parseTxList, iW as parseData, iX as getDataSignParseError } from "./index.js";
...
const _hoisted_5$1 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-window-minimize" }, null, -1);
const _hoisted_6$1 = [
  _hoisted_5$1
];
...
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("div", { class: "relative mt-1 ml-1 w-2 h-2 bg-gray-400 drop-shadow rounded-sm" }, null, -1);
const _hoisted_5 = { class: "absolute top-0 left-6 text-xs whitespace-nowrap" };
const _hoisted_6 = { class: "col-span-12 grid grid-cols-12 cc-bg-white-0 rounded-borders m-3 p-10 h-5/6" };
const _hoisted_7 = { class: "col-span-12 cc-text-extra-bold cc-text-red-light text-3xl" };
const _hoisted_8 = { class: "col-span-12 mt-6 w-full max-w-full text-xl" };
const _hoisted_9 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_11 = ["innerHTML"];
const _hoisted_12 = { class: "w-full h-full py-0 flex flex-col flex-nowrap justify-center items-center" };
const _hoisted_13 = ["allow", "src"];
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onSubmitTx = (witnessSetList) => {
      ...
      if (currentSignTxResolve)
        currentSignTxResolve(witnessSetList);
      _resetSignTx();
    };
    const _resetSignTx = () => {
    ...
    const onErrorData = (errorCode, info = "") => {
      ...
      if (currentSignDataReject)
        currentSignDataReject({
          code: errorCode,
          info
        });
      _resetSignData();
    ...
    const onSubmitData = (payload) => {
      ...
      if (currentSignDataResolve)
        currentSignDataResolve(payload.signedData);
      _resetSignData();
    };
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_2, [
              !isConnected.value ? (openBlock(), createElementBlock("div", _hoisted_3, [
                _hoisted_4,
                createBaseVNode("div", _hoisted_5, "connecting (" + toDisplayString(attempts.value) + ")...", 1)
              ])) : createCommentVNode("", true)
            ])
          ], 2)
        ]),
        content: withCtx(() => [
          isScam.value ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_6, [
              createBaseVNode("div", _hoisted_7, toDisplayString(unref(it)("common.scam.guard.warning")), 1),
