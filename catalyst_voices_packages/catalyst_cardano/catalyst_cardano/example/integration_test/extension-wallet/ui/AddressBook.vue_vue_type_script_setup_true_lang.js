import { fD as AdaHandleError, N as api, fx as isValidSendAddress, d as defineComponent, a7 as toRefs, z as ref, D as watch, u as unref, o as openBlock, a as createBlock, h as withCtx, c as createElementBlock, e as createBaseVNode, q as createVNode, j as createCommentVNode, fM as addressBook, K as networkId, aN as isTestnet, fN as updateAddressBookEntry, a9 as useQuasar, f as computed, n as normalizeClass, b as withModifiers, t as toDisplayString, H as Fragment, I as renderList, aJ as QPagination_default, gB as deleteAddressBookEntry, i as createTextVNode, Q as QSpinnerDots_default } from "./index.js";
...
const resolveAdaHandle = async (networkId2, adaHandle) => {
  ...
  if (((_a = res == null ? void 0 : res.data) == null ? void 0 : _a.address) && ((_b = res == null ? void 0 : res.data) == null ? void 0 : _b.fingerprint)) {
    if (!isValidSendAddress(isTestnetNetwork(networkId2), res.data.address)) {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const validateAddrInput = () => {
      ...
      if (!isValidSendAddress(isTestnet.value, addrInput.value) && !isMilkomedaAddress(addrInput.value)) {
