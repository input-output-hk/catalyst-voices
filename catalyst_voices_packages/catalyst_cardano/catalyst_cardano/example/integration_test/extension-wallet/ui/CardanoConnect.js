...
import { d as defineComponent, dq as useCardanoConnect, K as networkId, z as ref, o as openBlock, c as createElementBlock, e as createBaseVNode, t as toDisplayString, u as unref, i as createTextVNode, n as normalizeClass, j as createCommentVNode, a as createBlock, B as useFormatter, bf as useWalletAccount, U as reactive, w as watchEffect, aI as onUnmounted, q as createVNode, H as Fragment, I as renderList, dr as useUiSelectedAccount, dk as getWalletNameList, a9 as useQuasar, D as watch, ds as savePeerInfo, C as onMounted, h as withCtx, dt as walletsExists, du as EternlPeerConnect, f as computed, b as withModifiers, X as nextTick, dv as cardanoConnectDBList, bZ as onBeforeMount, aJ as QPagination_default, dw as updateCardanoConnectList, cH as onErrorCaptured } from "./index.js";
...
function getCallingFunctionName(...args) {
  var _a;
  const error = new Error();
  const stack = (_a = error.stack) == null ? void 0 : _a.split("\n");
  let source = "unknown source";
  if (stack && stack.length >= 4) {
    const stackLine = stack[4].trim();
    if (stackLine.startsWith("at")) {
      const functionName = stackLine.split(" ")[1];
      const location = stackLine.split(" ")[2] || "";
      const fileMatch = location.match(/[^/\\]*\.\w+/);
      const fileName = fileMatch ? fileMatch[0] : "unknown file";
      source = functionName ? `${functionName} (${fileName})` : `${fileName} ${location}`;
    } else {
      source = stackLine;
    }
  }
  const fixedWidthSource = source.padEnd(50, " ");
  console.warn(`${fixedWidthSource}:`, ...args);
}
const log = (...entries) => {
  getCallingFunctionName(...entries);
};
...
const _hoisted_11$1 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-open-in-new ml-1" }, null, -1);
const _hoisted_12$1 = { class: "grid grid-cols-12 w-full" };
const _hoisted_13$1 = { class: "col-span-6 cc-area-light-1 p-2 m-1" };
const _hoisted_14 = { class: "col-span-12 text-xs" };
const _hoisted_15 = { class: "col-span-12 cc-text-bold justify-start" };
const _hoisted_16 = { class: "col-span-6 cc-area-light-1 py-2 my-1 pl-2 ml-1" };
const _hoisted_17 = { class: "col-span-12 text-xs" };
const _hoisted_18 = { class: "col-span-12 cc-text-bold justify-start" };
const _hoisted_19 = { class: "grid grid-cols-12 w-full" };
const _hoisted_20 = { class: "col-span-6 cc-area-light-1 p-2 m-1" };
const _hoisted_21 = { class: "w-full grid grid-cols-12" };
const _hoisted_22 = { class: "col-span-6" };
const _hoisted_23 = { class: "w-full" };
const _hoisted_24 = { class: "w-full text-xs pr-2" };
const _hoisted_25 = { class: "w-full text-bold" };
const _hoisted_26 = { class: "w-full mt-2 text-xs" };
const _hoisted_27 = { class: "w-full text-xs pr-2" };
const _hoisted_28 = { class: "w-full text-bold" };
const _hoisted_29 = { class: "col-span-6 flex justify-center items-center" };
const _hoisted_30 = { class: "flex flex-col items-center" };
const _hoisted_31 = {
...
const _hoisted_34 = { class: "col-span-6 cc-area-light-1 py-2 my-1 pl-2 ml-1" };
const _hoisted_35 = { class: "w-full" };
const _hoisted_36 = { class: "w-full text-xs pr-2" };
const _hoisted_37 = { class: "w-full py-2 my-1" };
const _hoisted_38 = { class: "w-full grid grid-cols-12" };
const _hoisted_39 = { class: "col-span-4 cc-text-bold pr-2" };
const _hoisted_40 = {
  key: 0,
...
const _hoisted_42 = { class: "w-full py-2 my-1" };
...
const _hoisted_46 = { class: "w-full col-span-12 grid grid-cols-12" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        ...
        createBaseVNode("div", _hoisted_12$1, [
          createBaseVNode("div", _hoisted_13$1, [
            createBaseVNode("div", _hoisted_14, toDisplayString(unref(it)("directconnect.connect.labels.walletConnectionId")), 1),
            createBaseVNode("div", _hoisted_15, toDisplayString(__props.peerInfo.walletConnectionId), 1)
          ]),
          createBaseVNode("div", _hoisted_16, [
            createBaseVNode("div", _hoisted_17, toDisplayString(unref(it)("directconnect.connect.labels.address")), 1),
            createBaseVNode("div", _hoisted_18, toDisplayString(__props.peerInfo.peerDappInfo.address), 1)
          ])
        ]),
        createBaseVNode("div", _hoisted_19, [
            ...
            createBaseVNode("div", _hoisted_21, [
              createBaseVNode("div", _hoisted_22, [
                createBaseVNode("div", _hoisted_23, [
                  createBaseVNode("div", _hoisted_24, toDisplayString(unref(it)("directconnect.connect.labels.walletId")), 1)
                ]),
                createBaseVNode("div", _hoisted_25, toDisplayString(unref(walletName)), 1),
                createBaseVNode("div", _hoisted_26, [
                  createBaseVNode("div", _hoisted_27, toDisplayString(unref(it)("directconnect.connect.labels.accountPubKey")), 1)
                ]),
                createBaseVNode("div", _hoisted_28, toDisplayString(unref(accountName)), 1)
              ]),
              createBaseVNode("div", _hoisted_29, [
                createBaseVNode("div", _hoisted_30, [
                  createBaseVNode("div", _hoisted_31, toDisplayString(unref(it)("directconnect.connect.identicon.image")), 1),
                  createBaseVNode("div", _hoisted_32, [
                    identicon.value ? (openBlock(), createElementBlock("img", {
                      ...
                      src: identicon.value
                    }, null, 10, _hoisted_33)) : createCommentVNode("", true)
                  ])
                ])
              ])
            ])
          ...
          createBaseVNode("div", _hoisted_34, [
            createBaseVNode("div", _hoisted_35, [
              createBaseVNode("div", _hoisted_36, toDisplayString(unref(it)("directconnect.connect.labels.info")), 1)
            ]),
            createBaseVNode("div", _hoisted_37, [
              createBaseVNode("div", _hoisted_38, [
                createBaseVNode("div", _hoisted_39, toDisplayString(unref(it)("directconnect.connect.labels.autoConnect")), 1),
                createBaseVNode("div", {
                  ...
                  !__props.peerInfo.autoConnect ? (openBlock(), createElementBlock("i", _hoisted_41)) : createCommentVNode("", true)
                ])
              ])
            ]),
            createBaseVNode("div", _hoisted_42, [
              createBaseVNode("div", _hoisted_43, [
                createBaseVNode("div", _hoisted_44, toDisplayString(unref(it)("directconnect.connect.labels.lastActive")), 1),
                createBaseVNode("div", _hoisted_45, toDisplayString(unref(formatDatetime)(__props.peerInfo.lastActive ?? 0)), 1)
              ]),
              createBaseVNode("div", _hoisted_46, [
                createBaseVNode("div", _hoisted_47, toDisplayString(unref(it)("directconnect.connect.labels.created")), 1),
                createBaseVNode("div", _hoisted_48, toDisplayString(unref(formatDatetime)(__props.peerInfo.created)), 1)
              ])
            ])
          ])
        ]),
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const disconnect = () => {
      var _a2;
      log$1("disconnect", currentDBInfo.value, dAppIdentifier.value);
      if (!currentDBInfo.value) {
        log$1("peer connect not found in disconnect", peerConnect.value);
        return;
      }
      try {
    ...
    const saveChanges = async () => {
      ...
      if (dbInfo.value) {
        ...
        if (!uiSelectedWalletId.value || !uiSelectedAccountId.value) {
          log$1("No wallet selected, cannot inject new api.");
          return;
        }
...
const _hoisted_7 = { class: "cc-none inline-flex justify-center cc-badge-blue" };
const _hoisted_8 = { class: "ml-6 mt-1 cc-addr break-normal" };
const _hoisted_9 = { class: "relative col items-center w-full max-w-full" };
const _hoisted_10 = {
  key: 0,
...
const _hoisted_13 = /* @__PURE__ */ createBaseVNode("button", {
  type: "button",
  "aria-label": "sync wallet",
  class: "relative h-full text-md sm:text-xl px-2.5 flex flex-col justify-center items-center cursor-pointer cc-text-highlight-hover"
}, [
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const deleteEntry = async () => {
      if (!networkId.value || !props.entry)
        return;
    ...
    const toggleConnection = (event) => {
      log$1("toggle connection coming from detail in list view", dbInfo.value);
            ...
            createBaseVNode("div", _hoisted_1$2, [
              createBaseVNode("div", _hoisted_2$2, [
                ...
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_5, toDisplayString((_a2 = unref(dbInfo)) == null ? void 0 : _a2.peerDappInfo.name), 1),
                  ...
                  ((_d = unref(dbInfo)) == null ? void 0 : _d.autoConnect) ? (openBlock(), createElementBlock("div", _hoisted_6, [
              ...
              createBaseVNode("div", _hoisted_8, toDisplayString((_e = unref(dbInfo)) == null ? void 0 : _e.peerDappInfo.url), 1)
            ]),
            createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_9, [
                ((_f = unref(dbInfo)) == null ? void 0 : _f.active) ? (openBlock(), createElementBlock("div", _hoisted_10, [
                  _hoisted_11,
                  createVNode(_sfc_main$d, {
                    anchor: "center right",
                    self: "center left",
                ...
                !((_g = unref(dbInfo)) == null ? void 0 : _g.active) ? (openBlock(), createElementBlock("div", _hoisted_12, [
                  _hoisted_13,
                  createVNode(_sfc_main$d, {
                    anchor: "center right",
                    self: "center left",
