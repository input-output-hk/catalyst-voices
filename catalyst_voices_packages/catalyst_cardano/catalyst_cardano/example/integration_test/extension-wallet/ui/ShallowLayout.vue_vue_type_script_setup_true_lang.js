...
import { d as defineComponent, o as openBlock, c as createElementBlock, e as createBaseVNode, q as createVNode, u as unref, K as networkId, n as normalizeClass, j as createCommentVNode, t as toDisplayString, aC as renderSlot } from "./index.js";
...
const _hoisted_2$4 = { class: "group shrink flex flex-row flex-nowrap items-start justify-start cc-rounded cc-btn-focus h-3/4 cc-border-reset cc-btn-focus cc-text-semi-bold cc-text-xl text-center whitespace-nowrap" };
const _hoisted_3$3 = /* @__PURE__ */ createBaseVNode("div", { class: "grow shrink" }, null, -1);
const _hoisted_4$1 = /* @__PURE__ */ createBaseVNode("div", { class: "w-10 h-10 flex flex-row flex-nowrap justify-center items-center" }, null, -1);
...
const _hoisted_2$3 = { class: "relative w-full px-1 py-0.5 overflow-hidden cc-site-max-width mx-auto cc-rounded-la cc-shadow cc-text-medium cc-text-xs cc-text-color-light text-center cc-online" };
const _hoisted_3$2 = /* @__PURE__ */ createBaseVNode("div", { class: "relative whitespace-nowrap capitalize cc-text-semi-bold mt-px -mb-px" }, [
...
const _hoisted_2$2 = { class: "capitalize mr-1" };
const _hoisted_3$1 = /* @__PURE__ */ createBaseVNode("i", { class: "text-xs -mt-0.5 mdi mdi-check-circle text-purple-400 dark:text-purple-600" }, null, -1);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(networkId) ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("span", _hoisted_2$2, toDisplayString(unref(it)("common.network." + unref(networkId) + ".badge")), 1),
        _hoisted_3$1
...
const _hoisted_2$1 = /* @__PURE__ */ createBaseVNode("div", { class: "whitespace-nowrap text-center flex flex-row flex-nowrap space-x-1.5" }, " ", -1);
...
const _hoisted_7 = { class: "shallow-layout-main relative h-full flex-1 overflow-hidden focus:outline-none flex flex-col flex-nowrap" };
