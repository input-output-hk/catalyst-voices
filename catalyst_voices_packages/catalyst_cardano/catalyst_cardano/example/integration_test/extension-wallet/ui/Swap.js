import { d as defineComponent, z as ref, o as openBlock, c as createElementBlock, n as normalizeClass, e as createBaseVNode, t as toDisplayString, u as unref, a as createBlock, cn as getAssetIdBech32, j as createCommentVNode, h as withCtx, q as createVNode, hn as swapAssetInfoCnt, K as networkId, H as Fragment, D as watch, i as createTextVNode, cs as QToggle_default, at as appLanguageTag, f as computed, ck as isZero, f0 as compare, b as withModifiers, B as useFormatter, f7 as multiply, Q as QSpinnerDots_default, ho as defaultSlippage, cX as divide, hp as getProvider, I as renderList, hq as round, S as normalizeStyle, a9 as useQuasar, C as onMounted, F as withDirectives, J as vShow, hr as providerList, X as nextTick, cH as onErrorCaptured, hs as syncStartAI, ht as syncStartAI$1, hu as getSwapSettings, hv as formatAssetName, hw as getEternlFee, bn as dispatchSignal, hx as doInitSwap, aI as onUnmounted, aZ as removeSignalListener, ag as useSelectedAccount, hy as isEqualAssetList, hz as getAssetInfo, hA as getSwapAssetInfo, hB as getSwapAssetInfo$1, hC as selectBestPool, cV as subtract, hD as fetchSwapPools, hE as swapProviderList, eP as add, c8 as json, aY as addSignalListener, ga as getTxBuiltErrorMsg, g5 as ErrorBuildTx, hF as onBuiltTxSwap, hG as doBuildTxSwap, hH as fetchSwapEstimate, hI as getRootAddress, hJ as createSwapOrder, gy as parseTxSignRequest, hK as getErrorMsg, hL as fetchSwapDatum, hM as setSwapSettings, hN as swapRouteList, hO as verifiedAssetMap, hP as onAccountDataUpdated, cw as getRandomId, hQ as createISwapSettings, aS as sleep, hR as fetchAvgPrice, cm as getAssetName, hS as onBuiltTxSwapCancel, hT as doBuildTxSwapCancel, hU as fetchLpInfo, hV as updateForBestPool, aJ as QPagination_default, hW as onAccountListUpdated, hX as lastOrderUpdate, hY as openOrderList, hZ as isFetchingOrders, h_ as orderUpdateDelay, a4 as now, h$ as fetchOpenOrders, i0 as fetchOpenOrders$1, i1 as fetchEnabledAggList } from "./index.js";
...
const _hoisted_5$4 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-1" }, "/", -1);
const _hoisted_6$4 = {
  key: 0,
          ...
          createVNode(GridInput, {
            ...
            "icon-append": withCtx(() => [
              ...
              createBaseVNode("button", {
                ...
                !__props.updatingPrice ? (openBlock(), createElementBlock("i", _hoisted_6$4)) : (openBlock(), createBlock(QSpinnerDots_default, {
                  key: 1,
                  color: "gray",
                  size: "1em"
                }))
...
const _hoisted_1$6 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-chevron-right mr-1" }, null, -1);
const _hoisted_2$5 = /* @__PURE__ */ createBaseVNode("span", { class: "cc-text-normal" }, "1", -1);
const _hoisted_3$4 = { class: "ml-1 cc-text-normal" };
const _hoisted_4$4 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-1 cc-text-normal" }, "=", -1);
const _hoisted_5$3 = { class: "ml-1 cc-text-normal" };
const _hoisted_6$3 = {
  key: 0,
  class: "flex flex-row"
};
const _hoisted_7$3 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-1 mr-0.5" }, "(", -1);
const _hoisted_8$3 = { class: "ml-1" };
const _hoisted_9$3 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-0.5" }, ")", -1);
const _hoisted_10$3 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-2 cc-text-bold cc-text-lg" }, "@", -1);
...
const _hoisted_15$2 = { class: "w-full p-2 flex flex-col" };
const _hoisted_16$2 = { class: "relative w-full cc-flex-fixed inline-block mb-1" };
const _hoisted_17$2 = { class: "relative w-full px-1 py-0.5 cc-site-max-width mx-auto cc-rounded cc-shadow cc-online cc-text-bold text-center" };
const _hoisted_18$2 = { class: "relative flex flex-row justify-center items-center" };
const _hoisted_19$2 = {
  key: 0,
  class: "flex flex-row justify-center items-center"
};
const _hoisted_20$2 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-1 mr-0.5" }, "(", -1);
const _hoisted_21$2 = { class: "ml-0.5 cc-text-normal" };
const _hoisted_22$2 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-0.5" }, ")", -1);
const _hoisted_23$1 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-2 cc-text-bold cc-text-lg" }, "@", -1);
const _hoisted_24$1 = ["src", "alt"];
const _hoisted_25$1 = { class: "capitalize ml-2" };
const _hoisted_26$1 = {
  key: 0,
...
const _hoisted_29 = { class: "ml-1 cc-text-normal" };
const _hoisted_30 = { class: "flex flex-row justify-between cc-text-color" };
const _hoisted_31 = { class: "inline cc-text-slate-0" };
const _hoisted_32 = { class: "relative flex flex-row flex-nowrap" };
const _hoisted_33 = /* @__PURE__ */ createBaseVNode("span", { class: "cc-text-normal" }, "1", -1);
const _hoisted_34 = { class: "ml-1 cc-text-normal" };
const _hoisted_35 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-1 cc-text-normal" }, "=", -1);
const _hoisted_36 = { class: "ml-1 cc-text-normal" };
const _hoisted_37 = {
  key: 1,
  class: "flex flex-row justify-between cc-text-color"
};
const _hoisted_38 = { class: "cc-text-slate-0" };
const _hoisted_39 = { class: "flex flex-row flex-nowrap" };
const _hoisted_40 = {
  key: 2,
  class: "flex flex-row justify-between cc-text-color"
};
const _hoisted_41 = { class: "cc-text-slate-0" };
const _hoisted_42 = { class: "flex flex-row flex-nowrap" };
const _hoisted_43 = { class: "w-full cc-tabs-button-static cc-rounded p-2" };
const _hoisted_44 = { class: "flex flex-row justify-between cc-text-color" };
const _hoisted_45 = { class: "cc-text-slate-0" };
const _hoisted_46 = { class: "ml-1 cc-text-normal" };
const _hoisted_47 = { class: "flex flex-row justify-between cc-text-color" };
const _hoisted_48 = { class: "cc-text-slate-0" };
const _hoisted_49 = { class: "flex flex-row flex-nowrap" };
const _hoisted_50 = { class: "ml-1 cc-text-normal" };
const _hoisted_51 = {
  key: 0,
  class: "flex flex-row justify-between cc-text-color"
};
const _hoisted_52 = { class: "inline cc-text-slate-0" };
const _hoisted_53 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-1 mr-0.5" }, "(", -1);
const _hoisted_54 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-1" }, "%", -1);
const _hoisted_55 = { class: "ml-1" };
const _hoisted_56 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-0.5" }, ")", -1);
const _hoisted_57 = { class: "flex flex-row flex-nowrap" };
const _hoisted_58 = { class: "ml-1 cc-text-normal" };
const _hoisted_59 = {
  key: 1,
  class: "flex flex-row justify-between cc-text-color"
};
const _hoisted_60 = { class: "inline cc-text-slate-0" };
const _hoisted_61 = { class: "relative flex flex-row flex-nowrap" };
const _hoisted_62 = /* @__PURE__ */ createBaseVNode("span", { class: "cc-text-normal" }, "1", -1);
const _hoisted_63 = { class: "ml-1 cc-text-normal" };
const _hoisted_64 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-1 cc-text-normal" }, "=", -1);
const _hoisted_65 = { class: "ml-1 cc-text-normal" };
const _hoisted_66 = {
  key: 2,
  class: "flex flex-row justify-between cc-text-color"
};
const _hoisted_67 = { class: "cc-text-slate-0" };
const _hoisted_68 = { class: "flex flex-row flex-nowrap" };
const _hoisted_69 = { class: "ml-1 cc-text-normal" };
const _hoisted_70 = { class: "flex flex-row justify-between cc-text-color" };
const _hoisted_71 = { class: "cc-text-slate-0" };
const _hoisted_72 = { class: "flex flex-row flex-nowrap" };
const _hoisted_73 = { class: "ml-1 cc-text-normal" };
const _hoisted_74 = { class: "flex flex-row justify-between cc-text-color" };
const _hoisted_75 = { class: "cc-text-slate-0" };
const _hoisted_76 = { class: "flex flex-row flex-nowrap" };
const _hoisted_77 = {
  key: 3,
  class: "flex flex-row justify-between cc-text-color"
};
const _hoisted_78 = { class: "cc-text-slate-0" };
const _hoisted_79 = { class: "flex flex-row flex-nowrap" };
const _hoisted_80 = { class: "flex flex-row justify-between cc-text-color" };
const _hoisted_81 = { class: "cc-text-slate-0" };
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const providerList2 = computed(() => {
      if (!props.swapInfo) {
        return [getProvider("")];
      }
      if (props.swapInfo._dex_ === "MuesliSwap") {
        return [getProvider(props.swapInfo.pool.provider)];
      }
      if (props.swapInfo._dex_ === "DexHunter") {
        return props.swapInfo.splits.map((split) => getProvider(split.dex));
      } else {
        return [getProvider("")];
      }
    });
    ...
    return (_ctx, _cache) => {
      ...
      return __props.swapInfo ? (openBlock(), createElementBlock("div", {
        ...
        !swapInfoDetails.value ? (openBlock(), createElementBlock("div", {
          ...
          _hoisted_1$6,
          _hoisted_2$5,
          createBaseVNode("span", _hoisted_3$4, toDisplayString(flipPrice.value ? __props.targetName : __props.sourceName), 1),
          _hoisted_4$4,
          ...
          createBaseVNode("span", _hoisted_5$3, toDisplayString(flipPrice.value ? __props.sourceName : __props.targetName), 1),
          !isZero(aggBonus.value) ? (openBlock(), createElementBlock("div", _hoisted_6$3, [
            _hoisted_7$3,
            createVNode(_sfc_main$f, {
              "is-whole-number": "",
              "hide-fraction-if-zero": "",
            ...
            createBaseVNode("span", _hoisted_8$3, toDisplayString(__props.targetName), 1),
            _hoisted_9$3
          ])) : createCommentVNode("", true),
          _hoisted_10$3,
          (openBlock(true), createElementBlock(Fragment, null, renderList(providerList2.value, (provider, index) => {
          ...
          swapSplits.value.length === 1 ? (openBlock(), createElementBlock("span", _hoisted_12$3, toDisplayString(providerList2.value[0].name), 1)) : createCommentVNode("", true),
        ...
        ], 2)) : (openBlock(), createElementBlock("div", _hoisted_13$3, [
          __props.calculating ? (openBlock(), createElementBlock("div", _hoisted_14$2, [
            createVNode(_sfc_main$c, {
              ...
              createBaseVNode("div", _hoisted_15$2, [
                createBaseVNode("div", _hoisted_16$2, [
                  createBaseVNode("div", _hoisted_17$2, [
                    ...
                    createBaseVNode("div", _hoisted_18$2, [
                      ...
                      !isZero(getSplitPriceDiff(split, __props.swapInfo._dex_)) ? (openBlock(), createElementBlock("div", _hoisted_19$2, [
                        _hoisted_20$2,
                        createVNode(_sfc_main$f, {
                          percent: "",
                          "hide-fraction-if-zero": "",
                        ...
                        createBaseVNode("span", _hoisted_21$2, toDisplayString(unref(t)("wallet.swap.create.info.pricediff")), 1),
                        _hoisted_22$2
                      ])) : createCommentVNode("", true),
                      _hoisted_23$1,
                      providerList2.value[index].image.length > 0 ? (openBlock(), createElementBlock("img", {
                        key: 1,
                        class: "w-4 h-4",
                        loading: "lazy",
                        src: providerList2.value[index].image,
                        alt: `${providerList2.value[index].name} logo`
                      }, null, 8, _hoisted_24$1)) : createCommentVNode("", true),
                      createBaseVNode("span", _hoisted_25$1, toDisplayString(providerList2.value[index].name), 1)
                    ])
                  ])
                ]),
                swapSplits.value.length > 1 ? (openBlock(), createElementBlock("div", _hoisted_26$1, [
                  createBaseVNode("span", _hoisted_27, toDisplayString(unref(t)("wallet.swap.create.info.estreceive")), 1),
                  createBaseVNode("div", _hoisted_28, [
                    ...
                    createBaseVNode("span", _hoisted_29, toDisplayString(__props.targetName), 1)
                  ])
                ])) : createCommentVNode("", true),
                createBaseVNode("div", _hoisted_30, [
                  ...
                  createBaseVNode("div", _hoisted_32, [
                    ...
                    _hoisted_33,
                    createBaseVNode("span", _hoisted_34, toDisplayString(flipPrice.value ? __props.targetName : __props.sourceName), 1),
                    _hoisted_35,
                    createVNode(_sfc_main$f, {
                      "is-whole-number": "",
                      "hide-fraction-if-zero": "",
                    ...
                    createBaseVNode("span", _hoisted_36, toDisplayString(flipPrice.value ? __props.sourceName : __props.targetName), 1)
                  ])
                ]),
                swapSplits.value.length > 1 ? (openBlock(), createElementBlock("div", _hoisted_37, [
                  createBaseVNode("span", _hoisted_38, toDisplayString(unref(t)("wallet.swap.create.info.batcherfee")), 1),
                ...
                swapSplits.value.length > 1 ? (openBlock(), createElementBlock("div", _hoisted_40, [
                  createBaseVNode("span", _hoisted_41, toDisplayString(unref(t)("wallet.swap.create.info.deposit")), 1),
          ...
          createBaseVNode("div", _hoisted_43, [
            createBaseVNode("div", _hoisted_44, [
              createBaseVNode("span", _hoisted_45, toDisplayString(unref(t)("wallet.swap.create.info.aggregator")), 1),
              createBaseVNode("span", _hoisted_46, toDisplayString(__props.swapInfo._dex_), 1)
            ]),
            createBaseVNode("div", _hoisted_47, [
              createBaseVNode("span", _hoisted_48, toDisplayString(unref(t)("wallet.swap.create.info.estreceive")), 1),
              createBaseVNode("div", _hoisted_49, [
                ...
                createBaseVNode("span", _hoisted_50, toDisplayString(__props.targetName), 1)
              ])
            ]),
            !__props.isLimitOrder ? (openBlock(), createElementBlock("div", _hoisted_51, [
              createBaseVNode("div", _hoisted_52, [
                ...
                _hoisted_54,
                createBaseVNode("span", _hoisted_55, toDisplayString(unref(t)("wallet.swap.create.info.slippage")), 1),
                _hoisted_56
              ]),
              createBaseVNode("div", _hoisted_57, [
                ...
                createBaseVNode("span", _hoisted_58, toDisplayString(__props.targetName), 1)
              ])
            ])) : createCommentVNode("", true),
            swapSplits.value.length > 1 ? (openBlock(), createElementBlock("div", _hoisted_59, [
              ...
              createBaseVNode("div", _hoisted_61, [
                ...
                _hoisted_62,
                createBaseVNode("span", _hoisted_63, toDisplayString(flipPrice.value ? __props.targetName : __props.sourceName), 1),
                _hoisted_64,
                createVNode(_sfc_main$f, {
                  "is-whole-number": "",
                  "hide-fraction-if-zero": "",
                ...
                createBaseVNode("span", _hoisted_65, toDisplayString(flipPrice.value ? __props.sourceName : __props.targetName), 1)
              ])
            ])) : createCommentVNode("", true),
            !isZero(aggBonus.value) ? (openBlock(), createElementBlock("div", _hoisted_66, [
              createBaseVNode("span", _hoisted_67, toDisplayString(unref(t)("wallet.swap.create.info.aggbonus")), 1),
              createBaseVNode("div", _hoisted_68, [
                ...
                createBaseVNode("span", _hoisted_69, toDisplayString(__props.targetName), 1)
              ])
            ])) : createCommentVNode("", true),
            ...
            createBaseVNode("div", _hoisted_70, [
              createBaseVNode("span", _hoisted_71, toDisplayString(unref(t)("wallet.swap.create.input.from.title")), 1),
              createBaseVNode("div", _hoisted_72, [
                ...
                createBaseVNode("span", _hoisted_73, toDisplayString(__props.sourceName), 1)
              ])
            ]),
            createBaseVNode("div", _hoisted_74, [
              createBaseVNode("span", _hoisted_75, "+ " + toDisplayString(unref(t)("wallet.swap.create.info.batcherfee")), 1),
            ...
            !isZero(__props.eternlFee) ? (openBlock(), createElementBlock("div", _hoisted_77, [
              createBaseVNode("span", _hoisted_78, "+ " + toDisplayString(unref(t)("wallet.swap.create.info.frontend")), 1),
            ...
            createBaseVNode("div", _hoisted_80, [
              createBaseVNode("span", _hoisted_81, "+ " + toDisplayString(unref(t)("wallet.swap.create.info.deposit")), 1),
              createVNode(_sfc_main$f, {
                "hide-fraction-if-zero": "",
                "is-whole-number": "",
...
const _hoisted_9$2 = /* @__PURE__ */ createBaseVNode("span", { class: "cc-text-md cc-text-semi-bold" }, "%", -1);
const _hoisted_10$2 = {
  key: 0,
...
const _hoisted_12$2 = { class: "flex flex-row flex-nowrap gap-4" };
const _hoisted_13$2 = { class: "xs:w-2/5 flex flex-col flex-nowrap cc-gap" };
const _hoisted_14$1 = ["selected", "value"];
const _hoisted_15$1 = { class: "xs:w-3/5 flex flex-col flex-nowrap gap-1" };
const _hoisted_16$1 = { class: "flex flex-row flex-nowrap" };
const _hoisted_17$1 = {
  key: 0,
  class: "my-2 col-span-12 cc-flex cc-area-highlight align-middle cc-p cc-text-medium"
};
const _hoisted_18$1 = { class: "flex flex-row cc-gap" };
const _hoisted_19$1 = ["onClick"];
const _hoisted_20$1 = { class: "cc-text-sz" };
const _hoisted_21$1 = { class: "grid grid-cols-12 cc-gap w-full p-2" };
const _hoisted_22$1 = /* @__PURE__ */ createBaseVNode("i", { class: "text-xl hover:cc-text-blue-light mdi mdi-tune" }, null, -1);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function onToggleProvider(providerId) {
      ...
      if (index === -1) {
        if (_blacklist.value.length === providerList.length - 1) {
          $q.notify({
          ...
          content: withCtx(() => [
            createBaseVNode("div", _hoisted_3$3, [
              createBaseVNode("div", _hoisted_4$3, [
                ...
                slippageShowWarning.value ? (openBlock(), createElementBlock("div", _hoisted_10$2, [
                ...
                __props.limitOrder ? (openBlock(), createElementBlock("div", _hoisted_11$2, [
                  createVNode(IconWarning, { class: "w-7 flex-none mr-2" }),
                  createVNode(_sfc_main$c, {
              ...
              createBaseVNode("div", _hoisted_12$2, [
                createBaseVNode("div", _hoisted_13$2, [
                  ...
                  createBaseVNode("select", {
                    ...
                    (openBlock(), createElementBlock(Fragment, null, renderList(aggregatorList, (aggregator, index) => {
                      ...
                      }, toDisplayString(!aggregator ? "Automatic Selection" : aggregator), 9, _hoisted_14$1);
                    }), 64))
                  ], 32)
                ]),
                createBaseVNode("div", _hoisted_15$1, [
                  createBaseVNode("div", null, [
                    ...
                    showProviderInfo.value ? (openBlock(), createElementBlock("div", _hoisted_17$1, [
                      createVNode(_sfc_main$c, {
                  ...
                  createBaseVNode("div", _hoisted_18$1, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(providerList), (provider) => {
                      return openBlock(), createElementBlock("div", {
                        key: provider.id
                      }, [
                        createBaseVNode("div", {
                          ...
                          createBaseVNode("span", _hoisted_20$1, toDisplayString(provider.name), 1)
                        ], 10, _hoisted_19$1)
                      ]);
                    }), 128))
                  ])
    ...
    async function onPairSelected() {
      ...
      if (!settings.value.aggregator || settings.value.aggregator === "MuesliSwap") {
        muesliPools.value = (await fetchSwapPools(networkId.value, selectedSource.value, selectedTarget.value)).filter((p) => {
          var _a3;
          return ((_a3 = swapProviderList.value) == null ? void 0 : _a3.includes(p.provider)) && !settings.value.blacklist.includes(getProvider(p.provider).id);
        });
        if (limitEnabled.value) {
        ...
        !unref(isCreateSwapEnabled)(unref(networkId)) ? (openBlock(), createBlock(_sfc_main$i, {
          ...
          createBaseVNode("div", _hoisted_3$2, [
            createBaseVNode("div", _hoisted_4$2, [
              ...
              }, null, 8, ["agg-list", "limit-order", "settings"])
            ]),
            ...
            }, null, 8, ["selected-source", "selected-target", "source-metadata", "target-metadata", "source-name", "target-name", "eternl-fee", "slippage", "is-limit-order", "swap-info", "calculating"])) : calculating.value ? (openBlock(), createElementBlock("div", _hoisted_10$1, [
              createVNode(_sfc_main$c, {
                text: unref(t)("wallet.swap.create.estimate")
              }, null, 8, ["text"]),
              createVNode(QSpinnerDots_default, {
...
const CreateSwap = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-2cae05be"]]);
const _hoisted_1$3 = {
  key: 0,
...
const _hoisted_13 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-1" }, "/", -1);
const _hoisted_14 = { class: "" };
const _hoisted_15 = {
  key: 1,
  class: "col-span-12 flex flex-col flex-nowrap"
};
const _hoisted_16 = { class: "flex flex-row flex-nowrap justify-between space-x-4" };
const _hoisted_17 = { class: "whitespace-nowrap" };
const _hoisted_18 = {
  key: 0,
  class: "relative flex flex-row flex-nowrap items-start"
};
const _hoisted_19 = { class: "ml-1" };
const _hoisted_20 = /* @__PURE__ */ createBaseVNode("span", { class: "mx-1" }, "/", -1);
const _hoisted_21 = { class: "" };
const _hoisted_22 = { class: "whitespace-nowrap cc-text-xs-dense cc-text-color-caption" };
const _hoisted_23 = { class: "col-span-12 flex flex-row flex-nowrap justify-between space-x-4" };
const _hoisted_24 = { class: "whitespace-nowrap" };
const _hoisted_25 = { class: "w-1/2 flex flex-row flex-nowrap" };
const _hoisted_26 = { class: "col-span-12 flex justify-end" };
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const provider = computed(() => {
      return getProvider(props.order.provider ?? props.order.dex);
    });
    ...
    const utxo = computed(() => {
      ...
      if (props.order.hasOwnProperty("utxo")) {
        ...
        txIndex2 = props.order.utxo.slice(65);
      } else if (props.order.hasOwnProperty("tx_hash")) {
        txHash = props.order.tx_hash;
        txIndex2 = ((_a = props.order.tx_output_index) == null ? void 0 : _a.toString()) ?? "0";
      }
      return { txHash, txIndex: txIndex2, utxo: `${txHash}#${txIndex2}` };
    });
      ...
      if (pools.length === 0 && ((_b = props.aggList) == null ? void 0 : _b.includes("DexHunter"))) {
        ...
        if (lpInfo) {
          for (const pool of lpInfo.pools) {
            if (getProvider(pool.dexName) !== provider.value) {
              continue;
            }
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_9, [
          ...
          !isZero(orderPrice.value) ? (openBlock(), createElementBlock("div", _hoisted_11, [
            ...
            _hoisted_13,
            createBaseVNode("span", _hoisted_14, toDisplayString(flipPrice.value ? sourceName.value : targetName.value), 1)
          ])) : (openBlock(), createBlock(QSpinnerDots_default, {
            key: 1,
            color: "gray"
          }))
        ]),
        marketPrice.value ? (openBlock(), createElementBlock("div", _hoisted_15, [
          createBaseVNode("div", _hoisted_16, [
            createBaseVNode("div", _hoisted_17, toDisplayString(unref(t)("wallet.swap.orders.label.marketprice")), 1),
            marketPrice.value ? (openBlock(), createElementBlock("div", _hoisted_18, [
              createVNode(_sfc_main$f, {
                isWholeNumber: "",
                hideFractionIfZero: "",
              ...
              createBaseVNode("span", _hoisted_19, toDisplayString(flipPrice.value ? targetName.value : sourceName.value), 1),
              _hoisted_20,
              createBaseVNode("span", _hoisted_21, toDisplayString(flipPrice.value ? sourceName.value : targetName.value), 1)
            ])) : createCommentVNode("", true)
          ]),
          createBaseVNode("div", _hoisted_22, toDisplayString(unref(t)("wallet.swap.orders.label.marketpriceinfo")), 1)
        ])) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_23, [
          createBaseVNode("span", _hoisted_24, toDisplayString(unref(t)("wallet.swap.orders.label.transaction")), 1),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        }, null, 8, ["agg-list", "open-order-list", "class"]))
      ], 64);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const aggList = ref(null);
    onMounted(async () => {
      aggList.value = await fetchEnabledAggList(networkId.value, selectedAccountId.value);
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        aggList.value && aggList.value.length === 0 ? (openBlock(), createBlock(_sfc_main$i, {
          ...
          createBaseVNode("div", _hoisted_3, [
            createVNode(CreateSwap, { "agg-list": aggList.value }, null, 8, ["agg-list"])
          ]),
          createBaseVNode("div", _hoisted_4, [
            createVNode(_sfc_main$1, { "agg-list": aggList.value }, null, 8, ["agg-list"])
          ])
        ])) : createCommentVNode("", true)
      ]);
    };
