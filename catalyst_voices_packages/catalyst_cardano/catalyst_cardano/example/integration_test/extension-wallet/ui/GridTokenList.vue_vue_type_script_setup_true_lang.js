import { d as defineComponent, o as openBlock, a as createBlock, eS as decodeHex, N as api, eL as el, c8 as json, z as ref, a4 as now, K as networkId, q as createVNode, h as withCtx, c as createElementBlock, e as createBaseVNode, b as withModifiers, n as normalizeClass, j as createCommentVNode, aC as renderSlot, ad as withKeys, eH as Transition, iM as Teleport, j_ as MediaType, C as onMounted, t as toDisplayString, jR as parseMetaSrcFile, f as computed, u as unref, i as createTextVNode, H as Fragment, I as renderList, jI as QSpinnerTail_default, L as pushScopeId, M as popScopeId, a9 as useQuasar, aY as addSignalListener, aZ as removeSignalListener, j$ as onBuiltTxCleanUpScam, ga as getTxBuiltErrorMsg, g5 as ErrorBuildTx, bn as dispatchSignal, k0 as doBuildTxCleanUpScam, cw as getRandomId, U as reactive, A as useCurrencyAPI, a1 as isBexApp, D as watch, ag as useSelectedAccount, aK as useGuard, B as useFormatter, cX as divide, f7 as multiply, k1 as fetchAssetCDNImage, k2 as MediaSize, fC as getImageB64, k3 as fetchIPFS, jO as fetchAssetMetadata, jP as get721MetadataDetails, jQ as get1155Metadata, Q as QSpinnerDots_default, at as appLanguageTag, k4 as getAssetStatus, hv as formatAssetName, cn as getAssetIdBech32, f0 as compare, X as nextTick, hz as getAssetInfo, hA as getSwapAssetInfo, k5 as updateSwapAssetInfoMap, k6 as updateSwapAssetInfoMap$1, fB as getAssetCDN, aJ as QPagination_default, k7 as accAssetInfoCnt, k8 as getAdvancedTokenView, k9 as setAdvancedTokenView, ka as getSortedAssetList, cs as QToggle_default, cV as subtract, cl as isLessThanZero, cZ as isGreaterThanZero, co as accAssetInfoMap, kb as swapAssetInfoMap, kc as isScamAsset } from "./index.js";
...
const _hoisted_6$7 = { class: "w-20 h-20" };
const _hoisted_7$6 = /* @__PURE__ */ createBaseVNode("circle", {
  class: "",
  "stroke-width": "4",
  stroke: "currentColor",
  fill: "transparent",
...
const _hoisted_8$6 = ["stroke-dasharray", "stroke-dashoffset"];
const _hoisted_9$5 = { class: "absolute opacity-90" };
...
const _hoisted_13$3 = ["src", "type"];
const _hoisted_14$3 = {
  key: 5,
  class: "w-full h-full object-contain",
  controls: ""
};
const _hoisted_15$2 = ["src", "type"];
const _hoisted_16$2 = {
  key: 6,
  class: "w-full h-full object-contain"
};
      ...
      return openBlock(), createBlock(BaseModal, {
        ...
        content: withCtx(() => {
          ...
          return [
              ...
              createBaseVNode("div", null, [
                createBaseVNode("div", _hoisted_4$7, [
                  createBaseVNode("div", _hoisted_5$7, [
                    (openBlock(), createElementBlock("svg", _hoisted_6$7, [
                      _hoisted_7$6,
                    ...
                    createBaseVNode("span", _hoisted_9$5, toDisplayString(percent.value) + "%", 1)
                  ])
                ])
              ])
            ])) : createCommentVNode("", true),
            ...
            isVideo && isLoaded.value ? (openBlock(), createElementBlock("video", _hoisted_12$3, [
              createBaseVNode("source", {
                src: mediaSrc.value,
                type: (_a = __props.onChainFile) == null ? void 0 : _a.mediaType
              }, null, 8, _hoisted_13$3)
            ])) : createCommentVNode("", true),
            isAudio && isLoaded.value ? (openBlock(), createElementBlock("audio", _hoisted_14$3, [
              createBaseVNode("source", {
                src: mediaSrc.value,
                type: (_b = __props.onChainFile) == null ? void 0 : _b.mediaType
              }, null, 8, _hoisted_15$2)
            ])) : createCommentVNode("", true),
            isPDF && isLoaded.value ? (openBlock(), createElementBlock("object", _hoisted_16$2, [
...
const _hoisted_6$6 = /* @__PURE__ */ createBaseVNode("hr", null, null, -1);
const _hoisted_7$5 = { class: "flex flex-col" };
const _hoisted_8$5 = { class: "flex row" };
const _hoisted_9$4 = {
  key: 0,
  class: "flex row"
};
...
const _hoisted_12$2 = { class: "flex row" };
const _hoisted_13$2 = /* @__PURE__ */ createBaseVNode("hr", null, null, -1);
const _hoisted_14$2 = {
  key: 1,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
                ...
                createBaseVNode("div", null, [
                  ...
                  _floorPrice.value.marketplaceCount > 1 ? (openBlock(), createElementBlock("div", _hoisted_5$6, [
                    ...
                    createBaseVNode("div", _hoisted_7$5, [
                      ...
                      ((_a = _floorPrice.value.minFloorPrice) == null ? void 0 : _a.lovelacePrice) ? (openBlock(), createElementBlock("span", _hoisted_9$4, [
                      ...
                      ((_b = _floorPrice.value.maxFloorPrice) == null ? void 0 : _b.lovelacePrice) ? (openBlock(), createElementBlock("span", _hoisted_10$3, [
                    ...
                    _floorPrice.value.marketplaceCount > 2 ? (openBlock(), createElementBlock("hr", _hoisted_11$3)) : createCommentVNode("", true),
        ...
        isLoading.value ? (openBlock(), createElementBlock("div", _hoisted_14$2, [
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-c6a160a0"), n = n(), popScopeId(), n);
const _hoisted_1$5 = {
  key: 0,
...
const _hoisted_6$5 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-open-in-new mx-1" }, null, -1));
const _hoisted_7$4 = { class: "cc-table-cell cc-text-semi-bold" };
const _hoisted_8$4 = ["href"];
const _hoisted_9$3 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-open-in-new mx-1" }, null, -1));
...
const _hoisted_4$4 = { class: "text-center whitespace-pre-wrap cc-text-extra-bold cc-text-red-light" };
const _hoisted_5$4 = ["innerHTML"];
const _hoisted_6$4 = { class: "grow-0 shrink-0 w-64 flex flex-col flex-nowrap justify-center items-center" };
    ...
    return (_ctx, _cache) => {
      return __props.isScam ? (openBlock(), createElementBlock("div", _hoisted_1$4, [
        createBaseVNode("div", _hoisted_2$4, [
          _hoisted_3$4,
          createBaseVNode("div", _hoisted_4$4, toDisplayString(unref(it)("common.scam.guard.warning")), 1)
        ]),
        createBaseVNode("div", {
...
const _withScopeId = (n) => (pushScopeId("data-v-b2f9f962"), n = n(), popScopeId(), n);
...
const _hoisted_8$3 = { class: "font-extrabold drop-shadow-black cc-text cc-badge-bg-red rounded-borders text-center w-2/3 p-2" };
...
const _hoisted_29$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "w-full border-b" }, null, -1));
const _hoisted_30$1 = [
  _hoisted_29$1
];
const _hoisted_31$1 = { class: "w-full max-w-full mb-4 text-left" };
const _hoisted_32$1 = { key: 0 };
const _hoisted_33$1 = { class: "cc-table-cell-left whitespace-nowrap" };
const _hoisted_34 = { class: "cc-table-cell cc-text-semi-bold" };
const _hoisted_35 = { key: 1 };
const _hoisted_36 = { class: "cc-table-cell whitespace-nowrap" };
const _hoisted_37 = { class: "cc-table-cell cc-text-semi-bold" };
const _hoisted_38 = ["href"];
const _hoisted_39 = { class: "cc-table-cell whitespace-nowrap" };
const _hoisted_40 = { class: "cc-table-cell cc-text-semi-bold" };
const _hoisted_41 = { class: "flex flex-row flex-nowrap mt-0.5 items-center pt-0.5 cc-text-semi-bold" };
const _hoisted_42 = { class: "cc-table-cell whitespace-nowrap" };
const _hoisted_43 = { class: "cc-table-cell cc-text-semi-bold" };
const _hoisted_44 = { class: "cc-table-cell whitespace-nowrap" };
const _hoisted_45 = { class: "cc-table-cell cc-text-semi-bold" };
const _hoisted_46 = {
  key: 1,
  class: "col-span-12 my-1"
};
const _hoisted_47 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "w-full border-b" }, null, -1));
const _hoisted_48 = [
  _hoisted_47
];
const _hoisted_49 = { class: "w-full mb-4 text-left" };
...
const _hoisted_53 = { class: "cc-table-cell" };
const _hoisted_54 = { class: "cc-table-cell break-all max-h-24 overflow-y-auto block cc-text-semi-bold" };
const _hoisted_55 = {
  key: 3,
  class: "col-span-12 my-1"
};
const _hoisted_56 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "w-full border-b" }, null, -1));
const _hoisted_57 = [
  _hoisted_56
];
const _hoisted_58 = { class: "w-full px-2 whitespace-pre-wrap overflow-auto" };
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function getMediaButtonLabel(file) {
      var _a, _b, _c, _d;
      ...
      return selectText.replace("####FORMAT####", labelType);
    }
      ...
      if (files.length > 0) {
        ...
        if (item && item.src && item.mediaType) {
          ...
          if (item.mediaType === "text/html") {
            ...
            showOnChainFileModal.value = true;
          } else if (item.mediaType === "image/png" || item.mediaType === "image/jpg" || item.mediaType === "image/jpeg" || item.mediaType === "image/gif") {
    ...
    onMounted(async () => {
      ...
      isScam.value = (await isAssetOnBlockList(props.fingerprint)).length > 0;
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(Modal, {
              ...
              createBaseVNode("div", _hoisted_3$3, [
                createBaseVNode("div", _hoisted_4$3, [
                  imageSource.value || loading.value ? (openBlock(), createElementBlock("div", _hoisted_5$3, [
                    ...
                    isScam.value ? (openBlock(), createElementBlock("div", _hoisted_7$3, [
                      createBaseVNode("div", _hoisted_8$3, toDisplayString(unref(t)("common.scam.token.image")), 1)
                    ])) : createCommentVNode("", true),
                ...
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_26$1, [
                    ...
                    !__props.isNFT ? (openBlock(), createElementBlock("div", _hoisted_28$1, _hoisted_30$1)) : createCommentVNode("", true),
                    createVNode(_sfc_main$b, {
                      label: unref(t)("wallet.summary.token.modal.blockchainData"),
                      class: "cc-table-cell"
                    }, null, 8, ["label"]),
                    createBaseVNode("table", _hoisted_31$1, [
                      ((_c = __props.assetInfo.tr) == null ? void 0 : _c.ds) ? (openBlock(), createElementBlock("tr", _hoisted_32$1, [
                        createBaseVNode("th", _hoisted_33$1, toDisplayString(unref(t)("wallet.summary.token.modal.description")), 1),
                        createBaseVNode("th", _hoisted_34, toDisplayString((_d = __props.assetInfo.tr) == null ? void 0 : _d.ds), 1)
                      ])) : createCommentVNode("", true),
                      ((_f = (_e = __props.assetInfo) == null ? void 0 : _e.tr) == null ? void 0 : _f.u) && !((_g = __props.assetInfo.tr) == null ? void 0 : _g.u.includes("ipfs")) ? (openBlock(), createElementBlock("tr", _hoisted_35, [
                        createBaseVNode("th", _hoisted_36, toDisplayString(unref(t)("wallet.summary.token.modal.website")), 1),
                        createBaseVNode("th", _hoisted_37, [
                          createBaseVNode("a", {
                            href: (_i = (_h = __props.assetInfo) == null ? void 0 : _h.tr) == null ? void 0 : _i.u,
                            target: "_blank",
                            rel: "noopener noreferrer"
                          }, toDisplayString((_j = __props.assetInfo.tr) == null ? void 0 : _j.u), 9, _hoisted_38)
                        ])
                      ])) : createCommentVNode("", true),
                      createBaseVNode("tr", null, [
                        createBaseVNode("th", _hoisted_39, toDisplayString(unref(t)("wallet.summary.token.fingerprint")), 1),
                        createBaseVNode("th", _hoisted_40, [
                      ...
                      createBaseVNode("tr", null, [
                        createBaseVNode("th", _hoisted_42, toDisplayString(unref(t)("wallet.summary.token.policyId")), 1),
                      ...
                      createBaseVNode("tr", null, [
                        createBaseVNode("th", _hoisted_44, toDisplayString(unref(t)("wallet.summary.token.assetName")), 1),
                        createBaseVNode("th", _hoisted_45, [
                          createVNode(_sfc_main$g, {
                    ...
                    showMetaEntries.value ? (openBlock(), createElementBlock("div", _hoisted_46, _hoisted_48)) : createCommentVNode("", true),
                    ...
                    createBaseVNode("table", _hoisted_49, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(metaEntries.value, (entry, index) => {
                        return openBlock(), createElementBlock(Fragment, { key: index }, [
                          entry.isHeader ? (openBlock(), createElementBlock("tr", _hoisted_50, [
                            createBaseVNode("th", _hoisted_51, [
                              createBaseVNode("u", null, toDisplayString(entry.key), 1)
                            ])
                          ])) : (openBlock(), createElementBlock("tr", _hoisted_52, [
                            createBaseVNode("th", _hoisted_53, toDisplayString(entry.key), 1),
                            createBaseVNode("th", _hoisted_54, toDisplayString(entry.value), 1)
                          ]))
                        ], 64);
                      }), 128))
                    ]),
                    showMetaEntries.value ? (openBlock(), createElementBlock("div", _hoisted_55, _hoisted_57)) : createCommentVNode("", true),
                    showMetaEntries.value ? (openBlock(), createBlock(_sfc_main$b, {
                      key: 4,
          ...
          footer: withCtx(() => {
            ...
            return [
              ...
              showOpenOnChainFile.value && multipleFiles.value ? (openBlock(), createElementBlock("div", _hoisted_60, [
                ...
                ((_e = meta721.value) == null ? void 0 : _e.files) ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(meta721.value.files, (file, index) => {
                  return openBlock(), createBlock(_sfc_main$i, {
                    key: index,
                    class: "p-1 m-2 initial flex-1 w-1/4",
                    label: getMediaButtonLabel(file),
...
const GridTokenDetailsModal = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b2f9f962"]]);
...
const _hoisted_8$2 = { class: "relative w-full flex-shrink item-text flex flex-row flex-nowrap overflow-hidden max-w-full" };
...
const _hoisted_32 = /* @__PURE__ */ createBaseVNode("i", { class: "text-lg cc-text-yellow mdi mdi-alert-circle-outline" }, null, -1);
const _hoisted_33 = {
  key: 1,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        ])) : __props.simpleSelect ? (openBlock(), createElementBlock("div", _hoisted_33, [
          createBaseVNode("div", {
...
const _hoisted_4$1 = /* @__PURE__ */ createBaseVNode("div", { class: "cc-text-semi-bold pr-2" }, "Policy:", -1);
const _hoisted_5$1 = {
...
const _hoisted_7$1 = { class: "relative cc-shadow cc-rounded py-2 px-4" };
const _hoisted_8$1 = {
  key: 1,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        showPagination.value && showFullCollection.value ? (openBlock(), createElementBlock("div", _hoisted_6$1, [
        ...
        __props.tokenCollection.l.length > 3 ? (openBlock(), createElementBlock("div", _hoisted_8$1, [
