import { di as getApiURL, d as defineComponent, f as computed, dj as getIDAppConnectEntry, u as unref, o as openBlock, c as createElementBlock, b as withModifiers, j as createCommentVNode, t as toDisplayString, n as normalizeClass, e as createBaseVNode, z as ref, D as watch, r as resolveComponent, q as createVNode, h as withCtx, H as Fragment, U as reactive, C as onMounted, w as watchEffect, X as nextTick, a as createBlock, a0 as isStagingApp, I as renderList, bf as useWalletAccount, dk as getWalletNameList, k as dispatchSignalSync, dl as doToggleDappAccountId, a9 as useQuasar, cH as onErrorCaptured, aI as onUnmounted, i as createTextVNode, Q as QSpinnerDots_default, bl as QSpinner_default, ab as timestampLocal, K as networkId } from "./index.js";
import { u as useDappAccount } from "./useDappAccount.js";
import { f as favorites, d as delDappBrowserFavorite, a as addDappBrowserFavorite, u as useDAppBrowserEvents, e as entryList, D as DAppEntryEvent, _ as _sfc_main$a } from "./DAppIframe.vue_vue_type_script_setup_true_lang.js";
import { u as useTranslation } from "./useTranslation.js";
import { _ as _sfc_main$g } from "./Page.vue_vue_type_script_setup_true_lang.js";
import { _ as _sfc_main$d, a as _sfc_main$e } from "./WalletIcon.vue_vue_type_script_setup_true_lang.js";
import { _ as _sfc_main$f } from "./GridTabs.vue_vue_type_script_setup_true_lang.js";
import { _ as _sfc_main$9, a as _sfc_main$b } from "./GridHeadline.vue_vue_type_script_setup_true_lang.js";
import { G as GridSpace } from "./GridSpace.js";
import { _ as _sfc_main$8 } from "./GridTextArea.vue_vue_type_script_setup_true_lang.js";
...
import { C as CommonAPI } from "./QrcodeStream.js";
import { p as processFile } from "./scanner.js";
import { u as useUiSelectedAccount } from "./uiSelectedAccount.js";
import { _ as _sfc_main$c } from "./DAppsAccountItem.vue_vue_type_script_setup_true_lang.js";
...
const _hoisted_3$4 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-trash-can-outline text-gray-400 drop-shadow text-xl" }, null, -1);
const _hoisted_4$2 = [
  _hoisted_3$4
];
const _hoisted_5$1 = {
...
const _hoisted_6$1 = /* @__PURE__ */ createBaseVNode("div", { class: "relative mt-0.5 ml-0.5 w-3 h-3 cc-bg-green drop-shadow rounded-sm" }, null, -1);
const _hoisted_7$1 = [
  _hoisted_6$1
];
const _hoisted_8$1 = {
...
const _hoisted_9$1 = /* @__PURE__ */ createBaseVNode("div", { class: "relative mt-1 ml-1 w-2 h-2 bg-gray-400 drop-shadow rounded-sm" }, null, -1);
const _hoisted_10$1 = [
  _hoisted_9$1
];
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return unref(entry) && (__props.onlyFavs ? isFav.value : true) ? (openBlock(), createElementBlock("div", {
        ...
        !__props.isFeatured || !imageURL() ? (openBlock(), createElementBlock("div", _hoisted_2$4, toDisplayString((_a = unref(entry)) == null ? void 0 : _a.label), 1)) : createCommentVNode("", true),
        ...
        }, _hoisted_4$2, 2)) : createCommentVNode("", true),
        createBaseVNode("button", {
          ...
          __props.dappConnect.isConnected ? (openBlock(), createElementBlock("div", _hoisted_5$1, _hoisted_7$1)) : (openBlock(), createElementBlock("div", _hoisted_8$1, _hoisted_10$1))
        ], 2)
  ...
  setup(__props, { emit: __emit }) {
    ...
    function actuallyUpdateList() {
      ...
      for (const entry of featuredList) {
        for (const cat of entry.categories) {
          ...
          if (props.onlyFavs && !favorites.value.includes(entry.id))
            continue;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        !(unref(walletData) && unref(accountData)) ? (openBlock(), createBlock(_sfc_main$8, {
          key: 0,
        ...
        }, null, 8, ["label", "text", "icon"])) : unref(isStagingApp)() ? (openBlock(), createBlock(_sfc_main$8, {
          key: 1,
        ...
        createVNode(_sfc_main$9, { label: __props.title }, null, 8, ["label"]),
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(categories, (category) => {
          return openBlock(), createElementBlock("div", {
            ...
            category.list.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
              ...
              __props.showCategory ? (openBlock(), createBlock(_sfc_main$9, {
                key: 1,
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        unref(appWallet) && unref(appWallet).isReadOnly ? (openBlock(), createBlock(_sfc_main$8, {
          key: 1,
...
const _hoisted_11 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-sync" }, null, -1);
...
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("div", { class: "cc-none xxxs:block grow w-px" }, null, -1);
const _hoisted_26 = {
  key: 0,
  class: "relative h-full flex-1 flex flex-col flex-nowrap justify-center items-end cc-text-semi-bold"
};
const _hoisted_27 = { class: "mb-0.5 flex flex-row" };
const _hoisted_28 = {
  key: 0,
  class: "h-0 mr-1"
};
...
const _hoisted_31 = /* @__PURE__ */ createBaseVNode("div", { class: "relative mr-2 block h-8 sm:h-10 w-8 sm:w-10 border-gray-300 dark:border-gray-600 border cc-rounded" }, null, -1);
...
const _hoisted_35 = /* @__PURE__ */ createBaseVNode("div", { class: "relative mr-2 block h-8 sm:h-10 w-8 sm:w-10 border-gray-300 dark:border-gray-600 border cc-rounded" }, null, -1);
const _hoisted_36 = { class: "relative h-full flex-1 flex flex-col flex-nowrap justify-center items-center cc-text-semi-bold" };
const _hoisted_37 = { class: "mb-0.5" };
const _hoisted_38 = { class: "cc-page-wallet cc-text-sz dark:text-cc-gray mb-12" };
const _hoisted_39 = { class: "flex cc-bg-light-1 bottom-8 w-full align-middle justify-center text-center sm:hidden" };
const _hoisted_40 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-star text-2xl" }, null, -1);
const _hoisted_41 = /* @__PURE__ */ createBaseVNode("p", null, "Favorites", -1);
const _hoisted_42 = [
  _hoisted_40,
  _hoisted_41
];
const _hoisted_43 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-application text-2xl" }, null, -1);
const _hoisted_44 = /* @__PURE__ */ createBaseVNode("p", null, "DApps", -1);
const _hoisted_45 = [
  _hoisted_43,
  _hoisted_44
];
const _hoisted_46 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-cloud-print text-2xl" }, null, -1);
const _hoisted_47 = /* @__PURE__ */ createBaseVNode("p", null, "Mint", -1);
const _hoisted_48 = [
  _hoisted_46,
  _hoisted_47
];
const _hoisted_49 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-connection text-2xl" }, null, -1);
const _hoisted_50 = /* @__PURE__ */ createBaseVNode("p", null, "Account", -1);
const _hoisted_51 = [
  _hoisted_49,
  _hoisted_50
];
          ...
          createVNode(_sfc_main$g, {
            ...
            header: withCtx(() => [
              createBaseVNode("div", _hoisted_3, [
                unref(walletName) ? (openBlock(), createElementBlock("div", _hoisted_4, [
                  createBaseVNode("div", {
                    ...
                    unref(dappWallet) ? (openBlock(), createElementBlock("div", _hoisted_6, [
                      ...
                      unref(walletBalance) ? (openBlock(), createBlock(_sfc_main$e, {
                        key: 0,
                      ...
                      unref(dappAccount) ? (openBlock(), createElementBlock("span", _hoisted_10, [
                        ...
                        unref(isManualSyncEnabled) ? (openBlock(), createElementBlock("span", _hoisted_12, [
                          createTextVNode("Manual, "),
                          unref(dappAccount).syncInfo.isInitializing && unref(isAccountSyncing) ? (openBlock(), createElementBlock("span", _hoisted_13, " preparing for")) : unref(isAccountSyncing) ? (openBlock(), createElementBlock("span", _hoisted_14, " syncing for")) : !(lastSync1.value || lastSync2.value) && unref(isManualSyncEnabled) ? (openBlock(), createElementBlock("span", _hoisted_15, " not synced yet")) : (openBlock(), createElementBlock("span", _hoisted_16, " synced"))
                        ])) : unref(dappAccount).syncInfo.isInitializing ? (openBlock(), createElementBlock("span", _hoisted_17, "Initializing")) : unref(isAccountSyncing) ? (openBlock(), createElementBlock("span", _hoisted_18, "Syncing for")) : (openBlock(), createElementBlock("span", _hoisted_19, "Synced")),
                        lastSync1.value ? (openBlock(), createElementBlock("span", _hoisted_20, " ")) : createCommentVNode("", true),
                        lastSync1.value ? (openBlock(), createElementBlock("span", _hoisted_21, toDisplayString(lastSync1.value), 1)) : createCommentVNode("", true),
                        lastSync2.value ? (openBlock(), createElementBlock("span", _hoisted_22, " ")) : createCommentVNode("", true),
                        lastSync2.value ? (openBlock(), createElementBlock("span", _hoisted_23, toDisplayString(lastSync2.value), 1)) : createCommentVNode("", true),
                        (lastSync1.value || lastSync2.value) && !unref(isAccountSyncing) ? (openBlock(), createElementBlock("span", _hoisted_24, " ago")) : createCommentVNode("", true)
                      ])) : createCommentVNode("", true)
                    ])) : createCommentVNode("", true)
                  ]),
                  _hoisted_25,
                  createBaseVNode("div", {
                    ...
                    unref(dappAccount) ? (openBlock(), createElementBlock("div", _hoisted_26, [
                      createBaseVNode("div", _hoisted_27, [
                        unref(isAccountSyncing) ? (openBlock(), createElementBlock("div", _hoisted_28, [
                          createVNode(QSpinnerDots_default, {
                            color: "gray",
                            size: "1rem"
                          })
                        ])) : createCommentVNode("", true),
                        unref(dappAccount).isDappAccount ? (openBlock(), createElementBlock("i", _hoisted_29)) : createCommentVNode("", true),
                        createTextVNode(" " + toDisplayString(unref(accountName)), 1)
                      ]),
                      unref(accountBalance) ? (openBlock(), createBlock(_sfc_main$e, {
                        key: 0,
                ...
                ])) : isLoading.value ? (openBlock(), createElementBlock("div", _hoisted_30, [
                  createBaseVNode("div", {
