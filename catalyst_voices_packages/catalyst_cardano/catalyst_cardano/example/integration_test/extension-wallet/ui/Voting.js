...
import { gL as endPoints, N as api, d as defineComponent, cH as onErrorCaptured, o as openBlock, c as createElementBlock, e as createBaseVNode, t as toDisplayString, j as createCommentVNode, q as createVNode, h as withCtx, i as createTextVNode, u as unref, z as ref, f as computed, H as Fragment, I as renderList, a as createBlock, aJ as QPagination_default, n as normalizeClass, C as onMounted, D as watch, X as nextTick, gM as isSameArray, aC as renderSlot, B as useFormatter, U as reactive, a9 as useQuasar, K as networkId, gN as getResultsDate, gO as isValidDate, a4 as now, aY as addSignalListener, gP as onTxSubmitted, aI as onUnmounted, aZ as removeSignalListener, b as withModifiers, a2 as isMobileApp, c2 as isIosApp, c6 as isAndroidApp, cw as getRandomId, ag as useSelectedAccount, gQ as generateCatalystKey, ga as getTxBuiltErrorMsg, g5 as ErrorBuildTx, gR as onBuiltTxVoteReg, bn as dispatchSignal, gS as doBuildTxVoteReg, ez as getRequestData, eA as ApiRequestType, eB as ErrorSync, eC as DEFAULT_ACCOUNT_ID, bS as getDRepAddressFromKeyhash, ck as isZero, f7 as multiply, cX as divide, gT as getCCColdAddressFromKeyhash, gU as getCCHotAddressFromKeyhash, gV as onEpochParamsUpdated, a_ as checkEpochParams, gW as getIAppAccountById, bL as getAddressCredentials, gX as onBuiltTxVoteDelegation, gY as doBuildTxVoteDelegation, aT as onNetworkFeaturesUpdated } from "./index.js";
...
import { _ as _sfc_main$l } from "./GridSteps.vue_vue_type_script_setup_true_lang.js";
...
import { _ as _sfc_main$n } from "./GridTxListUtxoListBadges.vue_vue_type_script_setup_true_lang.js";
import { _ as _sfc_main$o } from "./SendWalletList.vue_vue_type_script_setup_true_lang.js";
import { _ as _sfc_main$m } from "./CopyToClipboard.vue_vue_type_script_setup_true_lang.js";
import { M as Modal } from "./Modal.js";
import { _ as _sfc_main$p } from "./GridTabs.vue_vue_type_script_setup_true_lang.js";
...
const _hoisted_2$8 = { class: "relative w-full h-full" };
const _hoisted_3$8 = { class: "h-full flex flex-col items-stretch overflow-hidden cc-p" };
...
const _hoisted_10$2 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-web text-blue-500" }, null, -1);
const _hoisted_11$2 = [
  _hoisted_10$2
];
const _hoisted_12$1 = { class: "text-xs break-words" };
const _hoisted_13$1 = { class: "flex flex-grow items-end mt-2 text-xs" };
const _hoisted_14$1 = { class: "cc-text-semi-bold whitespace-nowrap mr-2" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$b, [
        createBaseVNode("div", _hoisted_2$8, [
          createBaseVNode("div", _hoisted_3$8, [
            ...
            createBaseVNode("div", _hoisted_12$1, toDisplayString(__props.challenge.description), 1),
            createBaseVNode("div", _hoisted_13$1, [
              createBaseVNode("span", _hoisted_14$1, toDisplayString(unref(t)("wallet.voting.catalyst.step.info.fund.challenges.allocation")), 1),
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function voteRegistration() {
      ...
      await dispatchSignal(doBuildTxVoteReg, catalystKey.value.privateKey);
      removeSignalListener(onBuiltTxVoteReg, storeId);
    }
    ...
    function votingPrerequisites() {
      ...
      if (((_a = accountData.value) == null ? void 0 : _a.account.signType) === "keystone") {
        votingPreReqError.value = t("wallet.voting.catalyst.error.keystone");
        return;
      }
      if (!catalystData.value) {
      ...
      const isRegistered = ((_b = rewardInfo.value) == null ? void 0 : _b.registered) ?? false;
      if (!isRegistered) {
...
const getGovDRepInfo = (networkId2, accountId, cred) => {
  if (!accountId) {
...
const _hoisted_1$1 = { class: "col-span-12" };
...
const _hoisted_14 = { class: "flex flex-row flex-nowrap items-center" };
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("div", { class: "ml-1 mr-0.5" }, "(", -1);
const _hoisted_16 = /* @__PURE__ */ createBaseVNode("div", { class: "ml-0.5" }, ")", -1);
const _hoisted_17 = { class: "cc-text-semi-bold" };
const _hoisted_18 = {
  key: 3,
  class: "col-span-12 grid grid-cols-12 cc-gap"
};
const _hoisted_19 = ["selected", "value"];
const _hoisted_20 = { class: "col-span-12" };
const _hoisted_21 = { class: "cc-text-semi-bold" };
const _hoisted_22 = { class: "cc-text-semi-bold" };
const _hoisted_23 = {
  key: 4,
  class: "col-span-12 max-w-fit cc-banner-gray cc-p mt-2"
};
const _hoisted_24 = { class: "flex flex-row flex-nowrap cc-gap items-center" };
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-information-outline text-xl sm:text-2xl" }, null, -1);
const _hoisted_26 = { class: "flex flex-col flex-nowrap cc-gap" };
const _hoisted_27 = { class: "flex flex-row flex-nowrap" };
const _hoisted_28 = { class: "cc-text-semi-bold" };
const _hoisted_29 = {
  key: 5,
  class: "col-span-12 grid grid-cols-12 cc-gap-lg"
};
const _hoisted_30 = { class: "col-span-12 cc-rounded cc-shadow cc-bg-light-0 cc-p" };
const _hoisted_31 = { class: "w-full flex flex-row flex-nowrap mt-0.5 items-start pt-0.5 text-xs cc-text-semi-bold cc-gap" };
const _hoisted_32 = { class: "break-all text-center cc-addr" };
const _hoisted_33 = { class: "col-span-12 cc-rounded cc-shadow cc-bg-light-0 cc-p" };
const _hoisted_34 = { class: "w-full flex flex-row flex-nowrap mt-0.5 items-start pt-0.5 text-xs cc-text-semi-bold cc-gap" };
const _hoisted_35 = { class: "break-all text-center cc-addr" };
const _hoisted_36 = { class: "col-span-12 cc-rounded cc-shadow cc-bg-light-0 cc-p" };
const _hoisted_37 = { class: "w-full flex flex-row flex-nowrap mt-0.5 items-start pt-0.5 text-xs cc-text-semi-bold cc-gap" };
const _hoisted_38 = { class: "break-all text-center cc-addr" };
const _hoisted_39 = { class: "grow-0 shrink-0 w-full flex flex-row flex-nowrap items-start justify-between border-b cc-p" };
const _hoisted_40 = { class: "flex flex-col cc-text-sz" };
const _hoisted_41 = { class: "p-1" };
const _hoisted_42 = { class: "grow-0 shrink-0 w-full flex flex-row flex-nowrap items-start justify-between border-b cc-p" };
const _hoisted_43 = { class: "flex flex-col cc-text-sz" };
const _hoisted_44 = { class: "p-1" };
const _hoisted_45 = { class: "grid grid-cols-12 cc-gap p-2 w-full" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const rewardInfo = accountSettings.rewardInfo;
    showDelegation.value = (((_a = rewardInfo.value) == null ? void 0 : _a.govDelegationList.length) ?? 0) === 0;
    ...
    updateEpochParams();
    const delegationDRepCred = computed(() => {
      var _a2, _b, _c;
      if ((((_a2 = rewardInfo.value) == null ? void 0 : _a2.govDelegationList) ?? []).length === 0) {
        return null;
      }
      return (_c = (_b = rewardInfo.value) == null ? void 0 : _b.govDelegationList) == null ? void 0 : _c.reduce((a, b) => {
        if (a.slot !== b.slot) {
    ...
    const delegationDRepAddr = computed(
      () => delegationDRepCred.value && delegationDRepCred.value.length === 56 ? getDRepAddressFromKeyhash(delegationDRepCred.value) : null
    );
    const delegationValue = computed(() => {
      if (!delegationDRepCred.value) {
        return t("wallet.voting.governance.delegation.current.undelegated");
      }
      switch (delegationDRepCred.value) {
        ...
        default:
          return delegationDRepAddr.value ?? delegationDRepCred.value;
      }
    });
    ...
    const delegationDRepVotePower = computed(() => {
      if (!delegationDRepInfo.value || isZero(delegationDRepInfo.value.totalStake)) {
        return null;
      }
      return multiply(divide(delegationDRepInfo.value.drepStake, delegationDRepInfo.value.totalStake), 100);
    });
    const delegationDRepUtxo = computed(() => {
      ...
      return {
        ...
        pc: delegationDRepCred.value,
        sc: ""
      };
    });
    const accDRepCred = computed(() => {
      var _a2;
      if (!((_a2 = accountData.value) == null ? void 0 : _a2.keys.drep) || accountData.value.keys.drep.length === 0) {
        return null;
      }
    ...
    const accDRepAddr = computed(() => {
      ...
      return getDRepAddressFromKeyhash(accDRepCred.value);
    });
    const ccColdAddr = computed(() => {
      var _a2;
      if (!((_a2 = accountData.value) == null ? void 0 : _a2.keys.cc_cold) || accountData.value.keys.cc_cold.length === 0) {
        return "-";
      }
    ...
    const ccHotAddr = computed(() => {
      var _a2;
      if (!((_a2 = accountData.value) == null ? void 0 : _a2.keys.cc_hot) || accountData.value.keys.cc_hot.length === 0) {
        return "-";
      }
      return getCCHotAddressFromKeyhash(accountData.value.keys.cc_hot[0].cred);
    });
    ...
    const validateCustomDRepId = (value) => {
      ...
      if (value && (!value.startsWith("drep") || value.length !== 58)) {
    ...
    const onDelegateToAccount = (info2) => {
      ...
      if (selectedAccountId.value !== info2.accountId) {
        ...
        customDRepID.value = getDRepAddressFromKeyhash(_drepCred);
        nextTick(() => voteDelegation());
      } else {
        showAnchorModal.value = true;
      }
    };
    const onVoteDelegation = () => {
    ...
    const voteDelegation = async () => {
      ...
      let drep = selectedDelegationDRep.value;
      let drepCred = "";
      let errorMsg = "";
      ...
      if (selectedDelegationDRep.value === "own") {
        ...
        try {
          const paymentCred = getAddressCredentials(customDRepID.value).paymentCred;
          if (!paymentCred) {
            errorMsg = t("wallet.voting.governance.delegation.new.error.invaliddrep");
          } else {
            drep = customDRepID.value;
            drepCred = paymentCred;
          }
        } catch (err) {
      ...
      if (errorMsg.length === 0 && drepCred.length > 0) {
        let drepInfo = null;
        try {
          drepInfo = await getGovDRepInfo(networkId.value, selectedAccountId.value, drepCred);
        } catch (e) {
        }
      ...
      await dispatchSignal(doBuildTxVoteDelegation, drep, needDRepReg, anchor);
      resetInput();
      removeSignalListener(onBuiltTxVoteReg, storeId);
    };
    const fetchCurrDRepInfo = async () => {
      ...
      try {
        delegationDRepInfo.value = await getGovDRepInfo(networkId.value, selectedAccountId.value, delegationDRepCred.value);
      } catch (e) {
        console.error("getGovDRepInfo:", e);
      }
    };
    watch(delegationDRepCred, () => fetchCurrDRepInfo());
    onMounted(() => {
      addSignalListener(onEpochParamsUpdated, storeId, updateEpochParams);
      fetchCurrDRepInfo();
    });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        }, null, 8, ["text", "icon"])) : (((_a2 = unref(rewardInfo)) == null ? void 0 : _a2.govDelegationList.length) ?? 0) === 0 || !((_b = unref(rewardInfo)) == null ? void 0 : _b.hasActiveDRep) ? (openBlock(), createBlock(_sfc_main$g, {
          key: 1,
          html: "",
          class: "col-span-12",
          css: "cc-rounded cc-banner-warning",
          text: unref(t)(`wallet.summary.stakeinfo.gov.${(((_c = unref(rewardInfo)) == null ? void 0 : _c.govDelegationList.length) ?? 0) === 0 ? "nodelegation" : "inactive"}`),
          icon: unref(t)("wallet.summary.stakeinfo.gov.icon.warning")
        ...
        createBaseVNode("div", _hoisted_1$1, [
          ...
          createBaseVNode("div", _hoisted_2, [
            !delegationDRepCred.value ? (openBlock(), createElementBlock("div", _hoisted_3, toDisplayString(delegationValue.value), 1)) : (openBlock(), createElementBlock("table", _hoisted_4, [
              createBaseVNode("tbody", null, [
                createBaseVNode("tr", _hoisted_5, [
                  ...
                  createBaseVNode("td", _hoisted_8, [
                    ...
                    delegationDRepUtxo.value ? (openBlock(), createBlock(_sfc_main$n, {
                      key: 0,
                ...
                delegationDRepStatus.value && delegationDRepAddr.value ? (openBlock(), createElementBlock("tr", _hoisted_10, [
                  createBaseVNode("td", _hoisted_11, toDisplayString(unref(t)("wallet.voting.governance.delegation.current.status")) + ":", 1),
                  createBaseVNode("td", null, toDisplayString(delegationDRepStatus.value), 1)
                ])) : createCommentVNode("", true),
                delegationDRepVotePower.value ? (openBlock(), createElementBlock("tr", _hoisted_12, [
                  createBaseVNode("td", _hoisted_13, toDisplayString(unref(t)("wallet.voting.governance.delegation.current.votepower")) + ":", 1),
        ...
        ((_d = unref(rewardInfo)) == null ? void 0 : _d.registered) && ((_e = unref(epochParams)) == null ? void 0 : _e.isAtLeastConwayEra) ? (openBlock(), createElementBlock("div", {
          key: 2,
          onClick: _cache[0] || (_cache[0] = withModifiers(($event) => showDelegation.value = !showDelegation.value, ["stop"])),
          class: normalizeClass(["col-span-12 cursor-pointer", showDelegation.value ? "mb-2" : ""])
        }, [
          createVNode(GridSpace, {
            hr: "",
            class: "col-span-12 mt-0.5 mb-2 sm:mt-2 sm:mb-4"
          }),
          createBaseVNode("i", {
            class: normalizeClass(["mr-2", showDelegation.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
          }, null, 2),
          createBaseVNode("span", _hoisted_17, toDisplayString(unref(t)("wallet.voting.governance.delegation.new.label")), 1)
        ], 2)) : createCommentVNode("", true),
        showDelegation.value ? (openBlock(), createElementBlock("div", _hoisted_18, [
          createBaseVNode("select", {
            class: "col-span-12 sm:col-span-6 xl:col-span-4 cc-rounded-la cc-dropdown cc-text-sm",
            required: true,
            onChange: _cache[1] || (_cache[1] = ($event) => onSelectDelegationDRep($event))
          }, [
          ...
          selectedDelegationDRep.value === "custom" ? (openBlock(), createBlock(GridInput, {
            ...
            "onUpdate:inputText": [
              _cache[2] || (_cache[2] = ($event) => customDRepID.value = $event),
              validateCustomDRepId
            ],
            "input-error": customDRepIDError.value,
            "onUpdate:inputError": _cache[3] || (_cache[3] = ($event) => customDRepIDError.value = $event),
            onReset: resetInput,
        ...
        createBaseVNode("div", _hoisted_20, [
          createBaseVNode("div", {
            onClick: _cache[4] || (_cache[4] = withModifiers(($event) => showAbstain.value = !showAbstain.value, ["stop"])),
            class: "cursor-pointer mb-1"
          }, [
            createBaseVNode("i", {
              class: normalizeClass(["mr-2", showAbstain.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
            }, null, 2),
            createBaseVNode("span", _hoisted_21, toDisplayString(unref(t)("wallet.voting.governance.info.abstain.label")), 1)
          ]),
          ...
          createBaseVNode("div", {
            onClick: _cache[5] || (_cache[5] = withModifiers(($event) => showNoConfidence.value = !showNoConfidence.value, ["stop"])),
            class: "cursor-pointer my-1"
          }, [
            createBaseVNode("i", {
              class: normalizeClass(["mr-2", showNoConfidence.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
            }, null, 2),
            createBaseVNode("span", _hoisted_22, toDisplayString(unref(t)("wallet.voting.governance.info.noconfidence.label")), 1)
          ]),
        ...
        unref(govToolURL).length > 0 ? (openBlock(), createElementBlock("div", _hoisted_23, [
        ...
        createBaseVNode("div", {
          onClick: _cache[6] || (_cache[6] = withModifiers(($event) => showCreds.value = !showCreds.value, ["stop"])),
          ...
          createBaseVNode("span", _hoisted_28, toDisplayString(unref(t)("wallet.voting.governance.key." + (!showCreds.value ? "show" : "hide"))), 1)
        ]),
        showCreds.value ? (openBlock(), createElementBlock("div", _hoisted_29, [
          createBaseVNode("div", _hoisted_30, [
            ...
            createBaseVNode("div", _hoisted_31, [
              ...
              createBaseVNode("div", _hoisted_32, toDisplayString(accDRepAddr.value), 1)
            ])
          ]),
          createBaseVNode("div", _hoisted_33, [
            ...
            createBaseVNode("div", _hoisted_34, [
              ...
              createBaseVNode("div", _hoisted_35, toDisplayString(ccColdAddr.value), 1)
            ])
          ]),
          createBaseVNode("div", _hoisted_36, [
            ...
            createBaseVNode("div", _hoisted_37, [
              ...
              createBaseVNode("div", _hoisted_38, toDisplayString(ccHotAddr.value), 1)
            ])
          ])
        ])) : createCommentVNode("", true),
          ...
          content: withCtx(() => [
            createBaseVNode("div", _hoisted_44, [
              createVNode(GridInput, {
                ...
                "onUpdate:inputText": [
                  _cache[7] || (_cache[7] = ($event) => drepAnchor.value = $event),
                  validateDRepAnchor
                ],
                "input-error": drepAnchorError.value,
                "onUpdate:inputError": _cache[8] || (_cache[8] = ($event) => drepAnchorError.value = $event),
                onEnter: _cache[9] || (_cache[9] = ($event) => voteDelegation()),
                onReset: resetInput,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        catalystIsEnabled.value && governanceIsEnabled.value ? (openBlock(), createBlock(_sfc_main$p, {
          key: 0,
          tabs: optionsTabs
        }, {
          tab0: withCtx(() => [
