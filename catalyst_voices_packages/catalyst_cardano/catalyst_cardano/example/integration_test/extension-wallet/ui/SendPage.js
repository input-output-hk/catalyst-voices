import { z as ref, D as watch, ag as useSelectedAccount, fj as getStagingTxList, fk as getStagingTxConfigList, fl as getBuiltTxList, fm as getBuiltTxBalanceList, k as dispatchSignalSync, fn as doResetAllTx, f as computed, fo as doAddOutput, fp as doRemoveOutput, fq as doAddDonation, fr as doRemoveDonation, fs as doAddAuxData, d as defineComponent, a7 as toRefs, o as openBlock, a as createBlock, a9 as useQuasar, bZ as onBeforeMount, C as onMounted, aY as addSignalListener, ft as onTxAuxUpdate, aI as onUnmounted, aZ as removeSignalListener, c as createElementBlock, b as withModifiers, q as createVNode, u as unref, e as createBaseVNode, n as normalizeClass, j as createCommentVNode, h as withCtx, cs as QToggle_default, H as Fragment, cw as getRandomId, fu as checkTxMetadataFromStringArray, fv as getTxMetadataFromStringArray, fw as UnstoppableDomainsError, ez as getRequestData, eA as ApiRequestType, fx as isValidSendAddress, K as networkId, fy as callAPI, fz as setMilkomedaParameter, aN as isTestnet, fA as getMilkomedaMetadata, fB as getAssetCDN, fC as getImageB64, fD as AdaHandleError, i as createTextVNode, t as toDisplayString, bf as useWalletAccount, bL as getAddressCredentials, fE as getIAppAccountByCred, dm as getIAppWallet, fF as getAccountName, fG as onAddressBookEntryDeleted, fH as onAddressBookEntryUpdated, X as nextTick, eH as Transition, fI as getDonationAddress, fJ as isValidAddress, fK as isScriptAddress, fL as getDefaultErrorMessage, fM as addressBook, fN as updateAddressBookEntry, L as pushScopeId, M as popScopeId, aK as useGuard, V as createSlots, a_ as checkEpochParams, fO as createIBalance, cV as subtract, at as appLanguageTag, fP as clearValueJSON, fQ as getNewBuildCounter, fR as resetBuiltTx, bn as dispatchSignal, fS as onTxBuiltReset, fT as dispatchSignalSyncTo, fU as doUpdateAccountBalances, fV as onTxBuilt, fW as onTxBuiltError, fX as onTxSignReset, fY as onAccountSettingsUpdated, fZ as onAccountBalancesUpdated, f_ as onSelectedUtxoToggled, B as useFormatter, eQ as addValueToValue, f$ as updateBalanceTotal, cl as isLessThanZero, ck as isZero, g0 as getMinUtxo, f0 as compare, g1 as replaceMultiAssetInValue, g2 as convertIAssetSendableListToMultiAssetJSON, ev as sleepDefault, g3 as hasNewerBuild, g4 as doJustBuildTxSend, g5 as ErrorBuildTx, g6 as convertMultiAssetJSONToIAssetSendableList, g7 as getStagingTx, g8 as getBuiltTx, g9 as isEqual, cY as abs, ga as getTxBuiltErrorMsg, gb as splitLargeOutput, gc as updateValueJSONIfNeeded, gd as addOutputIndex, ge as addToBalance, gf as decreaseBalance, aC as renderSlot, a$ as ErrorSignTx, gg as getHintUtxoList, gh as getTransactionFromCbor, gi as fillInputUtxoList, bh as getSignTxCredList, gj as calcAccountTxBalance, eR as createIUtxo, bm as useSignTx, cH as onErrorCaptured, gk as getTxImportErrorMsg, by as onTxSignCancel, bx as onTxSignSubmit, F as withDirectives, gl as vModelText, dy as Buffer$1, gm as pow, gn as MetadataJsonSchema, go as getMetadataType, eW as createJsonFromCborJson, I as renderList, gp as createIMetadata, gq as getMetadataFromJSON, gr as cslToJson, b2 as safeFreeCSLObject, gs as isProduction, Q as QSpinnerDots_default, gt as hasSelectedUtxos, gu as doClearSelectedUtxos, aS as sleep, gv as onBuiltTxTF, gw as doBuildTxTF, gx as doBuildTxCU, gy as parseTxSignRequest, gz as doBuildTxMSCU, w as watchEffect, gA as doJustSendBuiltTx } from "./index.js";
...
const _hoisted_2$d = { class: "col-span-12 flex flex-row flex-nowrap cc-gap" };
...
const resolveUnstoppableDomain = async (networkId2, accountId, domain) => {
  ...
  try {
    ...
    } else if (!address || !isValidSendAddress(isTestnetNetwork(networkId2), address)) {
...
const onLoadList = (milkomedaData, address) => {
  ...
  milkomedaBridgeAddrValid.value = isValidSendAddress(isTestnet.value, milkomedaData.current_address);
...
const _hoisted_2$c = /* @__PURE__ */ createBaseVNode("path", { d: "M17,4V10L15,8L13,10V4H9V20H19V4H17M3,7V5H5V4C5,2.89 5.9,2 7,2H19C20.05,2 21,2.95 21,4V20C21,21.05 20.05,22 19,22H7C5.95,22 5,21.05 5,20V19H3V17H5V13H3V11H5V7H3M5,5V7H7V5H5M5,19H7V17H5V19M5,13H7V11H5V13Z" }, null, -1);
const _hoisted_3$b = [
  _hoisted_2$c
];
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", _hoisted_1$c, [
        ...
        __props.add ? (openBlock(), createElementBlock("path", _hoisted_4$8)) : createCommentVNode("", true)
      ]);
    };
  }
});
...
const _hoisted_1$a = /* @__PURE__ */ createBaseVNode("span", { class: "whitespace-nowrap cc-text-xs" }, "Select Account", -1);
const _hoisted_2$9 = { class: "grow-0 shrink-0 w-full flex flex-row flex-nowrap items-start justify-between border-b cc-p" };
const _hoisted_3$8 = { class: "flex flex-col cc-text-sz" };
...
const _withScopeId = (n) => (pushScopeId("data-v-8d814765"), n = n(), popScopeId(), n);
const _hoisted_1$9 = {
  key: 0,
...
const _hoisted_7$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-heart text-xl text-red-500" }, null, -1));
const _hoisted_8 = [
  _hoisted_7$1
];
const _hoisted_9 = {
...
const _hoisted_12 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", null, "Change", -1));
const _hoisted_13 = [
  _hoisted_12
];
const _hoisted_14 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", {
...
const _hoisted_17 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("i", { class: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mdi mdi-close text-xs" }, null, -1));
const _hoisted_18 = [
  _hoisted_17
];
const _hoisted_19 = {
...
const _hoisted_20 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "relative -mt-px" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "relative ml-px -mt-0.5" }, [
    /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-alert-octagon-outline text-sm" })
  ])
], -1));
const _hoisted_21 = [
  _hoisted_20
...
const _hoisted_23 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "relative -mt-px" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "relative ml-px -mt-0.5" }, [
    /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-alert-octagon-outline text-sm" })
  ])
], -1));
...
const _hoisted_26 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("i", { class: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mdi mdi-check text-xs" }, null, -1));
const _hoisted_27 = [
  _hoisted_26
];
const _hoisted_28 = { class: "cc-text-bold cc-text-sx ml-px" };
const _hoisted_29 = {
  key: 0,
  class: "absolute -top-1.5 -right-1 rounded-full bg-red-500 dark:bg-red-600 w-4 h-4 flex justify-center items-center"
};
const _hoisted_30 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("i", { class: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mdi mdi-close text-xs" }, null, -1));
const _hoisted_31 = [
  _hoisted_30
];
const _hoisted_32 = {
...
const _hoisted_33 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "relative -mt-px" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "relative ml-px -mt-0.5" }, [
    /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-alert-octagon-outline text-sm" })
  ])
], -1));
...
const _hoisted_36 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "relative -mt-px" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "relative ml-px -mt-0.5" }, [
    /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-alert-octagon-outline text-sm" })
  ])
], -1));
...
const _hoisted_39 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("i", { class: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mdi mdi-check text-xs" }, null, -1));
const _hoisted_40 = [
  _hoisted_39
];
...
const _hoisted_44 = { class: "cc-text-bold cc-text-sx" };
const _hoisted_45 = {
  key: 7,
...
const _hoisted_46 = { class: "cc-text-bold cc-text-sx" };
const _hoisted_47 = {
  key: 8,
  class: "h-12 px-1.5 sm:px-2.5 py-1 max-w-[15rem] flex flex-nowrap justify-center items-center space-x-1 cc-text-medium rounded cc-badge-bg-blue"
};
const _hoisted_48 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "cc-text-bold cc-text-sx" }, "Same Account", -1));
const _hoisted_49 = [
  _hoisted_48
];
const _hoisted_50 = {
...
const _hoisted_51 = { class: "cc-text-bold cc-text-sx" };
const _hoisted_52 = {
  key: 10,
...
const _hoisted_53 = { class: "cc-text-bold cc-text-sx" };
const _hoisted_54 = {
  key: 11,
...
const _hoisted_55 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "cc-text-bold cc-text-sx" }, " Milkomeda C1 Address ", -1));
const _hoisted_56 = [
  _hoisted_55
];
const _hoisted_57 = { class: "inline-flex flex-row flex-nowrap justify-end cml" };
const _hoisted_58 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-trash-can-outline drop-shadow text-lg sm:text-xl -mt-0.5 sm:mt-0" }, null, -1));
const _hoisted_59 = { class: "relative grow min-w-0 flex flex-row flex-nowrap justify-start items-start space-x-1 sm:space-x-2" };
const _hoisted_60 = { class: "relative flex-1 flex flex-col flex-nowrap justify-start items-start space-y-1 sm:space-y-2" };
const _hoisted_61 = { class: "relative w-full flex flex-col sm:flex flex-nowrap justify-start items-start" };
const _hoisted_62 = {
...
const _hoisted_65 = { class: "col-span-full grid cc-bg-white-0 p-2 rounded-borders" };
const _hoisted_66 = { class: "col-span-12 flex flex-row flex-nowrap justify-center items-center whitespace-pre-wrap cc-text-bold cc-text-red-light" };
const _hoisted_67 = { class: "col-span-full mt-2 w-full max-w-full mb-2 cc-test" };
...
const _hoisted_73 = { class: "p-4" };
const _hoisted_74 = { class: "grid grid-cols-12 cc-gap mt-2" };
  ...
  setup(__props) {
    ...
    const validateAddrInput = async () => {
      ...
      if (props.allowStakeAddresses) {
        if (!isValidAddress(isTestnet.value, address)) {
        ...
        if (isMilkomedaTx2.value) {
          ...
          if (!isValidSendAddress(isTestnet.value, address)) {
            addrInputError.value = it(props.textId + ".error");
            onResetOutput();
          } else {
            onResetAddrInputError();
    ...
    const validateAddr = () => {
      if (addrInputError.value.length === 0 && (addrInput.value.length > 0 && addrInput.value !== "$" || addrInput.value.length === 0 && props.canBeEmpty)) {
        isValidReceiveAddr.value = isValidSendAddress(isTestnet.value, addrInput.value) || isMilkomedaTx2.value;
    ...
    return (_ctx, _cache) => {
      ...
      return unref(accountData2) ? (openBlock(), createElementBlock("div", _hoisted_1$9, [
        createBaseVNode("div", _hoisted_2$8, [
          createBaseVNode("div", _hoisted_3$7, [
            !__props.disabled ? (openBlock(), createElementBlock("div", _hoisted_4$6, [
              !isDonation.value ? (openBlock(), createElementBlock("span", _hoisted_5$4, toDisplayString(unref(outputIndex) + 1), 1)) : (openBlock(), createElementBlock("span", _hoisted_6$3, _hoisted_8)),
              isDonation.value ? (openBlock(), createElementBlock("span", _hoisted_9, "Thank you for supporting Eternl!")) : createCommentVNode("", true),
              unref(txIndex) > 0 ? (openBlock(), createElementBlock("span", _hoisted_10, " (" + toDisplayString(unref(txIndex) + 1) + ")", 1)) : createCommentVNode("", true)
            ...
            adaHandle.value ? (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                _hoisted_14,
                createBaseVNode("span", _hoisted_15, toDisplayString(adaHandle.value.substring(1)), 1)
              ], 2),
              createVNode(Transition, { name: "fade" }, {
                default: withCtx(() => [
                  !adaHandleAddress.value && addrInputError.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_16, _hoisted_18)) : !adaHandleAddress.value ? (openBlock(), createElementBlock("div", _hoisted_19, _hoisted_21)) : adaHandleAddress.value && adaHandleAddressNew.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_22, _hoisted_24)) : (openBlock(), createElementBlock("div", _hoisted_25, _hoisted_27))
                ]),
                _: 1
              })
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("span", _hoisted_28, toDisplayString(unstoppabledomain.value), 1)
              ], 2),
              createVNode(Transition, { name: "fade" }, {
                default: withCtx(() => [
                  !unstoppabledomainAddress.value && addrInputError.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_29, _hoisted_31)) : !unstoppabledomainAddress.value ? (openBlock(), createElementBlock("div", _hoisted_32, _hoisted_34)) : unstoppabledomainAddress.value && unstoppabledomainAddressNew.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_35, _hoisted_37)) : (openBlock(), createElementBlock("div", _hoisted_38, _hoisted_40))
                ]),
                _: 1
              })
            ...
            showAdaHandleResolve.value && !adaHandleAddress.value ? (openBlock(), createElementBlock("button", {
            ...
            ], 10, _hoisted_41)) : unstoppabledomainShowResolve.value && !unstoppabledomainAddress.value ? (openBlock(), createElementBlock("button", {
              key: 5,
              class: normalizeClass([
                "px-2 sm:px-3 flex flex-row flex-nowrap justify-center items-center space-x-1 cc-text-medium rounded-md text-white cursor-pointer",
              ...
              createBaseVNode("div", null, toDisplayString(unref(it)("common.label.resolve")), 1)
            ], 10, _hoisted_42)) : createCommentVNode("", true),
            entryInAddressBook.value ? (openBlock(), createElementBlock("div", _hoisted_43, [
              createBaseVNode("div", null, [
                createVNode(IconBook, { class: "h-4 -ml-0.5 mt-px" })
              ]),
              createBaseVNode("div", _hoisted_44, toDisplayString(entryInAddressBook.value.name), 1)
            ])) : createCommentVNode("", true),
            isSameAccount.value && appAccountName.value ? (openBlock(), createElementBlock("div", _hoisted_45, [
              createBaseVNode("div", _hoisted_46, toDisplayString(appAccountName.value), 1)
            ])) : isSameAccount.value ? (openBlock(), createElementBlock("div", _hoisted_47, _hoisted_49)) : isSameWallet.value && walletName.value ? (openBlock(), createElementBlock("div", _hoisted_50, [
              createBaseVNode("div", _hoisted_51, toDisplayString(walletName.value) + ": " + toDisplayString(appAccountName.value), 1)
            ])) : walletName.value ? (openBlock(), createElementBlock("div", _hoisted_52, [
              createBaseVNode("div", _hoisted_53, toDisplayString(walletName.value) + ": " + toDisplayString(appAccountName.value), 1)
            ])) : createCommentVNode("", true),
            unref(isMilkomedaTx2) ? (openBlock(), createElementBlock("div", _hoisted_54, _hoisted_56)) : createCommentVNode("", true)
          ]),
        ...
        showScammerWarning.value ? (openBlock(), createElementBlock("div", _hoisted_64, [
          createBaseVNode("div", _hoisted_65, [
            createBaseVNode("div", _hoisted_66, toDisplayString(unref(it)("common.scam.guard.warning")), 1),
            createBaseVNode("div", _hoisted_67, toDisplayString(unref(it)("common.scam.address.description")), 1),
            createBaseVNode("div", {
        ...
        }, null, 8, _hoisted_69)) : createCommentVNode("", true),
        unref(isMilkomedaTx2) ? (openBlock(), createElementBlock("div", _hoisted_70, [
        ...
        }, null, 8, _hoisted_71)) : createCommentVNode("", true),
        unref(isMilkomedaTx2) ? (openBlock(), createElementBlock("div", _hoisted_72, [
...
const SendOutputAddress = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-8d814765"]]);
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onAddAllAda = async (isFirstPass = true, offset) => {
      ...
      updateAvailableOutputBalance(accountBalances.value);
      adaInputError.value = "";
      manualUpdate.value = manualUpdate.value + 1;
      if (isFirstPass) {
    ...
    const updateAvailableOutputBalance = (balances) => {
...
const _hoisted_5$3 = { class: "relative flex-grow-0 flex-shrink-0 cursor-pointer cc-text-spacing cc-text-xs hover:cc-text-highlight-hover" };
const _hoisted_6$2 = { class: "ml-5 mr-16 mt-1 break-normal whitespace-pre-wrap" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_6$2, toDisplayString(__props.caption), 1)
          ], 2),
...
const parseTxList = async (networkId2, defaultAppAccount, txSubmitType, _txList) => {
  ...
  for (let i = 0; i < txLen; i++) {
    ...
    for (const cert of res.builtTx.body.certs ?? []) {
      if ((cert.hasOwnProperty("GenesisKeyDelegation") || cert.hasOwnProperty("MoveInstantaneousRewardsCert")) && epochParams.isAtLeastConwayEra) {
        throw ErrorSignTx.depreciatedCertificate;
      }
    }
    ...
    if (!txList[i].partialSign && res.txCredList.length !== creds.total) {
  ...
  useSignTx().openSignTx(resList, txSubmitType, balanceList, _appAccount.id, _appAccount.walletId, partialSign, totalBalance);
...
const _hoisted_6$1 = /* @__PURE__ */ createBaseVNode("span", { class: "mr-1" }, ">", -1);
const _hoisted_7 = ["selected", "value"];
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(schemaOptions), (schema, index) => {
            return openBlock(), createElementBlock("div", _hoisted_3$3, [
              createBaseVNode("div", _hoisted_4$3, [
                ...
                index === 0 ? (openBlock(), createElementBlock("div", _hoisted_5$2, "(recommended)")) : createCommentVNode("", true)
              ]),
              _hoisted_6$1,
              createVNode(_sfc_main$l, {
          ...
          createBaseVNode("select", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(schemaOptions), (schema, index) => {
              return openBlock(), createElementBlock("option", {
                ...
                value: index
              }, toDisplayString(schema), 9, _hoisted_7);
            }), 128))
          ], 32),
...
const _hoisted_5$1 = { class: "col-span-12 flex flex-row justify-start items-center gap-4 mb-2" };
...
const _hoisted_3$1 = /* @__PURE__ */ createBaseVNode("span", null, /* @__PURE__ */ toDisplayString("Send Transaction"), -1);
const _hoisted_4$1 = [
  _hoisted_3$1
];
const _hoisted_5 = {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        unref(accountData2) && unref(stagingTx) ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
          numStagingTx.value <= 1 ? (openBlock(), createElementBlock("div", _hoisted_2$1, _hoisted_4$1)) : (openBlock(), createBlock(GridSpace, {
            key: 1,
          ...
          unref(builtTx) && unref(builtTxBalance) && unref(accountData2) ? (openBlock(), createElementBlock("div", _hoisted_5, [
          ...
          !isMilkomeda.value ? (openBlock(), createElementBlock("div", _hoisted_6, [
