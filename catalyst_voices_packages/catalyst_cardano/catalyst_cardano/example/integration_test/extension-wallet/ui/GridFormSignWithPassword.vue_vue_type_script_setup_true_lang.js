...
import { d as defineComponent, z as ref, U as reactive, f as computed, o as openBlock, a as createBlock, h as withCtx, q as createVNode, aC as renderSlot, u as unref } from "./index.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function onSubmit() {
      if (!submitEnabled.value || !spendingPassword.value)
        return;
      emit("submit", {
