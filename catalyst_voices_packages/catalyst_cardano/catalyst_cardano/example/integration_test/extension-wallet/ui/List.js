...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-wallet text-8xl sm:text-9xl" }, null, -1);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          _hoisted_3,
          createBaseVNode("span", _hoisted_4, toDisplayString(unref(t)("wallet.list.choose")), 1)
        ])
      ]);
    };
  }
