import { d as defineComponent, a7 as toRefs, f as computed, z as ref, u as unref, o as openBlock, a as createBlock, h as withCtx, e as createBaseVNode, q as createVNode, c as createElementBlock, j as createCommentVNode, a9 as useQuasar, c7 as entityGroupList, C as onMounted, n as normalizeClass, b as withModifiers, t as toDisplayString, H as Fragment, I as renderList, aJ as QPagination_default, c8 as json, c9 as deleteReportEntityGroup, ca as addReportEntityGroup, cb as updateReportEntityGroup, cc as updateAllReportEntityGroups, cd as setSelectedEntityGroup, F as withDirectives, J as vShow, ce as selectedEntityGroup, i as createTextVNode, cf as reportLabelList, cg as addReportLabel, ch as deleteReportLabel, ai as walletGroupNameList, ci as allEntityGroup, cj as switchWalletGroupToSelectedEntityGroup, D as watch, ck as isZero, cl as isLessThanZero, cm as getAssetName, B as useFormatter, cn as getAssetIdBech32, co as accAssetInfoMap, cp as fetchAssetInfo, K as networkId, cq as updateAccountAssetInfoMap, aK as useGuard, cr as hasLeftOverValue, bi as getTimestampFromSlot, cs as QToggle_default, ct as QBtn_default, cu as QPopupProxy_default, cv as QDate_default, cw as getRandomId, cx as markBalanceAsTaxRelevant, cy as markBalanceAsC, cz as resetBalance, cA as calcFiatValue, cB as markBalanceAsManual, cC as isTxHash, cD as getMetaData, cE as markBalanceUsingCostBasis, cF as updateBalanceCB, cG as getSlotFromDateId, au as appTimezone, cH as onErrorCaptured, cI as getAllMetaData, cJ as isZeroOrGreater, bf as useWalletAccount, cK as getRawData, aI as onUnmounted, cL as isAccountLoadingRawReportingData, cM as isLoadingRawReportingData, cN as loadRawData, a8 as useAppWallet, aa as SyncState, ad as withKeys, ak as walletGroupMap, cO as getIAppWallet, cP as loadRawDataRewards, cQ as saveRawData, cR as clearRawData, cS as addRawData, X as nextTick, cT as doLoadMissingAssetInfo, cU as sortRawBalanceList, cV as subtract, cW as neg, cX as divide, cY as abs, cZ as isGreaterThanZero, c_ as getAssetInfoLight, c$ as date_default, d0 as saveMetaData, d1 as clearMetaData, d2 as ITxBalanceType, d3 as getDateIdFromSlot, d4 as addPriceOfDay, d5 as combineData, d6 as setMetaData, d7 as getAllReportData, d8 as saveReportData, d9 as clearReportData, da as createReportData, db as getAccountIdListByEntity, dc as createLedger, dd as getReports, de as doLoadMissingAssetInfoByStringList, df as getCSVADAAmount, dg as getCSVAmount, dh as setReportData, x as isSignMode } from "./index.js";
...
import "./NetworkId.js";
import { u as useCSVExport, I as ICSVExportTargetId } from "./useCSVExport.js";
...
const _hoisted_8$8 = { class: "divide-y" };
const _hoisted_9$7 = ["onClick"];
const _hoisted_10$6 = { class: "w-5 h-5 cc-text-highlight mdi mdi-text-box-edit-outline ml-1" };
        ...
        filteredList.value.length > 0 ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_2$g, [
            createBaseVNode("table", _hoisted_3$f, [
              ...
              createBaseVNode("tbody", _hoisted_8$8, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(filteredList.value, (entityGroup, index) => {
                  ...
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", {
                      ...
                      withDirectives(createBaseVNode("i", _hoisted_10$6, null, 512), [
                    ...
                    createBaseVNode("td", {
                      ...
                      onClick: withModifiers(($event) => unref(setSelectedEntityGroup)(entityGroup), ["stop"])
                    }, toDisplayString(entityGroup.comment), 11, _hoisted_11$4),
...
const _hoisted_9$6 = { class: "divide-y" };
const _hoisted_10$5 = { class: "cc-grid" };
const itemsOnPage = 8;
            ...
            createBaseVNode("table", _hoisted_3$e, [
              createBaseVNode("thead", null, [
                createBaseVNode("tr", _hoisted_4$e, [
                  ...
                  !__props.readonly ? (openBlock(), createElementBlock("th", _hoisted_8$7, toDisplayString(unref(it)("setting.reportEntity.reportLabels.table.header.action")), 1)) : createCommentVNode("", true)
                ])
              ]),
              createBaseVNode("tbody", _hoisted_9$6, [
...
const _hoisted_8$6 = { key: 5 };
const _hoisted_9$5 = { key: 6 };
const _hoisted_10$4 = { class: "truncate" };
const _hoisted_11$3 = {
  key: 0,
  ...
  setup(__props, { emit: __emit }) {
    ...
    const update = async (balance) => {
      ...
      if (balance.au) {
        ...
        if ((await isAssetOnBlockList(getAssetIdBech32(policy, asset))).length > 0) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$d, [
        createBaseVNode("div", _hoisted_2$d, [
          ...
          __props.costBasis.ts ? (openBlock(), createElementBlock("span", _hoisted_4$c, toDisplayString(unref(formatDatetime)(new Date(__props.costBasis.ts), true, false)), 1)) : createCommentVNode("", true),
          ...
          __props.costBasis.gl ? (openBlock(), createElementBlock("span", _hoisted_8$6, "g/l: " + toDisplayString((__props.costBasis.gl.toFixed(4) ?? 0).replace(".", ",")) + " " + toDisplayString(__props.costBasis.fu), 1)) : createCommentVNode("", true),
          createBaseVNode("span", null, "(" + toDisplayString(__props.costBasis.t) + ")", 1),
          assetCnt.value > 1 ? (openBlock(), createElementBlock("span", _hoisted_9$5, "ac: (" + toDisplayString(assetCnt.value) + ")", 1)) : createCommentVNode("", true),
          ...
          createBaseVNode("div", {
            ...
            assetsFiltered.value.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(assetsFiltered.value, (asset, index) => {
              ...
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_10$4, toDisplayString(unref(getAssetName)(asset.asset.t.a, asset.info, true)), 1),
                spamAssets.value.includes(asset.asset.p + asset.asset.t.a) ? (openBlock(), createElementBlock("div", _hoisted_11$3, [
...
const ReportCBListEntryBalance = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-83f3aa20"]]);
...
const _hoisted_8$5 = { class: "q-gutter-sm row" };
const _hoisted_9$4 = ["selected", "value"];
const _hoisted_10$3 = ["selected", "value"];
const _hoisted_11$2 = { class: "grow-0 shrink-0 w-full flex flex-row flex-nowrap items-start justify-between cc-bg-white-0 border-b cc-p" };
...
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("div", { class: "mt-1 rounded-full bg-yellow-500 dark:bg-yellow-600 w-4 h-4 flex justify-center items-center" }, [
...
const _hoisted_22 = { class: "mt-1.5 mr-2 cc-addr break-normal" };
const _hoisted_23 = { class: "relative flex flex-row items-center mt-1 sm:mt-0.5 gap-1" };
const _hoisted_24 = { class: "relative cc-text-bold mr-0.5 mt-px" };
const _hoisted_25 = {
  key: 0,
...
const _hoisted_28 = { class: "ml-6 inline-flex flex-row flex-wrap gap-1 max-w-96" };
const _hoisted_29 = ["onClick"];
const _hoisted_30 = { class: "text-amber-600" };
const _hoisted_31 = {
  key: 0,
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onSaveTxHash = () => {
      const data = metaData.value;
      const txHash = inputManualTxHash.value;
      console.log("onSaveTxHash", data, isTxHash(txHash), txHash);
      if (!data) {
        return;
      }
      if (!isTxHash(txHash)) {
      ...
      console.log("onSaveTxHash", inputManualTxHash.value);
      const _metaData = getMetaData(props.entityId, false);
      const cbTx = _metaData.balanceList.find((d) => d.h === txHash);
      if (!cbTx) {
        return;
      }
      console.log(cbTx);
      markBalanceUsingCostBasis(networkId.value, data, cbTx);
      onCloseModal();
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$c, [
                ...
                createBaseVNode("select", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(selectManualTypeList), (type) => {
                    return openBlock(), createElementBlock("option", {
                      ...
                      value: type.id
                    }, toDisplayString(type.value), 9, _hoisted_9$4);
                  }), 128))
                ], 32),
                createBaseVNode("select", {
                  class: "col-span-5 cc-rounded-la cc-dropdown cc-text-sm",
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(selectManualUnitList), (type) => {
                    return openBlock(), createElementBlock("option", {
                      ...
                      value: type.id
                    }, toDisplayString(type.value), 9, _hoisted_10$3);
                  }), 128))
                ], 32)
              ]),
              createVNode(GridInput, {
        ...
        unref(metaData) ? (openBlock(), createElementBlock("div", _hoisted_14, [
          createBaseVNode("div", _hoisted_15, [
            createBaseVNode("div", _hoisted_16, [
              createBaseVNode("div", _hoisted_17, [
                unref(metaData).a.coin === "0" ? (openBlock(), createElementBlock("div", _hoisted_18, _hoisted_20)) : (openBlock(), createElementBlock("div", _hoisted_21, [
                  createBaseVNode("i", {
                    class: normalizeClass(["relative text-xl -mt-px", txType.value.icon])
                  }, null, 2)
                ])),
                createBaseVNode("div", _hoisted_22, toDisplayString(unref(formatDatetime)(blockTime.value)), 1),
                createBaseVNode("div", _hoisted_23, [
                  createBaseVNode("div", _hoisted_24, toDisplayString(txType.value.name), 1),
                  hasLeftOver.value ? (openBlock(), createElementBlock("div", _hoisted_25, "not checked")) : createCommentVNode("", true),
                  createBaseVNode("div", {
                  ...
                  unref(metaData).d && !unref(isZero)(unref(metaData).d) ? (openBlock(), createElementBlock("div", _hoisted_26, "deposit")) : createCommentVNode("", true)
                ])
              ]),
              createBaseVNode("div", _hoisted_27, [
                createBaseVNode("div", _hoisted_28, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(metaData).al, (a) => {
                    ...
                    }, toDisplayString(a), 9, _hoisted_29);
                  }), 256)),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(metaData).el, (e) => {
                    return openBlock(), createElementBlock("div", _hoisted_30, toDisplayString(e) + " -", 1);
                  }), 256))
                ])
              ]),
              hasLeftOver.value ? (openBlock(), createElementBlock("div", _hoisted_31, [
              ...
              scpId.value && scpId.value !== unref(metaData).h ? (openBlock(), createElementBlock("div", _hoisted_32, [
                createVNode(_sfc_main$p, {
                  subject: scpId.value,
                  type: "transaction",
                  label: scpId.value,
            ...
            }, null, 8, ["tx-balance"])) : (openBlock(), createElementBlock("div", _hoisted_33, [
          ...
          hasLeftOver.value || unref(metaData).cb.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_34, [
            hasLeftOver.value ? (openBlock(), createElementBlock("div", _hoisted_35, [
              ...
              maLeft.value ? (openBlock(), createElementBlock("span", _hoisted_36, toDisplayString(maLeft.value), 1)) : createCommentVNode("", true)
            ])) : createCommentVNode("", true),
            ...
            hasLeftOver.value ? (openBlock(), createElementBlock("div", _hoisted_37, [
              createBaseVNode("div", {
...
const _hoisted_10$2 = { class: "col-span-12 flex justify-center" };
const _hoisted_11$1 = {
  key: 1,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$b, [
        ...
        createBaseVNode("div", _hoisted_5$7, [
          createBaseVNode("div", _hoisted_6$6, [
            filterByAccountId.value ? (openBlock(), createElementBlock("div", _hoisted_7$5, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(excludeAccountIdList.value, (accountId) => {
                ...
                }, toDisplayString(accountId), 9, _hoisted_8$4);
              }), 256))
          ...
          unref(entityId) ? (openBlock(), createElementBlock("div", _hoisted_11$1, [
...
const _hoisted_10$1 = /* @__PURE__ */ createBaseVNode("div", { class: "flex-grow flex-shrink" }, null, -1);
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const doCreateReport = async () => {
      ...
      await loadRawData(_appAccount, _stopSync, true);
      _stopSync.value = false;
    };
    onUnmounted(() => {
      _stopSync.value = true;
              ...
              createBaseVNode("div", _hoisted_3$9, [
                createBaseVNode("div", _hoisted_4$9, [
                  ...
                  createBaseVNode("button", {
                    ...
                    disabled: unref(isLoadingRawReportingData)
                  }, toDisplayString(_showTransactions.value ? "Hide" : "Show") + " Transactions ", 9, _hoisted_9$2)
                ])
              ])
            ]),
            _hoisted_10$1
...
const _hoisted_8$2 = /* @__PURE__ */ createBaseVNode("div", { class: "flex-grow flex-shrink" }, null, -1);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function doExportCSV() {
      ...
      const csv = createCSVFile(networkId.value, metaData.balanceList, target, it, timezoneToggle.value);
      const fileName = "eternlio-entity-" + props.entityId + "-" + target.id + ".csv";
    ...
    const createCSVFile = (networkId2, _balanceList, target, t, useLocalTimezone = false, includeTxNotes = false) => {
      var _a, _b, _c;
      ...
      for (const balance of balanceList) {
        if (!((_a = balance.a) == null ? void 0 : _a.coin))
          throw new Error("Transaction malformed.");
      ...
      for (let i = 0; i < numFields; i++) {
        ...
        switch (field) {
          ...
          case "Koinly Date":
            ...
            if (!useLocalTimezone) {
              csv += date_default.formatDate(slotTime, "YYYY-MM-DD HH:mm:ss");
            } else {
              csv += '"' + date_default.formatDate(slotTime.getTime() - (/* @__PURE__ */ new Date()).getTimezoneOffset() * 6e4, "YYYY-MM-DD HH:mm:ss") + '"';
            }
            break;
          case "Sent Amount":
            if (isNeg)
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const doUpdate = async () => {
      ...
      const metaData = getMetaData(entity.id, false);
          ...
          createBaseVNode("div", _hoisted_3$3, [
            createBaseVNode("div", _hoisted_4$3, [
              createBaseVNode("div", _hoisted_5$2, [
                createBaseVNode("div", _hoisted_6$2, toDisplayString(unref(formatDatetime)(blockTime.value, true, false)), 1)
              ])
            ]),
            createBaseVNode("div", _hoisted_7$2, [
              ...
              unref(report).out.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_9$1, [
...
const _hoisted_4$1 = { class: "col-span-12 font-mono" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const showTokens = ref(false);
    const showBought = ref(true);
    const hasPassive = ref(true);
    const has1YearTaxFree = ref(false);
    const inputRef = ref(null);
    computed(() => {
      var _a, _b;
      const list = ((_a = selectedEntityGroup.value) == null ? void 0 : _a.walletGroupNameList.concat()) ?? [];
    ...
    const convertCustomDatevRows = (customDatevRows, rowMap, year22) => {
    ...
    const doCalcLedger = async () => {
      ...
      const customDatevRows = convertCustomDatevRows(_customDatevRows2020, {}, 2020);
      convertCustomDatevRows(_customDatevRows2021, customDatevRows, 2021);
      convertCustomDatevRows(_customDatevRows2022, customDatevRows, 2022);
      _entityReports.value = await createLedger(entity.id, hasPassive.value, has1YearTaxFree.value, customDatevRows);
    };
    const getFormattedDate = (date) => {
      const year22 = date.getFullYear();
      const month22 = String(date.getMonth() + 1).padStart(2, "0");
      const day22 = String(date.getDate()).padStart(2, "0");
      const hours = String(date.getHours()).padStart(2, "0");
      const minutes = String(date.getMinutes()).padStart(2, "0");
      const seconds = String(date.getSeconds()).padStart(2, "0");
      const milliseconds = String(date.getMilliseconds()).padStart(3, "0");
      return `${year22}${month22}${day22}${hours}${minutes}${seconds}${milliseconds}`;
    };
...
`;
    ...
    const doExportDatev = async () => {
      ...
      const datevRows = reports.datevRowList.filter((row) => row.y === year2.value);
      const assetList = [];
      ...
      const csvYear = year2.value;
      const csvExportedAt = getFormattedDate(/* @__PURE__ */ new Date());
      ...
      const { downloadText } = useDownload();
      await downloadText(csv, csvYear + "-csv-" + entity.id + ".csv");
    };
    const processFile = (jsonObj) => {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        createBaseVNode("div", _hoisted_3$1, [
          createVNode(_sfc_main$i, { label: "Ledger at the end of the time frame" }),
          createVNode(GridSpace, {
            hr: "",
            label: "passive"
          }),
          (openBlock(true), createElementBlock(Fragment, null, renderList((_a = _report.value) == null ? void 0 : _a.ledgerPassive, (cb) => {
            return openBlock(), createElementBlock(Fragment, null, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList((_b = _report.value) == null ? void 0 : _b.ledgerActive, (cb) => {
            return openBlock(), createElementBlock(Fragment, null, [
              (cb.t === "p" && showPassThrough.value || cb.t === "d" && showDeposit.value || cb.t === "c" && showDeposit.value || cb.t === "f" && showTxFee.value || cb.t === "r" && showRewards.value || cb.t === "i" && showIncome.value || cb.t === "n" && showNeutral.value || cb.t === "b" && showBought.value) && (showTokens.value || !showTokens.value && !cb.au || cb.au && typeof cb.lv === "string" && !unref(isZero)(cb.lv)) ? (openBlock(), createBlock(ReportCBListEntryBalance, {
                key: 0,
                "cost-basis": cb,
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList((_c = _report.value) == null ? void 0 : _c.ledgerPassThrough, (cb) => {
            return openBlock(), createElementBlock(Fragment, null, [
              (cb.t === "p" && showPassThrough.value || cb.t === "d" && showDeposit.value || cb.t === "c" && showDeposit.value || cb.t === "f" && showTxFee.value || cb.t === "r" && showRewards.value || cb.t === "i" && showIncome.value || cb.t === "n" && showNeutral.value || cb.t === "b" && showBought.value) && (showTokens.value || !showTokens.value && !cb.au || cb.au && typeof cb.lv === "string" && !unref(isZero)(cb.lv)) ? (openBlock(), createBlock(ReportCBListEntryBalance, {
                key: 0,
                "cost-basis": cb,
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(_datevRows.value, (line) => {
            return openBlock(), createElementBlock("span", _hoisted_4$1, toDisplayString(line.a.padStart(10, "_")) + " " + toDisplayString(line.sh) + " " + toDisplayString(line.i.padStart(4, "_")) + " " + toDisplayString(line.o.padStart(4, "_")) + " " + toDisplayString(line.d) + " " + toDisplayString(line.y) + " " + toDisplayString(line.n), 1);
          }), 256))
        ])
      ]);
    };
...
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("div", { class: "h-16 md:h-20 w-full max-w-full flex flex-row flex-nowrap justify-center items-center border-t border-b mb-px cc-text-sx-dense cc-bg-white-0 overflow-hidden" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "relative w-full h-full flex flex-row flex-nowrap justify-between items-center max-w-6xl px-1 xxs:px-3 lg:px-6 xl:px-6 space-x-2" })
], -1);
const _hoisted_2 = {
  key: 0,
  class: "w-full max-w-full flex flex-col flex-nowrap justify-center items-center border-t border-b cc-menu-group"
};
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("nav", {
...
const _hoisted_5 = { class: "cc-page-wallet" };
...
const _hoisted_9 = { class: "col-span-12 grid grid-cols-12 cc-gap-lg" };
const _hoisted_10 = { class: "col-span-12 grid grid-cols-12 cc-gap-lg" };
const _hoisted_11 = { class: "col-span-12 grid grid-cols-12 cc-gap-lg" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$t, {
        ...
        header: withCtx(() => [
          _hoisted_1,
          !unref(isSignMode)() ? (openBlock(), createElementBlock("div", _hoisted_2, _hoisted_4)) : createCommentVNode("", true)
        ]),
        default: withCtx(() => [
