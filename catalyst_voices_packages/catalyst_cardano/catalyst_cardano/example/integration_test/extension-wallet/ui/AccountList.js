import { d as defineComponent, a9 as useQuasar, f as computed, ey as MAX_ACCOUNTS, z as ref, dp as isHDAccount, D as watch, aa as SyncState, bZ as onBeforeMount, C as onMounted, aY as addSignalListener, hP as onAccountDataUpdated, aI as onUnmounted, aZ as removeSignalListener, o as openBlock, c as createElementBlock, a as createBlock, j as createCommentVNode, q as createVNode, u as unref, h as withCtx, e as createBaseVNode, H as Fragment, I as renderList, b as withModifiers, n as normalizeClass, t as toDisplayString, F as withDirectives, ad as withKeys, gl as vModelText, aC as renderSlot, cw as getRandomId, ag as useSelectedAccount, X as nextTick, kl as verifyRootKeyPassword, km as createAdditionalAccountMnemonic, kn as createAdditionalAccountsHardwareWallet, ko as saveWallet, bn as dispatchSignal, kp as onReloadWalletList, kq as doRemoveAccount, aS as sleep, c8 as json, dn as purpose, a8 as useAppWallet, ee as useAppAccount, a7 as toRefs, kk as onPoolDataUpdated, kr as poolDataList, k as dispatchSignalSync, dl as doToggleDappAccountId, ks as onAccountRemoved } from "./index.js";
...
import { u as useKeystoneDevice, _ as _sfc_main$4, a as _sfc_main$9 } from "./Keystone.vue_vue_type_script_setup_true_lang.js";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onAccountSynced = async (appAccount) => {
      console.log("onAccountSynced", appAccount.id, appAccount.data.keys.payment);
      const isWantedAccount = discoveryList.value.some((account) => account.id === appAccount.id);
      console.log("onAccountSynced", "isWantedAccount", isWantedAccount);
      if (!isWantedAccount) {
        return;
      }
      const hasUsedCreds = appAccount.data.keys.payment.some((payment) => payment.used);
      console.log("onAccountSynced", "hasUsedCreds", hasUsedCreds);
      if (!hasUsedCreds) {
