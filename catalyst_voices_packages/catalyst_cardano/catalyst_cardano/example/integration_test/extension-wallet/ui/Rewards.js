import { d as defineComponent, f as computed, bT as getRewardAddressFromCred, K as networkId, u as unref, o as openBlock, c as createElementBlock, q as createVNode, e as createBaseVNode, t as toDisplayString, j as createCommentVNode, ag as useSelectedAccount, z as ref, C as onMounted, aI as onUnmounted, D as watch, n as normalizeClass, B as useFormatter, kg as getCalculatedEpoch, f4 as getRewardHistory, kh as getEpochStart, f7 as multiply, a9 as useQuasar, aa as SyncState, ck as isZero, aY as addSignalListener, gV as onEpochParamsUpdated, aZ as removeSignalListener, a as createBlock, b as withModifiers, cw as getRandomId, a_ as checkEpochParams, ki as onBuiltTxWithdrawal, ga as getTxBuiltErrorMsg, g5 as ErrorBuildTx, bn as dispatchSignal, kj as doBuildTxWithdrawal } from "./index.js";
        ...
        createBaseVNode("div", {
          ...
          ((_c = unref(rewardInfo)) == null ? void 0 : _c.registered) ? (openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            unref(epochParams) && unref(epochParams).isAtLeastConwayEra ? (openBlock(), createElementBlock("div", _hoisted_2, [
              (((_d = unref(rewardInfo)) == null ? void 0 : _d.govDelegationList.length) ?? 0) === 0 || !((_e = unref(rewardInfo)) == null ? void 0 : _e.hasActiveDRep) ? (openBlock(), createBlock(_sfc_main$7, {
                key: 0,
                class: "mt-2 cc-flex-fixed",
                css: "cc-text-semi-bold cc-rounded cc-banner-warning",
                "text-c-s-s": "",
                text: unref(it)(`wallet.summary.stakeinfo.gov.${(((_f = unref(rewardInfo)) == null ? void 0 : _f.govDelegationList.length) ?? 0) === 0 ? "nodelegation" : "inactive"}`),
