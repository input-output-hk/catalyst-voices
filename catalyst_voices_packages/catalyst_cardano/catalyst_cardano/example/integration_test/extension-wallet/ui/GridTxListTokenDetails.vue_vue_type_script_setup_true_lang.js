import { d as defineComponent, z as ref, c_ as getAssetInfoLight, C as onMounted, hz as getAssetInfo, cn as getAssetIdBech32, o as openBlock, c as createElementBlock, e as createBaseVNode, n as normalizeClass, j as createCommentVNode, q as createVNode, t as toDisplayString, u as unref, cm as getAssetName, i as createTextVNode, h as withCtx, b as withModifiers, F as withDirectives, J as vShow, aK as useGuard } from "./index.js";
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      if (((_a2 = props.asset) == null ? void 0 : _a2.p) != null) {
        ...
        isScam.value = (await isAssetOnBlockList(getAssetIdBech32(props.asset.p, props.asset.t.a))).length > 0;
      }
    });
    return (_ctx, _cache) => {
