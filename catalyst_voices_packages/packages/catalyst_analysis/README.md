...
For more information, see the [complete list of options](https://github.com/input-output-hk/catalyst-voices/blob/main/catalyst_voices_packages/packages/catalyst_analysis/lib/analysis_options.1.0.0.yaml).
