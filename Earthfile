...
IMPORT github.com/input-output-hk/catalyst-ci/earthly/mdlint:feat/version-key-derivation AS mdlint-ci
IMPORT github.com/input-output-hk/catalyst-ci/earthly/cspell:feat/version-key-derivation AS cspell-ci
IMPORT github.com/input-output-hk/catalyst-ci/earthly/postgresql:feat/version-key-derivation AS postgresql-ci
