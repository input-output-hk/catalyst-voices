...
IMPORT github.com/input-output-hk/catalyst-ci/earthly/mdlint:feat/automatic_set_build_number AS mdlint-ci
IMPORT github.com/input-output-hk/catalyst-ci/earthly/cspell:feat/automatic_set_build_number AS cspell-ci
IMPORT github.com/input-output-hk/catalyst-ci/earthly/postgresql:feat/automatic_set_build_number AS postgresql-ci
