...
It requires connection to the wallet third party extensions (e.g Lace) to be able to perform wallet actions.
...
* Lace, Nami, Eternl, and Vespr must work with the application
...
Playwright will be used to test the application
