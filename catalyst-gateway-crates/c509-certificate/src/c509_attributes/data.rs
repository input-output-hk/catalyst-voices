//! Attribute data provides a necessary information for encoding and decoding of C509 Attribute.
//! See [C509 Certificate]https://datatracker.ietf.org/doc/draft-ietf-cose-cbor-encoded-cert/09/) 
//! Section 9.3 C509 Atttributes Registry for more information.
...
/// Define static lookup for `Attribute` table
pub(crate) static ATTRIBUTES_TABLES: Lazy<AttributeData> = Lazy::new(|| {
