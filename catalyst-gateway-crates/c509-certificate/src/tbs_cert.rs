...
// Notes
// - Test is modified to match the current encode and decode where `subject_public_key` doesn't support
...
mod test_tbs_cert {
    ...
    */
    ...
    fn tbs_cert2() {
        ...
        subject_public_key_algorithm: 0x01
        subject_public_key: 0x4888d0b6b0b37baa46
        extensions: 0x840421015496600d8716bf7fd0e752d0ac760777ad665d02a0210503822082492b06010401b01f0a014401020304
        issuer_signature_algorithm: 0x00
        */
